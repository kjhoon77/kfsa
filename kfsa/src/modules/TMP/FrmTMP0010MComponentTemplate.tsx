...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_radRadioV ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '50px', height: '42px' }}><RadioGroup row >{ (FrmTMP0010MComponentTemplateData.ds_ds_oRadio || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_radRadioH ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '100px', height: '22px' }}><RadioGroup row >{ (FrmTMP0010MComponentTemplateData.ds_ds_oRadio || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box><Box sx={{ display: hook.isVisible_btnSearchCode ? undefined : 'none' }}><Button variant="outlined"  size="small" sx={{ minWidth: 26, p: 0.2, width: '22px', height: '24px' }}><Search fontSize="small" /></Button></Box></Stack>
