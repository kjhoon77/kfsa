...
export const FrmTMP0010MComponentTemplate = () => {
    ...
    const columns_gdGrid = [
        { field: 'id_seq', headerName: 'No', width: 40, renderCell: (params) => params.api.getAllRowIds().indexOf(params.id) + 1, sortable: false },
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">Component템플릿</Typography>
