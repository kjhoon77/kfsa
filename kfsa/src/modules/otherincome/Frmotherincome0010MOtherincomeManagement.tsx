...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        ...
                        <Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "32px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_tabTab1 ? undefined : 'none' }}><Box sx={{ width: '718px', height: '631px', width: "100%", height: "auto", minHeight: "631px" }}><Box sx={{ borderBottom: 1, borderColor: "divider" }}><Tabs value={tabValue_tabTab1} onChange={(e, v) => setTabValue_tabTab1(v)} aria-label="tabTab1"><Tab label="   지급조서 관리   " /><Tab label="   지급조서 발급현황   " /><Tab label="   사업소득자 관리   " /></Tabs></Box><CustomTabPanel value={tabValue_tabTab1} index={0}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "67px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_lbPersonSearch ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '96px', height: '24px' }}><Typography variant="body2">소득자 검색</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_edOpmgno ? undefined : 'none' }}><TextField size="small" fullWidth value={hook.ds_oOneOtherPerson?.OPMGNO || ''} sx={{ width: '63px', height: '24px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box><Box sx={{ display: hook.isVisible_btnPersonNew ? undefined : 'none' }}><Button variant="outlined" onClick={hook.tabTab1_tab1_btnPersonNew_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '92px', height: '28px' }}><TouchApp fontSize="small" /></Button></Box><Box sx={{ display: hook.isVisible_btnPersonChg ? undefined : 'none' }}><Button variant="outlined" onClick={hook.tabTab1_tab1_btnPersonChg_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '92px', height: '28px' }}><TouchApp fontSize="small" /></Button></Box><Box sx={{ display: hook.isVisible_btnPersonDel ? undefined : 'none' }}><Button variant="outlined" onClick={hook.tabTab1_tab1_btnPersonDel_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '92px', height: '28px' }}><TouchApp fontSize="small" /></Button></Box><Box sx={{ display: hook.isVisible_btnPersonSave ? undefined : 'none' }}><Button variant="outlined" onClick={hook.tabTab1_tab1_btnPersonSave_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '92px', height: '28px' }}><TouchApp fontSize="small" /></Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '209px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmotherincome0010MOtherincomeManagementData.ds_ds_ioGujuGubun || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
                    ...
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmotherincome0010MOtherincomeManagementData.ds_ds_ioLocalGubun || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
                 </Stack></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_edOimgno ? undefined : 'none' }}><TextField size="small" fullWidth  sx={{ width: '63px', height: '24px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box><Box sx={{ display: hook.isVisible_btnIncomepaymentNew ? undefined : 'none' }}><Button variant="outlined" onClick={hook.tabTab1_tab1_btnIncomepaymentNew_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '92px', height: '28px' }}><TouchApp fontSize="small" /></Button></Box><Box sx={{ display: hook.isVisible_btnIncomepaymentSave ? undefined : 'none' }}><Button variant="outlined" onClick={hook.tabTab1_tab1_btnIncomepaymentSave_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '92px', height: '28px' }}><TouchApp fontSize="small" /></Button></Box><Box sx={{ display: hook.isVisible_btnIncomepaymentPrint ? undefined : 'none' }}><Button variant="outlined" onClick={hook.tabTab1_tab1_btnIncomepaymentPrint_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '92px', height: '28px' }}><TouchApp fontSize="small" /></Button></Box><Box sx={{ display: hook.isVisible_btnIncomepaymentFall ? undefined : 'none' }}><Button variant="outlined" onClick={hook.tabTab1_tab1_btnIncomepaymentFall_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '92px', height: '28px' }}><TouchApp fontSize="small" /></Button></Box><Box sx={{ display: hook.isVisible_btnIncomepaymentDel ? undefined : 'none' }}><Button variant="outlined" onClick={hook.tabTab1_tab1_btnIncomepaymentDel_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '92px', height: '28px' }}><TouchApp fontSize="small" /></Button></Box><Box sx={{ display: hook.isVisible_edOiyear ? undefined : 'none' }}><TextField size="small" fullWidth  sx={{ width: '70px', height: '24px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '248px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmotherincome0010MOtherincomeManagementData.ds_ds_ioBizGubun || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '178px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnOipaymentdate ? undefined : 'none' }}><Button variant="contained"  onClick={hook.tabTab1_tab1_btnOipaymentdate_OnClick} sx={{ width: '66px', height: '28px' }}>일자조회</Button></Box><Box sx={{ display: hook.isVisible_edOijibu ? undefined : 'none' }}><TextField size="small" fullWidth  sx={{ width: '70px', height: '24px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '143px', height: '22px', display: 'flex', alignItems: 'center', ml: '3px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '219px', height: '22px', display: 'flex', alignItems: 'center', ml: '146px' }}>
                    ...
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmotherincome0010MOtherincomeManagementData.ds_ds_ioJibuGubun || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
                    ...
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmotherincome0010MOtherincomeManagementData.ds_ds_ioDataGubun || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
                 </Stack><Box sx={{ display: hook.isVisible_btnToExcel ? undefined : 'none' }}><Button variant="outlined" onClick={hook.tabTab1_tab1_btnToExcel_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '92px', height: '28px' }}><TouchApp fontSize="small" /></Button></Box></Stack>
...
</CustomTabPanel><CustomTabPanel value={tabValue_tabTab1} index={1}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "78px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static0 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '96px', height: '24px' }}><Typography variant="body2">출력구분</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "10px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '479px', height: '57px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmotherincome0010MOtherincomeManagementData.ds_ds_inPrtGubun || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
                 </Stack></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "20px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static2 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '96px', height: '24px' }}><Typography variant="body2">출력기준</Typography></Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '479px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmotherincome0010MOtherincomeManagementData.ds_ds_inPrtStandard || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
                 </Stack></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "8px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '479px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmotherincome0010MOtherincomeManagementData.ds_ds_inJibu || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
                 </Stack></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "28px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnpaymentprint ? undefined : 'none' }}><Button variant="outlined" onClick={hook.tabTab1_tab3_btnpaymentprint_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '112px', height: '36px' }}><TouchApp fontSize="small" /></Button></Box><Box sx={{ display: hook.isVisible_btnpaymentexcel ? undefined : 'none' }}><Button variant="outlined" onClick={hook.tabTab1_tab3_btnpaymentexcel_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '112px', height: '36px' }}><TouchApp fontSize="small" /></Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdOtherExcel2 ? undefined : 'none' }}><Paper sx={{ width: '495px', height: '114px', width: '100%', height: 'auto', minHeight: '114px' }}><DataGridWrapper rows={hook.ds_oExcelcreate} columns={columns_gdOtherExcel2} /></Paper></Box></Stack>
</CustomTabPanel><CustomTabPanel value={tabValue_tabTab1} index={2}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "60px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '168px', height: '22px', display: 'flex', alignItems: 'center', ml: '11px' }}>
                    ...
                    <Typography variant="body2" sx={{ minWidth: 10, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>~</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnErrorPerson ? undefined : 'none' }}><Button variant="outlined" onClick={hook.tabTab1_tab2_btnErrorPerson_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '118px', height: '28px' }}><TouchApp fontSize="small" /></Button></Box><Box sx={{ display: hook.isVisible_btnToExcel ? undefined : 'none' }}><Button variant="outlined" onClick={hook.tabTab1_tab2_btnToExcel_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '92px', height: '28px' }}><TouchApp fontSize="small" /></Button></Box><Box sx={{ display: hook.isVisible_medJubsuCnt ? undefined : 'none' }}><TextField size="small" fullWidth  sx={{ width: '72px', height: '24px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "9px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_lbtotal ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '585px', height: '44px' }}><Typography variant="body2">소득자 조회</Typography></Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '289px', height: '27px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnOtherbizTrans ? undefined : 'none' }}><Button variant="contained"  onClick={hook.tabTab1_tab2_btnOtherbizTrans_OnClick} sx={{ width: '180px', height: '29px' }}>사업소득 ⇒ 기타소득 전환</Button></Box><Box sx={{ display: hook.isVisible_btnOtherbizTotal ? undefined : 'none' }}><Button variant="contained"  onClick={hook.tabTab1_tab2_btnOtherbizTotal_OnClick} sx={{ width: '110px', height: '29px' }}>소득자 집계현황</Button></Box></Stack>
