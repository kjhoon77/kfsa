...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '549px', height: '22px', display: 'flex', alignItems: 'center', ml: '13px' }}>
                    ...
                    <FormControl component="fieldset" sx={{ width: "max-content", whiteSpace: "nowrap" }}><RadioGroup row sx={{ flexWrap: "nowrap" }} value={hook.ds_ioMaster?.ETC_MATTER || ''}>{ (Frmcust3040MFireManagerPstponeManagementData.ds_ds_oEtcCourse || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} sx={{ whiteSpace: 'nowrap', flexShrink: 0, mr: 2 }} />) }</RadioGroup></FormControl>
                 </Stack></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '733px', height: '22px', display: 'flex', alignItems: 'center', ml: '13px' }}>
                    ...
                    <FormControl component="fieldset" sx={{ width: "max-content", whiteSpace: "nowrap" }}><RadioGroup row sx={{ flexWrap: "nowrap" }} value={hook.ds_ioMaster?.APNT_PSTPONE_CODE || ''}>{ (Frmcust3040MFireManagerPstponeManagementData.ds_ds_oResn || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} sx={{ whiteSpace: 'nowrap', flexShrink: 0, mr: 2 }} />) }</RadioGroup></FormControl>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "6px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnCheck ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnCheck_OnClick} sx={{ width: '337px', height: '24px', whiteSpace: "nowrap" }}> 안전원 보유정보 확인</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Button2 ? undefined : 'none' }}><Button variant="contained"   onClick={hook.Button2_OnClick} sx={{ width: '104px', height: '23px', whiteSpace: "nowrap" }}>Button2</Button></Box></Stack>
