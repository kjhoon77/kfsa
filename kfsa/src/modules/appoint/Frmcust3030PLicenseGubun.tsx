...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_radCourse ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '72px', height: '352px' }}><RadioGroup row >{ (Frmcust3030PLicenseGubunData.ds_ds_Chk || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box><Box sx={{ display: hook.isVisible_Grid1 ? undefined : 'none' }}><Paper sx={{ width: '446px', height: '168px', width: '100%', height: 'auto', minHeight: '168px' }}><DataGridWrapper rows={hook.ds_grid} columns={columns_Grid1} /></Paper></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "62px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnSearchPersonInfo ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnSearchPersonInfo_OnClick} sx={{ width: '67px', height: '24px' }}>확인</Button></Box><Box sx={{ display: hook.isVisible_Button0 ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnSearchPersonInfo_OnClick} sx={{ width: '69px', height: '24px' }}>닫기</Button></Box></Stack>
