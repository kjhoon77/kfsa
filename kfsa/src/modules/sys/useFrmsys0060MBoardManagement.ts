...
export const useFrmsys0060MBoardManagement = () => {
    ...
    const [isVisible_lbRealFileName, setIsVisible_lbRealFileName] = useState(false);
    const [isVisible_lbDays, setIsVisible_lbDays] = useState(true);
    const [isVisible_edDays, setIsVisible_edDays] = useState(true);
    const [isVisible_lbDays2, setIsVisible_lbDays2] = useState(true);
