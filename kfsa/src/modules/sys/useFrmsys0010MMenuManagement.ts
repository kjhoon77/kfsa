...
export const useFrmsys0010MMenuManagement = () => {
    ...
    const [isVisible_btnUp, setIsVisible_btnUp] = useState(true);
    const [isVisible_btnDown, setIsVisible_btnDown] = useState(true);
    ...
    const [isVisible_btnLevelDown, setIsVisible_btnLevelDown] = useState(true);
    const [isVisible_btnLevelUp, setIsVisible_btnLevelUp] = useState(true);
    const [isVisible_btnRenew, setIsVisible_btnRenew] = useState(true);
