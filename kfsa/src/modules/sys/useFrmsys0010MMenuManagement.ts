...
import type { Ids_ioMenuTree, Ids_oSysGubun, Ids_oUrlType, Ids_ioMenuTreeBackup, Ids_iMenuDelete, Ids_oDeptAdminGubun } from './Frmsys0010MMenuManagementData';
...
export const useFrmsys0010MMenuManagement = () => {
    ...
    const [rawVisible_btnUp, setRawVisible_btnUp] = useState(true);
    const [rawVisible_btnDown, setRawVisible_btnDown] = useState(true);
    ...
    const [rawVisible_btnLevelDown, setRawVisible_btnLevelDown] = useState(true);
    const [rawVisible_btnLevelUp, setRawVisible_btnLevelUp] = useState(true);
    const [rawVisible_btnRenew, setRawVisible_btnRenew] = useState(true);
    ...
    const isVisible_btnUp = rawVisible_btnUp && rawVisible_shpGubunBox2;
    const setIsVisible_btnUp = setRawVisible_btnUp;
    const isVisible_btnDown = rawVisible_btnDown && rawVisible_shpGubunBox2;
    ...
    const isVisible_btnLevelDown = rawVisible_btnLevelDown && rawVisible_shpGubunBox2;
    const setIsVisible_btnLevelDown = setRawVisible_btnLevelDown;
    const isVisible_btnLevelUp = rawVisible_btnLevelUp && rawVisible_shpGubunBox2;
    const setIsVisible_btnLevelUp = setRawVisible_btnLevelUp;
    const isVisible_btnRenew = rawVisible_btnRenew && rawVisible_shpGubunBox1;
