...
import type { Ids_oPostCode, Ids_oSido, Ids_oDong, Ids_oRoad, Ids_iSearch, Ids_oRoadAddr, Ids_oRoadList, Ids_iPostAddrDivide, Ids_oPostAddrDivide } from './사본Frmsys0054PAddrSearchData';

export const use사본Frmsys0054PAddrSearch = () => {
