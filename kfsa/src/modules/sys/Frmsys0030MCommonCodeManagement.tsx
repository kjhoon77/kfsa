...
import { useFrmsys0030MCommonCodeManagement } from './useFrmsys0030MCommonCodeManagement';
import * as Frmsys0030MCommonCodeManagementData from './Frmsys0030MCommonCodeManagementData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmsys0030MCommonCodeManagement = () => {
    const hook = useFrmsys0030MCommonCodeManagement();
    const [chk_chkUseYn, setChk_chkUseYn] = useState('0');
    const columns_gdCommonCode = [
        { field: 'USE_YN', headerName: '사용유무', width: 70 },
        { field: 'CCGROUPCD', headerName: '그룹코드', width: 120 },
        { field: 'CCCD', headerName: '공통코드', width: 120 },
        { field: 'CCCDNM', headerName: '공통코드명', width: 224 },
        { field: 'CCORDERSEQ', headerName: '정렬순서', width: 86 },
        { field: 'CCREMARK', headerName: '비고', width: 150 },
    ];
    return (
        <PageContainer>

            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">공통코드관리</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '392px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    <Typography variant="body2" sx={{ minWidth: 88, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>그룹코드</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '392px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    <Typography variant="body2" sx={{ minWidth: 88, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>공통코드</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '384px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    <Typography variant="body2" sx={{ minWidth: 88, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>공통코드명</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdCommonCode ? undefined : 'none' }}><Paper sx={{ width: '792px', height: '418px', width: '100%', height: 'auto', minHeight: '418px' }}><DataGridWrapper rows={hook.ds_ioCommonCode} columns={columns_gdCommonCode} /></Paper></Box></Stack>
...
export default Frmsys0030MCommonCodeManagement;
