...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '291px', height: '22px', display: 'flex', alignItems: 'center', ml: '396px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnRenew ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnRenew_OnClick} sx={{ width: '105px', height: '24px' }}>폴더 새로고침</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "32px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnUp ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnUp_OnClick} sx={{ width: '196px', height: '24px' }}>▲ 현재 노드 위로 이동</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "10px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnDown ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnDown_OnClick} sx={{ width: '196px', height: '24px' }}>▼ 현재 노드 아래로 이동</Button></Box></Stack>
