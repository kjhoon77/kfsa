    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">메뉴관리</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '291px', height: '22px', display: 'flex', alignItems: 'center', ml: '396px' }}>
                    ...
                    <FormControl size="small" fullWidth sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" } }}><Select value={hook.ds_ioMenuTree?.MSYSGUBUN || ''} displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmsys0010MMenuManagementData.ds_ds_oSysGubun || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
                 </Stack><Box sx={{ display: hook.isVisible_btnRenew ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnRenew_OnClick} sx={{ width: '105px', height: '24px', whiteSpace: "nowrap" }}>폴더 새로고침</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '396px', height: '22px', display: 'flex', alignItems: 'center', ml: '396px' }}>
                    ...
                    <FormControl component="fieldset" sx={{ width: "max-content", whiteSpace: "nowrap" }}><RadioGroup row sx={{ flexWrap: "nowrap" }} value={hook.ds_ioMenuTree?.MURLTYPE || ''}>{ (Frmsys0010MMenuManagementData.ds_ds_oUrlType || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} sx={{ whiteSpace: 'nowrap', flexShrink: 0, mr: 2 }} />) }</RadioGroup></FormControl>
                 </Stack></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '396px', height: '22px', display: 'flex', alignItems: 'center', ml: '396px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '291px', height: '22px', display: 'flex', alignItems: 'center', ml: '396px' }}>
                    ...
                    <FormControl size="small" fullWidth sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" } }}><Select value={hook.ds_ioMenuTree?.MDEPTADMINGUBUN || ''} displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmsys0010MMenuManagementData.ds_ds_oDeptAdminGubun || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
                 </Stack></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "5px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_lbMenuRemark ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '88px', height: '22px' }}><Typography variant="body2">메뉴설명</Typography></Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "32px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnUp ? undefined : 'none' }}><Button variant="contained" color="success"  onClick={hook.btnUp_OnClick} sx={{ width: '196px', height: '24px', whiteSpace: "nowrap" }}>▲ 현재 노드 위로 이동</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "10px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnLevelUp ? undefined : 'none' }}><Button variant="contained" color="success"  onClick={hook.btnLevelUp_OnClick} sx={{ width: '92px', height: '24px', whiteSpace: "nowrap" }}>◀ Level Up</Button></Box><Box sx={{ display: hook.isVisible_btnLevelDown ? undefined : 'none' }}><Button variant="contained" color="success"  onClick={hook.btnLevelDown_OnClick} sx={{ width: '92px', height: '24px', whiteSpace: "nowrap" }}>Level Down ▶</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "10px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnDown ? undefined : 'none' }}><Button variant="contained" color="success"  onClick={hook.btnDown_OnClick} sx={{ width: '196px', height: '24px', whiteSpace: "nowrap" }}>▼ 현재 노드 아래로 이동</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "25px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static15 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '24px', height: '93px' }}><Typography variant="body2">R
O
