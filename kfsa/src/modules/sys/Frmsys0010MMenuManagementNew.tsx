...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '396px', height: '22px', display: 'flex', alignItems: 'center', ml: '396px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnUp ? undefined : 'none' }}><Button variant="contained" color="success"  onClick={hook.btnUp_OnClick} sx={{ width: '196px', height: '24px', whiteSpace: "nowrap" }}>▲ 현재 노드 위로 이동</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '396px', height: '22px', display: 'flex', alignItems: 'center', ml: '396px' }}>
