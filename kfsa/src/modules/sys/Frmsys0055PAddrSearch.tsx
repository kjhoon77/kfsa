...
export const Frmsys0055PAddrSearch = () => {
    ...
    const columns_gdRoad = [
        ...
        { field: 'RADDR', headerName: '주소', width: 543, renderCell: (params) => <Stack spacing={0} sx={{ height: "100%", justifyContent: "center" }}><Box sx={{ height: "20px", display: "flex", alignItems: "center" }}>{params.row.RADDR}</Box><Box sx={{ height: "20px", display: "flex", alignItems: "center" }}>{params.row.JADDR}</Box></Stack>, sortable: false },
    ];
    return (
        <PageContainer>

            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">도로명주소정보검색팝업</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "10px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '174px', height: '22px', display: 'flex', alignItems: 'center', ml: '16px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnRoadSearch ? undefined : 'none' }}><Button variant="contained" color="secondary"  onClick={hook.btnRoadSearch_OnClick} sx={{ width: '93px', height: '24px', whiteSpace: "nowrap" }}>주소 조회</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdRoad ? undefined : 'none' }}><Paper sx={{ width: '685px', height: '395px', width: '100%', height: 'auto', minHeight: '395px' }}><MultiDataGridWrapper rows={hook.ds_oRoadList} columns={columns_gdRoad} rowHeight={40} headerHeight={20} hideFooter={true} /></Paper></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnSave ? undefined : 'none' }}><Button variant="contained" color="secondary"  onClick={hook.btnSave_OnClick} sx={{ width: '122px', height: '24px', whiteSpace: "nowrap" }}>적용주소 반영(F4)</Button></Box></Stack>
