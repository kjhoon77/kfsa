...
export const useFrmsys0020MUserAuthManagement = () => {
    ...
    const [rawVisible_btnDeleteKemsAuth, setRawVisible_btnDeleteKemsAuth] = useState(true);
    ...
    const isVisible_btnDeleteKemsAuth = rawVisible_btnDeleteKemsAuth && rawVisible_shpGubunBox;
