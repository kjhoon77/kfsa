...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_radPort ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '490px', height: '22px' }}><RadioGroup row >{ (Frmtraining0470MExamOMRPortSettingData.ds_ds_oPort || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_radSpeed ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '245px', height: '22px' }}><RadioGroup row >{ (Frmtraining0470MExamOMRPortSettingData.ds_ds_oSpeed || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_radBoundRate ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '245px', height: '22px' }}><RadioGroup row >{ (Frmtraining0470MExamOMRPortSettingData.ds_ds_oBoundRate || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_radParityBit ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '100px', height: '22px' }}><RadioGroup row >{ (Frmtraining0470MExamOMRPortSettingData.ds_ds_oParityBit || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_radStopBIt ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '100px', height: '22px' }}><RadioGroup row >{ (Frmtraining0470MExamOMRPortSettingData.ds_ds_oStopBit || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Stack>
