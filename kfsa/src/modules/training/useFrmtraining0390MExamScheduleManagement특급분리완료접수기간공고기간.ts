...
import type { Ids_ioExamOrder, Ids_oJibu, Ids_oCourse, Ids_oUseYn, Ids_oCourseGubun, Ids_oExamGubun1, Ids_oInternetJubsuStatus, Ids_ioExamRoomMinimap, Ids_oInetJubsuYn, Ids_oExamGubun2, Ids_oExamGubun3, Ids_oExamOrderMgno, Ids_oModifyColumn, Ids_ioJubsu, Ids_oExamGubun4, Ids_oExamGubun, Ids_oDayGubun, Ids_oSendYN, Ids_ioChasuGubun } from './Frmtraining0390MExamScheduleManagement특급분리완료접수기간공고기간Data';

export const useFrmtraining0390MExamScheduleManagement특급분리완료접수기간공고기간 = () => {
    ...
    const [rawVisible_medExamTimeStart2, setRawVisible_medExamTimeStart2] = useState(true);
    const [rawVisible_lbTimeWave2, setRawVisible_lbTimeWave2] = useState(true);
    const [rawVisible_medExamTimeEnd2, setRawVisible_medExamTimeEnd2] = useState(true);
    ...
    const isVisible_medExamTimeStart2 = rawVisible_medExamTimeStart2 && rawVisible_shpGubunBox;
    const setIsVisible_medExamTimeStart2 = setRawVisible_medExamTimeStart2;
    ...
    const isVisible_medExamTimeEnd2 = rawVisible_medExamTimeEnd2 && rawVisible_shpGubunBox;
    const setIsVisible_medExamTimeEnd2 = setRawVisible_medExamTimeEnd2;
    ...
    return {
        ...
        isVisible_medExamTimeStart2,
        setIsVisible_medExamTimeStart2,
        isVisible_lbTimeWave2,
        setIsVisible_lbTimeWave2,
        isVisible_medExamTimeEnd2,
        setIsVisible_medExamTimeEnd2,
