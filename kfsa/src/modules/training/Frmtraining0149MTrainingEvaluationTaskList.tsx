...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "7px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '336px', height: '24px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnDownload ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnDownload_OnClick} sx={{ width: '118px', height: '24px' }}>일괄 다운로드</Button></Box><Box sx={{ display: hook.isVisible_btnPass ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnPass_OnClick} sx={{ width: '118px', height: '24px' }}>과제 합격처리</Button></Box><Box sx={{ display: hook.isVisible_fdAttachFile ? undefined : 'none' }}><Box sx={{ width: '24px', height: '26px', border: '1px dashed grey' }}>Unknown: FileDialog</Box></Box><Box sx={{ display: hook.isVisible_hfAttachFile ? undefined : 'none' }}><Box sx={{ width: '24px', height: '26px', border: '1px dashed grey' }}>Unknown: HttpFile</Box></Box></Stack>
