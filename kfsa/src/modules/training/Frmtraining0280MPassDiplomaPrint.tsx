...
export const Frmtraining0280MPassDiplomaPrint = () => {
    ...
    const [chk_chkExpireDateFilter, setChk_chkExpireDateFilter] = useState('0');
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    ...
                    <FormControl component="fieldset" sx={{ width: "max-content", whiteSpace: "nowrap" }}><RadioGroup row sx={{ flexWrap: "nowrap" }} >{ (Frmtraining0280MPassDiplomaPrintData.ds_ds_oSearchGubun || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} sx={{ whiteSpace: 'nowrap', flexShrink: 0, mr: 2 }} />) }</RadioGroup></FormControl>
                 </Stack></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static0 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '88px', height: '22px' }}><Typography variant="body2">출력☞</Typography></Box></Box><Box sx={{ display: hook.isVisible_btnPassPrint ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnPassPrint} sx={{ width: '118px', height: '24px', whiteSpace: "nowrap" }}>수료증(테두리有)</Button></Box><Box sx={{ display: hook.isVisible_btnPassPrint2 ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnPass2Print} sx={{ width: '118px', height: '24px', whiteSpace: "nowrap" }}>수료증(테두리無)</Button></Box><Box sx={{ display: hook.isVisible_btnPass2Print3 ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnPass3Print} sx={{ width: '118px', height: '24px', whiteSpace: "nowrap" }}>수료증(상장양식지)</Button></Box><Box sx={{ display: hook.isVisible_btnPassList ? undefined : 'none' }}><Button variant="contained" color="secondary"  onClick={hook.btnPassList_OnClick} sx={{ width: '66px', height: '24px', whiteSpace: "nowrap" }}>수료대장</Button></Box><Box sx={{ display: hook.isVisible_btnAttend ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnAttend_OnClick} sx={{ width: '66px', height: '24px', whiteSpace: "nowrap" }}>참가증</Button></Box><Box sx={{ display: hook.isVisible_btnMolPass ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnMolPass_OnClick} sx={{ width: '132px', height: '24px', whiteSpace: "nowrap" }}>노동부제출용 수료증</Button></Box><FormControlLabel control={<Checkbox checked={chk_chkExpireDateFilter === '1'} onChange={(e) => setChk_chkExpireDateFilter(e.target.checked ? '1' : '0')} />} label="필터" /></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "7px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '140px', height: '22px', display: 'flex', alignItems: 'center', ml: '6px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnPass ? undefined : 'none' }}><Button variant="contained" color="secondary"  onClick={hook.btnPass_OnClick} sx={{ width: '144px', height: '24px', whiteSpace: "nowrap" }}>수료증(테두리有)미리보기</Button></Box><Box sx={{ display: hook.isVisible_btnPass2 ? undefined : 'none' }}><Button variant="contained" color="secondary"  onClick={hook.btnPass2_OnClick} sx={{ width: '145px', height: '24px', whiteSpace: "nowrap" }}>수료증(테두리無)미리보기</Button></Box><Box sx={{ display: hook.isVisible_btnPass3 ? undefined : 'none' }}><Button variant="contained" color="secondary"  onClick={hook.btnPass3_OnClick} sx={{ width: '145px', height: '24px', whiteSpace: "nowrap" }}>수료증(상장양식지) 미리보기</Button></Box><Box sx={{ display: hook.isVisible_btnMutilSort ? undefined : 'none' }}><Button variant="outlined"  onClick={hook.btnMutilSort_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '74px', height: '22px', whiteSpace: "nowrap" }}><Sort fontSize="small" /></Button></Box></Stack>
