...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdSms ? undefined : 'none' }}><Paper sx={{ width: '708px', height: '520px', width: '100%', height: 'auto', minHeight: '520px' }}><DataGridWrapper rows={hook.ds_ioSmsTraining} columns={columns_gdSms} /></Paper></Box><Box sx={{ display: hook.isVisible_imgSmsTraining ? undefined : 'none' }}><Box sx={{ width: '287px', height: '489px', border: "1px solid #ddd", display: "flex", alignItems: "center", justifyContent: "center" }}>Image: imgSmsTraining</Box></Box></Stack>
