...
import type { Ids_oChangeDate, Ids_oBankSunapGubun } from './Frmtraining0406PExamJubsuProcessDateChangeData';

export const useFrmtraining0406PExamJubsuProcessDateChange = () => {
