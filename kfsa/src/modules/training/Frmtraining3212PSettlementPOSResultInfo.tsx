...
import { useFrmtraining3212PSettlementPOSResultInfo } from './useFrmtraining3212PSettlementPOSResultInfo';
import * as Frmtraining3212PSettlementPOSResultInfoData from './Frmtraining3212PSettlementPOSResultInfoData';

export const Frmtraining3212PSettlementPOSResultInfo = () => {
    const hook = useFrmtraining3212PSettlementPOSResultInfo();
    return (
        <PageContainer>

            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">카드결제처리결과조회팝업</Typography>
...
export default Frmtraining3212PSettlementPOSResultInfo;
