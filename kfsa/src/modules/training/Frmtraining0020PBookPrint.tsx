...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '272px', height: '22px', display: 'flex', alignItems: 'center', ml: '16px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnBookSmsSend ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnBookSmsSend_OnClick} sx={{ width: '118px', height: '24px' }}>문자발송</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "7px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdHist ? undefined : 'none' }}><Paper sx={{ width: '500px', height: '150px', width: '100%', height: 'auto', minHeight: '150px' }}><DataGridWrapper rows={hook.ds_oHist} columns={columns_gdHist} /></Paper></Box></Stack>
