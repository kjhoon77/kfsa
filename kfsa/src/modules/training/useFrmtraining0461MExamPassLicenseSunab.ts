...
export const useFrmtraining0461MExamPassLicenseSunab = () => {
    ...
    const [rawVisible_medEarlyCnt, setRawVisible_medEarlyCnt] = useState(true);
    ...
    const isVisible_medEarlyCnt = rawVisible_medEarlyCnt;
    const setIsVisible_medEarlyCnt = setRawVisible_medEarlyCnt;
    ...
    return {
        ...
        isVisible_medEarlyCnt,
        setIsVisible_medEarlyCnt,
        isVisible_Static2,
