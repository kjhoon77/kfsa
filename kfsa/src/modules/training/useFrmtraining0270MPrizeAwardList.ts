...
import type { Ids_oPassYn, Ids_oCourse, Ids_oRepayYn, Ids_ioPrize, Ids_oJibu, Ids_oPrizeGubun, Ids_oPrizeImageGubun, Ids_ioReport, Ids_ioReport2, Ids_ioPrizeList, Ids_ioPrizePop, Ids_ioPrizePop2 } from './Frmtraining0270MPrizeAwardListData';
...
export const useFrmtraining0270MPrizeAwardList = () => {
    ...
    const isVisible_edTrainingOrder2 = rawVisible_edTrainingOrder2 && rawVisible_shpGubunBox;
