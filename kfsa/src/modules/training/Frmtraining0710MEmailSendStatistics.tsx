...
import { useFrmtraining0710MEmailSendStatistics } from './useFrmtraining0710MEmailSendStatistics';
import * as Frmtraining0710MEmailSendStatisticsData from './Frmtraining0710MEmailSendStatisticsData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmtraining0710MEmailSendStatistics = () => {
    const hook = useFrmtraining0710MEmailSendStatistics();
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">메일발송현황</Typography>
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    ...
                    <FormControl size="small" fullWidth sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" } }}><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmtraining0710MEmailSendStatisticsData.ds_ds_oJibu || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdEmailStat ? undefined : 'none' }}><Paper sx={{ width: '792px', height: '460px', width: '100%', height: 'auto', minHeight: '460px' }}><DataGridWrapper rows={hook.ds_oEmailStat} columns={columns_gdEmailStat} /></Paper></Box></Stack>
...
export default Frmtraining0710MEmailSendStatistics;
