...
import type { Ids_ioInternetJusu, Ids_oWorkGubun, Ids_oCourse, Ids_oJibu, Ids_oInternetJubsuStatus, Ids_oGubun } from './Frmtraining0412MInternetExamJubsuDateModifyData';
