...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "8px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdTraining ? undefined : 'none' }}><Paper sx={{ width: '792px', height: '482px', width: '100%', height: 'auto', minHeight: '482px' }}><DataGridWrapper rows={hook.ds_ioTrainingPassCancel} columns={columns_gdTraining} /></Paper></Box></Stack>
