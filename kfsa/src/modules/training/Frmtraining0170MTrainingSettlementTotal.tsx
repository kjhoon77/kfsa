...
export const Frmtraining0170MTrainingSettlementTotal = () => {
    ...
    const columns_gdTrainingSettlementTotal = [
        ...
        { field: 'TSTINCOME', headerName: '수입금액(A-B) 계', width: 114 },
        { field: 'TSTPASSAMT', headerName: '수료자수입금액', width: 120 },
        { field: 'TSTBUBUNAMT', headerName: '결강자수입금액', width: 120 },
        { field: 'TSTSUNABAMT', headerName: '수납(A) 교육대상자수납금액', width: 132 },
        { field: 'TSTREPAYAMT', headerName: '환불(B) 교육전환불금액', width: 120 },
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">강습수수료 결강자 환불현황</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdTrainingSettlementTotal ? undefined : 'none' }}><Paper sx={{ width: '832px', height: '489px', width: '100%', height: 'auto', minHeight: '489px' }}><MultiDataGridWrapper rows={hook.ds_ioTrainingSettlementTotal} columns={columns_gdTrainingSettlementTotal} rowHeight={20} headerHeight={40} hideFooter={true} /></Paper></Box></Stack>
