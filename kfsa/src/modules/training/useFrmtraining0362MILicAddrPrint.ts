...
export const useFrmtraining0362MILicAddrPrint = () => {
    ...
    const [rawVisible_radApplyGubun, setRawVisible_radApplyGubun] = useState(true);
    ...
    const isVisible_radApplyGubun = rawVisible_radApplyGubun && rawVisible_shpGubunBox;
    const setIsVisible_radApplyGubun = setRawVisible_radApplyGubun;
