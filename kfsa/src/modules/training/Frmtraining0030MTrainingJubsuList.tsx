...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        ...
                        <Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "57px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnPrintEmail ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnPrintEmail_OnClick} sx={{ width: '157px', height: '24px' }}>이메일출력(TXT파일)</Button></Box><Box sx={{ display: hook.isVisible_btnPrintBookAddr ? undefined : 'none' }}><Button variant="contained"  onClick={hook.lfn_PrintBookAddr} sx={{ width: '106px', height: '24px' }}>교재수령지출력</Button></Box><Box sx={{ display: hook.isVisible_btnPrintBookAddrAll ? undefined : 'none' }}><Button variant="contained"  onClick={hook.lfn_PrintBookAddr} sx={{ width: '132px', height: '24px' }}>교재수령지출력(전체)</Button></Box><Box sx={{ display: hook.isVisible_btnFortec ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnFortec_OnClick} sx={{ width: '157px', height: '24px' }}>Formtec(3107) 주소 출력</Button></Box><Box sx={{ display: hook.isVisible_btnPrintReRctPDF ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnPrintReRct_OnClick} sx={{ width: '133px', height: '24px' }}>영수증재발행(PDF용)</Button></Box><Box sx={{ display: hook.isVisible_fdOpenFile ? undefined : 'none' }}><Box sx={{ width: '24px', height: '26px', border: '1px dashed grey' }}>Unknown: FileDialog</Box></Box><Box sx={{ display: hook.isVisible_filSaveFile ? undefined : 'none' }}><Box sx={{ width: '24px', height: '26px', border: '1px dashed grey' }}>Unknown: File</Box></Box></Stack>
