...
import type { Ids_oJibu, Ids_oStatus, Ids_oList, Ids_iLicenseReissueH, Ids_iLicenseImage, Ids_iLicenseH, Ids_iLicenseSettlement, Ids_oLicenseReport, Ids_oLicenseReportEdu, Ids_ioLicenseReissuePay, Ids_oPmMgno, Ids_ioPosPayment, Ids_ioPosPrintM, Ids_oPosCas, Ids_AddrLable, Ids_PrintApplication } from './Frmtraining0360MInternetLicenseReIssueManagementData';

export const useFrmtraining0360MInternetLicenseReIssueManagement = () => {
