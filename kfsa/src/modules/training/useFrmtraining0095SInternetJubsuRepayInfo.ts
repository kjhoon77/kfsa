...
import type { Ids_oTrainingRepayFee } from './Frmtraining0095SInternetJubsuRepayInfoData';

export const useFrmtraining0095SInternetJubsuRepayInfo = () => {
    ...
    const [rawVisible_medAmount2, setRawVisible_medAmount2] = useState(true);
    ...
    const isVisible_medAmount2 = rawVisible_medAmount2 && rawVisible_Shape1;
    const setIsVisible_medAmount2 = setRawVisible_medAmount2;
    ...
    return {
        ...
        isVisible_medAmount2,
        setIsVisible_medAmount2,
    };
};