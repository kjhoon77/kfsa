    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">수첩발급현황 전자결재연동</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnCreateList ? undefined : 'none' }}><Button variant="contained" color="secondary"  onClick={hook.btnCreateList_OnClick} sx={{ width: '314px', height: '24px', whiteSpace: "nowrap" }}>      (1) 수첩발급현황 보기 ☞☞☞</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnProcElecApv ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnProcElecApv_OnClick} sx={{ width: '314px', height: '24px', whiteSpace: "nowrap" }}>      (2) 전자결재 연동 처리 (기안)</Button></Box></Stack>
