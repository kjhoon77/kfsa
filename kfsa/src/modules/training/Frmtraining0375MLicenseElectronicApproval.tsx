...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnCreateList ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnCreateList_OnClick} sx={{ width: '314px', height: '24px', whiteSpace: "nowrap" }}>      (1) 수첩발급현황 보기 ☞☞☞</Button></Box></Stack>
