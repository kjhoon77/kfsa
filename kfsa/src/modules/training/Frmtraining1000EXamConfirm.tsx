...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btn_masterSave ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btn_masterSave_OnClick} sx={{ width: '118px', height: '24px' }}>저장(평가관리과)</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '203px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btConfirmCancell ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btConfirmCancell_OnClick} sx={{ width: '80px', height: '24px' }}>승인취소</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "7px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_edCheckCount ? undefined : 'none' }}><TextField size="small" fullWidth  sx={{ width: '24px', height: '22px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box><Box sx={{ display: hook.isVisible_btnRemark ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnRemark_OnClick} sx={{ width: '93px', height: '24px' }}>사유전체보기</Button></Box><Box sx={{ display: hook.isVisible_btnInput ? undefined : 'none' }}><Button variant="contained" startIcon={<Add />} onClick={hook.lfn_Input} sx={{ width: '85px', height: '24px' }}>추가 저장</Button></Box><Box sx={{ display: hook.isVisible_btnSave ? undefined : 'none' }}><Button variant="contained" startIcon={<Save />} onClick={hook.lfn_Save} sx={{ width: '85px', height: '24px' }}>수정 저장</Button></Box><Box sx={{ display: hook.isVisible_btnJubsu ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnJubsu_OnClick} sx={{ width: '66px', height: '24px' }}>접수시작</Button></Box><Box sx={{ display: hook.isVisible_btn_Cancell ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btn_Cancell_OnClick} sx={{ width: '66px', height: '24px' }}>접수취소</Button></Box><Box sx={{ display: hook.isVisible_btnMod ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnMod_OnClick} sx={{ width: '66px', height: '24px' }}>보완</Button></Box><Box sx={{ display: hook.isVisible_btnApprove ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnApprove_OnClick} sx={{ width: '66px', height: '24px' }}>승인</Button></Box><Box sx={{ display: hook.isVisible_btnReject ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnReject_OnClick} sx={{ width: '66px', height: '24px' }}>반려</Button></Box><Box sx={{ display: hook.isVisible_btCanCell ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btCanCell_OnClick} sx={{ width: '66px', height: '24px' }}>신청취소</Button></Box><Box sx={{ display: hook.isVisible_btnDelete ? undefined : 'none' }}><Button variant="contained" startIcon={<Delete />} onClick={hook.lfn_Delete} sx={{ width: '85px', height: '24px' }}>삭제 저장</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdProfessor ? undefined : 'none' }}><Paper sx={{ width: '985px', height: '293px', width: '100%', height: 'auto', minHeight: '293px' }}><DataGridWrapper rows={hook.ds_ioProfessor} columns={columns_gdProfessor} /></Paper></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_radChangeTpmgno ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '200px', height: '22px' }}><RadioGroup row >{ (Frmtraining1000EXamConfirmData.ds_ds_oChangeTpmgno || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '227px', height: '22px', display: 'flex', alignItems: 'center', ml: '16px' }}>
                    <Typography variant="body2" sx={{ minWidth: 88, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>지부</Typography>
                    <FormControl size="small" fullWidth sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" } }}><Select value={hook.ds_ioExamJubsu?.EAMGGTMGNO || ''} displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmtraining1000EXamConfirmData.ds_ds_oJibu2 || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '196px', height: '22px', display: 'flex', alignItems: 'center', ml: '6px' }}>
                    <Typography variant="body2" sx={{ minWidth: 88, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>신청일자</Typography>
                    <DatePicker format="yyyy/MM/dd" slotProps={{ textField: { size: "small", fullWidth: true, sx: { "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } } } }} />
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '144px', height: '22px', display: 'flex', alignItems: 'center', ml: '3px' }}>
                    <Typography variant="body2" sx={{ minWidth: 68, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>신청상태</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '151px', height: '22px', display: 'flex', alignItems: 'center', ml: '600px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '227px', height: '22px', display: 'flex', alignItems: 'center', ml: '16px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '149px', height: '22px', display: 'flex', alignItems: 'center', ml: '357px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '195px', height: '22px', display: 'flex', alignItems: 'center', ml: '16px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnSearchPersonInfo ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnSearchPersonInfo_OnClick} sx={{ width: '118px', height: '24px' }}>접수자  검색</Button></Box><Box sx={{ display: hook.isVisible_btnAuthBIRTHDAY ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnAuthBIRTHDAY_OnClick} sx={{ width: '105px', height: '24px' }}>실명인증</Button></Box><Box sx={{ display: hook.isVisible_Button0 ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnSearchPersonInfoChange_OnClick} sx={{ width: '105px', height: '24px' }}>접수자정보변경</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '195px', height: '22px', display: 'flex', alignItems: 'center', ml: '16px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnSearchRegPicture ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnSearchRegPicture_OnClick} sx={{ width: '93px', height: '24px' }}>등록사진조회</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '195px', height: '22px', display: 'flex', alignItems: 'center', ml: '16px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnImageZoom ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnImageZoom_OnClick} sx={{ width: '79px', height: '24px' }}>이미지확대</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnScanPicture ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnScanPicture_OnClick} sx={{ width: '106px', height: '24px' }}>SVP5300사진스캔</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '197px', height: '22px', display: 'flex', alignItems: 'center', ml: '16px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_Static11 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '270px', height: '15px' }}><Typography variant="body2">◀-- 응시자격 선택 시 자동 선택됩니다. </Typography></Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnFormDelete ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnFormDelete_OnClick} sx={{ width: '16px', height: '22px' }}>서류삭제</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "6px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '393px', height: '23px', display: 'flex', alignItems: 'center', ml: '18px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnDownload ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnDownload_OnClick} sx={{ width: '65px', height: '23px' }}> 다운로드 </Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '282px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
