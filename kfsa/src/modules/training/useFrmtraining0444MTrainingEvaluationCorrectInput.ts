...
import type { Ids_ioLoadedCorrect, Ids_ioExcel, Ids_oCourse, Ids_ioExcelDetail, Ids_oAnswer, Ids_ioExcelCopy } from './Frmtraining0444MTrainingEvaluationCorrectInputData';
...
export const useFrmtraining0444MTrainingEvaluationCorrectInput = () => {
    ...
    const [rawVisible_gdLoadedCorrect, setRawVisible_gdLoadedCorrect] = useState(true);
    ...
    const isVisible_btnSave = rawVisible_btnSave && rawVisible_shpGubunBox;
    const setIsVisible_btnSave = setRawVisible_btnSave;
    const isVisible_btnPrintScreen = rawVisible_btnPrintScreen && rawVisible_shpBtnBox;
    const setIsVisible_btnPrintScreen = setRawVisible_btnPrintScreen;
    const isVisible_btnEnd = rawVisible_btnEnd && rawVisible_shpBtnBox;
    const setIsVisible_btnEnd = setRawVisible_btnEnd;
    const isVisible_gdLoadedCorrect = rawVisible_gdLoadedCorrect;
    const setIsVisible_gdLoadedCorrect = setRawVisible_gdLoadedCorrect;
    ...
    return {
        ...
        isVisible_btnEnd,
        setIsVisible_btnEnd,
        isVisible_gdLoadedCorrect,
        setIsVisible_gdLoadedCorrect,
        isVisible_lbCourse,
