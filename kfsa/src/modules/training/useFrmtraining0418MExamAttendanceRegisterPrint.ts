...
import type { Ids_oCourse, Ids_ioExamJubsuList, Ids_oJibu, Ids_oSort, Ids_oSunab } from './Frmtraining0418MExamAttendanceRegisterPrintData';

export const useFrmtraining0418MExamAttendanceRegisterPrint = () => {
