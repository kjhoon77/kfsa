...
export const useFrmtraining0042MTrainingAbsentList = () => {
    ...
    const [rawVisible_btnMunjeSave, setRawVisible_btnMunjeSave] = useState(true);
    const [rawVisible_medPassCnt, setRawVisible_medPassCnt] = useState(true);
    const [rawVisible_Static0, setRawVisible_Static0] = useState(true);
    const [rawVisible_medMunjeCnt, setRawVisible_medMunjeCnt] = useState(true);
    const [rawVisible_Static1, setRawVisible_Static1] = useState(true);
    const [rawVisible_lbCyberNotice, setRawVisible_lbCyberNotice] = useState(false);
    ...
    const isVisible_btnMunjeSave = rawVisible_btnMunjeSave && rawVisible_shpBtnBox;
    const setIsVisible_btnMunjeSave = setRawVisible_btnMunjeSave;
    const isVisible_medPassCnt = rawVisible_medPassCnt;
    const setIsVisible_medPassCnt = setRawVisible_medPassCnt;
    const isVisible_Static0 = rawVisible_Static0;
    const setIsVisible_Static0 = setRawVisible_Static0;
    const isVisible_medMunjeCnt = rawVisible_medMunjeCnt;
    const setIsVisible_medMunjeCnt = setRawVisible_medMunjeCnt;
    const isVisible_Static1 = rawVisible_Static1;
    const setIsVisible_Static1 = setRawVisible_Static1;
    const isVisible_lbCyberNotice = rawVisible_lbCyberNotice;
    const setIsVisible_lbCyberNotice = setRawVisible_lbCyberNotice;
