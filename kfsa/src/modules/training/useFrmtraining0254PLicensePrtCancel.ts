...
export const useFrmtraining0254PLicensePrtCancel = () => {
    ...
    const [rawVisible_edPrtSEQ, setRawVisible_edPrtSEQ] = useState(true);
    ...
    const isVisible_edPrtSEQ = rawVisible_edPrtSEQ && rawVisible_shpGubunBox;
    const setIsVisible_edPrtSEQ = setRawVisible_edPrtSEQ;
