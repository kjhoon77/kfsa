...
import type { Ids_ioExamPaper, Ids_oAlphaType, Ids_oCourse, Ids_oNumType, Ids_ioExamPaperSearch, Ids_oModifyColumn, Ids_oSubjectGubun } from './Frmtraining0580MExamPaperManagementData';

export const useFrmtraining0580MExamPaperManagement = () => {
    ...
    const [isVisible_cbxSubjectGubun, setIsVisible_cbxSubjectGubun] = useState(true);
