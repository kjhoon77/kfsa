...
export const Frmtraining0250MLicenseIssueManagement = () => {
    ...
    const columns_gdLcsInfo = [
        { field: 'id_seq', headerName: '순번', width: 31, renderCell: (params) => params.api.getAllRowIds().indexOf(params.id) + 1, sortable: false },
    ...
    const columns_gdLcsHistory = [
        { field: 'id_seq', headerName: '순번', width: 32, renderCell: (params) => params.api.getAllRowIds().indexOf(params.id) + 1, sortable: false },
        { field: 'LHISSUEREASON', headerName: '발급구분', width: 81 },
        { field: 'LHPRTDATE', headerName: '발급일자', width: 72 },
        { field: 'col_3', headerName: '출력구분', width: 72 },
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">수첩발급정보관리</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnSearchLcsIssueHist ? undefined : 'none' }}><Button variant="contained" color="secondary"  onClick={hook.btnLcsImage_OnClick} sx={{ width: '94px', height: '24px', whiteSpace: "nowrap" }}>이미지보기</Button></Box></Stack>
