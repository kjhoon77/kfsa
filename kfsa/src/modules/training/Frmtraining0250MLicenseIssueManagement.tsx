...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '198px', height: '22px', display: 'flex', alignItems: 'center', ml: '35px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnSearchPersonInfo ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnSearchPersonInfo_OnClick} sx={{ width: '106px', height: '24px' }}>접수자 검색</Button></Box><Box sx={{ display: hook.isVisible_btnAuthBIRTHDAY ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnAuthBIRTHDAY_OnClick} sx={{ width: '106px', height: '24px' }}>실명인증</Button></Box><Box sx={{ display: hook.isVisible_btnTPModify ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnTPModify_OnClick} sx={{ width: '131px', height: '24px' }}>접수자 정보 변경</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '234px', height: '22px', display: 'flex', alignItems: 'center', ml: '35px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnSearch ? undefined : 'none' }}><Button variant="contained"  onClick={hook.lfn_Search} sx={{ width: '66px', height: '24px' }}>번호조회</Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '149px', height: '22px', display: 'flex', alignItems: 'center', ml: '9px' }}>
                    <Typography variant="body2" sx={{ minWidth: 46, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>바코드</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnBarCodeSearch ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnBarCodeSearch_OnClick} sx={{ width: '80px', height: '24px' }}>바코드조회</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ ml: "713px", minWidth: "100px" }}><Box sx={{ display: hook.isVisible_lbImgDate ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '91px', height: '22px' }}><Typography variant="body2"></Typography></Box></Box><Box sx={{ display: hook.isVisible_btnApplyPicture ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnApplyPicture_OnClick} sx={{ width: '93px', height: '24px' }}>최근사진반영</Button></Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "6px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_lbLcsInfo ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '24px', height: '106px' }}><Typography variant="body2">수첩정보</Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '190px', height: '22px', display: 'flex', alignItems: 'center', ml: '4px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnIssuedateModify ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnIssuedateModify_OnClick} sx={{ width: '38px', height: '24px' }}>수정</Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '174px', height: '22px', display: 'flex', alignItems: 'center', ml: '3px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnSearchLcsIssueHist ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnLcsImage_OnClick} sx={{ width: '94px', height: '24px' }}>이미지보기</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_lbLcsHistInfo ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '112px', height: '26px' }}><Typography variant="body2">수첩보유현황</Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '130px', height: '22px', display: 'flex', alignItems: 'center', ml: '3px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnDelete ? undefined : 'none' }}><Button variant="contained"  onClick={hook.lfn_Delete} sx={{ width: '92px', height: '24px' }}>수첩 폐기</Button></Box><Box sx={{ display: hook.isVisible_Static0 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '90px', height: '26px' }}><Typography variant="body2">수첩발급이력</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnPassPrint ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnPassPrint_OnClick} sx={{ width: '92px', height: '24px' }}>상장 출력</Button></Box></Stack>
