...
import { useFrmtraining0540MExamMarking } from './useFrmtraining0540MExamMarking';
import * as Frmtraining0540MExamMarkingData from './Frmtraining0540MExamMarkingData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmtraining0540MExamMarking = () => {
    const hook = useFrmtraining0540MExamMarking();
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">채점</Typography>
...
export default Frmtraining0540MExamMarking;
