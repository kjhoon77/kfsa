...
import { useFrmtraining3211PSettlementPOSResultInfo } from './useFrmtraining3211PSettlementPOSResultInfo';
import * as Frmtraining3211PSettlementPOSResultInfoData from './Frmtraining3211PSettlementPOSResultInfoData';

export const Frmtraining3211PSettlementPOSResultInfo = () => {
    const hook = useFrmtraining3211PSettlementPOSResultInfo();
    return (
        <PageContainer>

            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">현금결제처리결과조회팝업</Typography>
...
export default Frmtraining3211PSettlementPOSResultInfo;
