...
export const useFrmtraining0020MTrainingJubsuManagement = () => {
    ...
    const [isVisible_radMemAgreeYN, setIsVisible_radMemAgreeYN] = useState(false);
    ...
    const [isVisible_lbSunapAmt, setIsVisible_lbSunapAmt] = useState(true);
    const [isVisible_medSunapAmt, setIsVisible_medSunapAmt] = useState(true);
    ...
    const [isVisible_edTaskSubmitGubun, setIsVisible_edTaskSubmitGubun] = useState(true);
    const [isVisible_edOnlineGubun, setIsVisible_edOnlineGubun] = useState(true);
    ...
    const [isVisible_btnTaskSave, setIsVisible_btnTaskSave] = useState(true);
    ...
    const [isVisible_radTaskGubun, setIsVisible_radTaskGubun] = useState(true);
    const [isVisible_btnDivTaskSave, setIsVisible_btnDivTaskSave] = useState(true);
    const [isVisible_lbTrainingInfo3, setIsVisible_lbTrainingInfo3] = useState(true);
    const [isVisible_edCARGUBUN, setIsVisible_edCARGUBUN] = useState(false);
    const [isVisible_edMANAGE_VRSC_AT, setIsVisible_edMANAGE_VRSC_AT] = useState(false);
    const [isVisible_edLTCCOURECD, setIsVisible_edLTCCOURECD] = useState(false);
    const [isVisible_divWorkFormTitle, setIsVisible_divWorkFormTitle] = useState(true);
    const [isVisible_edBookPrint, setIsVisible_edBookPrint] = useState(true);
