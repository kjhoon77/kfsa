...
export const useFrmtraining0170MTrainingSettlementTotal = () => {
    ...
    const [isVisible_gdTrainingSettlementTotal, setIsVisible_gdTrainingSettlementTotal] = useState(true);
    ...
    const [isVisible_radCourseFG, setIsVisible_radCourseFG] = useState(true);
