...
import { useFrmtraining0340SLicenseReIssueRegisterPrint } from './useFrmtraining0340SLicenseReIssueRegisterPrint';
import * as Frmtraining0340SLicenseReIssueRegisterPrintData from './Frmtraining0340SLicenseReIssueRegisterPrintData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmtraining0340SLicenseReIssueRegisterPrint = () => {
    const hook = useFrmtraining0340SLicenseReIssueRegisterPrint();
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">수첩전자교부대장</Typography>
...
export default Frmtraining0340SLicenseReIssueRegisterPrint;
