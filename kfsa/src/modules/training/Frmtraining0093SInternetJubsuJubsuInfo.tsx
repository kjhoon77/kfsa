...
import { useFrmtraining0093SInternetJubsuJubsuInfo } from './useFrmtraining0093SInternetJubsuJubsuInfo';
import * as Frmtraining0093SInternetJubsuJubsuInfoData from './Frmtraining0093SInternetJubsuJubsuInfoData';

export const Frmtraining0093SInternetJubsuJubsuInfo = () => {
    const hook = useFrmtraining0093SInternetJubsuJubsuInfo();
    return (
        <PageContainer>

            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">접수자정보DIV</Typography>
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnEmailView ? undefined : 'none' }}><Button variant="contained" color="secondary"   sx={{ width: '92px', height: '24px', whiteSpace: "nowrap" }}>메일 미리 보기</Button></Box></Stack>
...
export default Frmtraining0093SInternetJubsuJubsuInfo;
