...
export const useFrmtraining0660MExamScoreStatistics = () => {
    ...
    const [rawVisible_grdOrderExport, setRawVisible_grdOrderExport] = useState(false);
    const [rawVisible_btnToExcel, setRawVisible_btnToExcel] = useState(false);
    const [rawVisible_grdScoreExport, setRawVisible_grdScoreExport] = useState(false);
    ...
    const isVisible_grdOrderExport = rawVisible_grdOrderExport;
    const setIsVisible_grdOrderExport = setRawVisible_grdOrderExport;
    const isVisible_btnToExcel = rawVisible_btnToExcel;
    const setIsVisible_btnToExcel = setRawVisible_btnToExcel;
    const isVisible_grdScoreExport = rawVisible_grdScoreExport;
    const setIsVisible_grdScoreExport = setRawVisible_grdScoreExport;
    ...
    return {
        ...
        isVisible_grdOrderExport,
        setIsVisible_grdOrderExport,
        isVisible_btnToExcel,
        setIsVisible_btnToExcel,
        isVisible_grdScoreExport,
        setIsVisible_grdScoreExport,
        isVisible_Grid0,
        setIsVisible_Grid0,
        btnToExcel_OnClick,
        lfn_End,
