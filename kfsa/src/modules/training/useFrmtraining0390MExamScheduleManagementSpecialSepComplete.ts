...
export const useFrmtraining0390MExamScheduleManagementSpecialSepComplete = () => {
    ...
    const [isVisible_medExamTimeStart2, setIsVisible_medExamTimeStart2] = useState(true);
    const [isVisible_lbTimeWave2, setIsVisible_lbTimeWave2] = useState(true);
    const [isVisible_medExamTimeEnd2, setIsVisible_medExamTimeEnd2] = useState(true);
