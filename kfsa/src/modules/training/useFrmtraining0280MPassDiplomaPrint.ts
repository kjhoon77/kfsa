...
export const useFrmtraining0280MPassDiplomaPrint = () => {
    ...
    const [rawVisible_btnPassPrint2, setRawVisible_btnPassPrint2] = useState(true);
    const [rawVisible_Static0, setRawVisible_Static0] = useState(true);
    const [rawVisible_btnPass2, setRawVisible_btnPass2] = useState(true);
    const [rawVisible_btnPass2Print3, setRawVisible_btnPass2Print3] = useState(true);
    const [rawVisible_btnPass3, setRawVisible_btnPass3] = useState(true);
    const [rawVisible_cbxOnlineGubun, setRawVisible_cbxOnlineGubun] = useState(true);
    const [rawVisible_Static1, setRawVisible_Static1] = useState(true);
    const [rawVisible_chkExpireDateFilter, setRawVisible_chkExpireDateFilter] = useState(false);
    ...
    const isVisible_btnMolPass = rawVisible_btnMolPass && rawVisible_shpGubunBox;
    ...
    const isVisible_btnAttend = rawVisible_btnAttend && rawVisible_shpGubunBox;
    ...
    const isVisible_btnPassList = rawVisible_btnPassList && rawVisible_shpGubunBox;
    ...
    const isVisible_btnPassPrint = rawVisible_btnPassPrint && rawVisible_shpGubunBox;
    const setIsVisible_btnPassPrint = setRawVisible_btnPassPrint;
    const isVisible_btnPassPrint2 = rawVisible_btnPassPrint2 && rawVisible_shpGubunBox;
    const setIsVisible_btnPassPrint2 = setRawVisible_btnPassPrint2;
    const isVisible_Static0 = rawVisible_Static0 && rawVisible_shpGubunBox;
    const setIsVisible_Static0 = setRawVisible_Static0;
    const isVisible_btnPass2 = rawVisible_btnPass2;
    const setIsVisible_btnPass2 = setRawVisible_btnPass2;
    const isVisible_btnPass2Print3 = rawVisible_btnPass2Print3 && rawVisible_shpGubunBox;
    const setIsVisible_btnPass2Print3 = setRawVisible_btnPass2Print3;
    const isVisible_btnPass3 = rawVisible_btnPass3;
    const setIsVisible_btnPass3 = setRawVisible_btnPass3;
    ...
    const isVisible_chkExpireDateFilter = rawVisible_chkExpireDateFilter && rawVisible_shpGubunBox;
    const setIsVisible_chkExpireDateFilter = setRawVisible_chkExpireDateFilter;
