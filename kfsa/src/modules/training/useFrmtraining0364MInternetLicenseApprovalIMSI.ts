...
export const useFrmtraining0364MInternetLicenseApprovalIMSI = () => {
    ...
    const [rawVisible_cbxISSuegubun, setRawVisible_cbxISSuegubun] = useState(true);
    ...
    const isVisible_medCheckCnt = rawVisible_medCheckCnt && rawVisible_Shape1;
    ...
    const isVisible_medSearchCnt = rawVisible_medSearchCnt && rawVisible_Shape1;
    const setIsVisible_medSearchCnt = setRawVisible_medSearchCnt;
    const isVisible_lbAbsentCnt = rawVisible_lbAbsentCnt && rawVisible_Shape1;
    const setIsVisible_lbAbsentCnt = setRawVisible_lbAbsentCnt;
    const isVisible_btConfirmCancell = rawVisible_btConfirmCancell && rawVisible_Shape1;
    ...
    const isVisible_cbxISSuegubun = rawVisible_cbxISSuegubun && rawVisible_Shape0;
    const setIsVisible_cbxISSuegubun = setRawVisible_cbxISSuegubun;
    ...
    return {
        ...
        isVisible_cbxISSuegubun,
        setIsVisible_cbxISSuegubun,
