...
export const FrmTrainingStat0010 = () => {
    ...
    const columns_gdList = [
        ...
        { field: 'TSJUBSUCNT_BANG1', headerName: '소방안전관리자 1급', width: 85, renderCell: (params) => <Stack spacing={0} sx={{ height: "100%", justifyContent: "center" }}><Box sx={{ height: "20px", display: "flex", alignItems: "center" }}>{params.row.TSJUBSUCNT_BANG1}</Box><Box sx={{ height: "20px", display: "flex", alignItems: "center" }}>{params.row.TSENTERCNT_BANG1}</Box><Box sx={{ height: "20px", display: "flex", alignItems: "center" }}>{params.row.TSNOTENTERCNT_BANG1}</Box><Box sx={{ height: "20px", display: "flex", alignItems: "center" }}>{params.row.TSPASSCNT_BANG1}</Box><Box sx={{ height: "20px", display: "flex", alignItems: "center" }}>{params.row.TSNOTPASSCNT_BANG1}</Box></Stack>, sortable: false },
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">시험합격자 현황</Typography>
