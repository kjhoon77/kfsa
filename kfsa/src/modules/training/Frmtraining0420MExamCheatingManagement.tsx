...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "8px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdExamCheat ? undefined : 'none' }}><Paper sx={{ width: '792px', height: '298px', width: '100%', height: 'auto', minHeight: '298px' }}><DataGridWrapper rows={hook.ds_ioExamCheat} columns={columns_gdExamCheat} /></Paper></Box></Stack>
