...
import { useFrmtraining0390MExamScheduleManagementSpecialSepComplete } from './useFrmtraining0390MExamScheduleManagementSpecialSepComplete';
import * as Frmtraining0390MExamScheduleManagementSpecialSepCompleteData from './Frmtraining0390MExamScheduleManagementSpecialSepCompleteData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmtraining0390MExamScheduleManagementSpecialSepComplete = () => {
    const hook = useFrmtraining0390MExamScheduleManagementSpecialSepComplete();
    const columns_gdExamOrder = [
        ...
        { field: 'EOCHASUGUBUN', headerName: 'EOCHASUGUBUN', width: 27 },
        ...
        { field: 'EXAMTIME', headerName: '시험시간', width: 93 },
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    ...
                    <FormControl size="small" fullWidth sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" } }}><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmtraining0390MExamScheduleManagementSpecialSepCompleteData.ds_ds_oJibu || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_lbProcMsgTitle ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '192px', height: '94px' }}><Typography variant="body2"> 회차 구분 </Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_lbProcMsg1 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '186px', height: '22px' }}><Typography variant="body2">1. 교육종료일 회차 : 001 ~ 100</Typography></Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_lbProcMsg3 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '186px', height: '22px' }}><Typography variant="body2">3. 학·경력자 회차   : 701 ~ 800</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ ml: "8px", minWidth: "578px" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '578px', height: '22px', display: 'flex', alignItems: 'center', ml: '0px' }}>
                    ...
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmtraining0390MExamScheduleManagementSpecialSepCompleteData.ds_ds_oExamGubun1 || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
                 </Stack><Box sx={{ display: hook.isVisible_radExamGubun3 ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '262px', height: '22px' }}><RadioGroup row >{ (Frmtraining0390MExamScheduleManagementSpecialSepCompleteData.ds_ds_oExamGubun3 || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box><Box sx={{ display: hook.isVisible_radExamGubun4 ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '188px', height: '22px' }}><RadioGroup row >{ (Frmtraining0390MExamScheduleManagementSpecialSepCompleteData.ds_ds_oExamGubun4 || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '283px', height: '22px', display: 'flex', alignItems: 'center', ml: '0px' }}>
                    <Typography variant="body2" sx={{ minWidth: 88, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>시험차수</Typography>
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmtraining0390MExamScheduleManagementSpecialSepCompleteData.ds_ds_ioChasuGubun || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
                 </Stack></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '190px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <Typography variant="body2" sx={{ minWidth: 10, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>~</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_Static0 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '186px', height: '22px' }}><Typography variant="body2">5. 특급 회차          : 001 ~ 100</Typography></Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '448px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    <Typography variant="body2" sx={{ minWidth: 88, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>시험일 구분</Typography>
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmtraining0390MExamScheduleManagementSpecialSepCompleteData.ds_ds_oDayGubun || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
                 </Stack></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '228px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmtraining0390MExamScheduleManagementSpecialSepCompleteData.ds_ds_oInetJubsuYn || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '224px', height: '22px', display: 'flex', alignItems: 'center', ml: '138px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '323px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <FormControl size="small" fullWidth sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" } }}><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmtraining0390MExamScheduleManagementSpecialSepCompleteData.ds_ds_oInternetJubsuStatus || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '288px', height: '22px', display: 'flex', alignItems: 'center', ml: '43px' }}>
                    <Typography variant="body2" sx={{ minWidth: 150, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>회차 사용/폐기 여부</Typography>
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmtraining0390MExamScheduleManagementSpecialSepCompleteData.ds_ds_oUseYn || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
                 </Stack></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '255px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmtraining0390MExamScheduleManagementSpecialSepCompleteData.ds_ds_oSendYN || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdExamOrder ? undefined : 'none' }}><Paper sx={{ width: '792px', height: '295px', width: '100%', height: 'auto', minHeight: '295px' }}><DataGridWrapper rows={hook.ds_ioExamOrder} columns={columns_gdExamOrder} /></Paper></Box></Stack>
...
export default Frmtraining0390MExamScheduleManagementSpecialSepComplete;
