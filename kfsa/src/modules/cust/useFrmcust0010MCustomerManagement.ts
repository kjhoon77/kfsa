...
export const useFrmcust0010MCustomerManagement = () => {
    ...
    const [isVisible_cbxPostAddrGubun, setIsVisible_cbxPostAddrGubun] = useState(true);
    ...
    const [isVisible_lbFireManagerHConvStatus, setIsVisible_lbFireManagerHConvStatus] = useState(false);
    ...
    const [isVisible_btnSMSHist, setIsVisible_btnSMSHist] = useState(true);
    ...
    const [isVisible_gdTrainingPassList, setIsVisible_gdTrainingPassList] = useState(true);
    ...
    const [isVisible_btnVAccountCno, setIsVisible_btnVAccountCno] = useState(true);
    const [isVisible_gdEduInfo, setIsVisible_gdEduInfo] = useState(true);
    const [isVisible_btnEduDataH, setIsVisible_btnEduDataH] = useState(false);
    ...
    const [isVisible_edCivilAppeal_old, setIsVisible_edCivilAppeal_old] = useState(true);
    ...
    const [isVisible_btnEduPrint, setIsVisible_btnEduPrint] = useState(false);
    const [isVisible_btnEduDataPrint, setIsVisible_btnEduDataPrint] = useState(true);
    const [isVisible_btnEduChange, setIsVisible_btnEduChange] = useState(false);
    ...
    const [isVisible_edRoadPost1, setIsVisible_edRoadPost1] = useState(true);
    const [isVisible_edRoadPost2, setIsVisible_edRoadPost2] = useState(true);
    const [isVisible_medRoadPostZipCode, setIsVisible_medRoadPostZipCode] = useState(true);
    ...
    const [isVisible_cbxPostPlace, setIsVisible_cbxPostPlace] = useState(true);
    ...
    const [isVisible_cbxEduPostPlace, setIsVisible_cbxEduPostPlace] = useState(true);
    ...
    const [isVisible_btnFireSearch, setIsVisible_btnFireSearch] = useState(false);
    ...
    const [isVisible_lbBuildingConvStatus, setIsVisible_lbBuildingConvStatus] = useState(false);
    const [isVisible_btnSuppoterInput, setIsVisible_btnSuppoterInput] = useState(true);
    const [isVisible_btnSuppoterView, setIsVisible_btnSuppoterView] = useState(true);
    const [isVisible_lbSuppoter, setIsVisible_lbSuppoter] = useState(true);
    ...
    const [isVisible_btnEduJubsu, setIsVisible_btnEduJubsu] = useState(true);
    ...
    const [isVisible_lbContinue, setIsVisible_lbContinue] = useState(true);
    const [isVisible_btnRestore, setIsVisible_btnRestore] = useState(true);
    const [isVisible_medPersonKey, setIsVisible_medPersonKey] = useState(true);
    const [isVisible_btnPostGo, setIsVisible_btnPostGo] = useState(true);
    const [isVisible_btnUpdateSameManagerInfo, setIsVisible_btnUpdateSameManagerInfo] = useState(true);
    const [isVisible_lbSuppoterCnt1, setIsVisible_lbSuppoterCnt1] = useState(true);
    const [isVisible_edSuppoterCnt, setIsVisible_edSuppoterCnt] = useState(true);
    const [isVisible_lbSuppoterCnt2, setIsVisible_lbSuppoterCnt2] = useState(true);
    const [isVisible_Static0, setIsVisible_Static0] = useState(true);
    const [isVisible_edDuplCnt, setIsVisible_edDuplCnt] = useState(true);
    const [isVisible_cbxExpireGubun, setIsVisible_cbxExpireGubun] = useState(true);
    const [isVisible_lbTJEduExpireDate, setIsVisible_lbTJEduExpireDate] = useState(false);
    const [isVisible_calTJEduExpireDate, setIsVisible_calTJEduExpireDate] = useState(false);
