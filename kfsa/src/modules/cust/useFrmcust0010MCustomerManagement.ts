...
export const useFrmcust0010MCustomerManagement = () => {
    ...
    const [rawVisible_cbxPostAddrGubun, setRawVisible_cbxPostAddrGubun] = useState(true);
    ...
    const [rawVisible_lbFireManagerHConvStatus, setRawVisible_lbFireManagerHConvStatus] = useState(false);
    ...
    const [rawVisible_btnSMSHist, setRawVisible_btnSMSHist] = useState(true);
    ...
    const [rawVisible_gdTrainingPassList, setRawVisible_gdTrainingPassList] = useState(true);
    ...
    const [rawVisible_btnVAccountCno, setRawVisible_btnVAccountCno] = useState(true);
    const [rawVisible_gdEduInfo, setRawVisible_gdEduInfo] = useState(true);
    const [rawVisible_btnEduDataH, setRawVisible_btnEduDataH] = useState(false);
    ...
    const [rawVisible_btnEduPrint, setRawVisible_btnEduPrint] = useState(false);
    const [rawVisible_btnEduDataPrint, setRawVisible_btnEduDataPrint] = useState(true);
    const [rawVisible_btnEduChange, setRawVisible_btnEduChange] = useState(false);
    ...
    const [rawVisible_edRoadPost1, setRawVisible_edRoadPost1] = useState(true);
    const [rawVisible_edRoadPost2, setRawVisible_edRoadPost2] = useState(true);
    const [rawVisible_medRoadPostZipCode, setRawVisible_medRoadPostZipCode] = useState(true);
    ...
    const [rawVisible_cbxPostPlace, setRawVisible_cbxPostPlace] = useState(true);
    ...
    const [rawVisible_cbxEduPostPlace, setRawVisible_cbxEduPostPlace] = useState(true);
    ...
    const [rawVisible_lbBuildingConvStatus, setRawVisible_lbBuildingConvStatus] = useState(false);
    const [rawVisible_btnSuppoterInput, setRawVisible_btnSuppoterInput] = useState(true);
    const [rawVisible_btnSuppoterView, setRawVisible_btnSuppoterView] = useState(true);
    const [rawVisible_lbSuppoter, setRawVisible_lbSuppoter] = useState(true);
    ...
    const [rawVisible_btnEduJubsu, setRawVisible_btnEduJubsu] = useState(true);
    ...
    const [rawVisible_lbContinue, setRawVisible_lbContinue] = useState(true);
    const [rawVisible_btnRestore, setRawVisible_btnRestore] = useState(true);
    const [rawVisible_medPersonKey, setRawVisible_medPersonKey] = useState(true);
    const [rawVisible_btnPostGo, setRawVisible_btnPostGo] = useState(true);
    const [rawVisible_btnUpdateSameManagerInfo, setRawVisible_btnUpdateSameManagerInfo] = useState(true);
    const [rawVisible_lbSuppoterCnt1, setRawVisible_lbSuppoterCnt1] = useState(true);
    const [rawVisible_edSuppoterCnt, setRawVisible_edSuppoterCnt] = useState(true);
    const [rawVisible_lbSuppoterCnt2, setRawVisible_lbSuppoterCnt2] = useState(true);
    const [rawVisible_Static0, setRawVisible_Static0] = useState(true);
    const [rawVisible_edDuplCnt, setRawVisible_edDuplCnt] = useState(true);
    const [rawVisible_cbxExpireGubun, setRawVisible_cbxExpireGubun] = useState(true);
    const [rawVisible_lbTJEduExpireDate, setRawVisible_lbTJEduExpireDate] = useState(false);
    const [rawVisible_calTJEduExpireDate, setRawVisible_calTJEduExpireDate] = useState(false);
    ...
    const isVisible_cbxPostAddrGubun = rawVisible_cbxPostAddrGubun;
    const setIsVisible_cbxPostAddrGubun = setRawVisible_cbxPostAddrGubun;
    ...
    const isVisible_lbFireManagerHConvStatus = rawVisible_lbFireManagerHConvStatus;
    const setIsVisible_lbFireManagerHConvStatus = setRawVisible_lbFireManagerHConvStatus;
    ...
    const isVisible_btnImageZoom = rawVisible_btnImageZoom;
    const setIsVisible_btnImageZoom = setRawVisible_btnImageZoom;
    const isVisible_btnSMSHist = rawVisible_btnSMSHist;
    const setIsVisible_btnSMSHist = setRawVisible_btnSMSHist;
    const isVisible_btnSendSms = rawVisible_btnSendSms;
    ...
    const isVisible_gdTrainingPassList = rawVisible_gdTrainingPassList;
    const setIsVisible_gdTrainingPassList = setRawVisible_gdTrainingPassList;
    ...
    const isVisible_lbAccountNo = rawVisible_lbAccountNo;
    const setIsVisible_lbAccountNo = setRawVisible_lbAccountNo;
    const isVisible_btnVAccountCno = rawVisible_btnVAccountCno;
    const setIsVisible_btnVAccountCno = setRawVisible_btnVAccountCno;
    const isVisible_gdEduInfo = rawVisible_gdEduInfo;
    const setIsVisible_gdEduInfo = setRawVisible_gdEduInfo;
    const isVisible_btnEduDataH = rawVisible_btnEduDataH && rawVisible_Shape5;
    const setIsVisible_btnEduDataH = setRawVisible_btnEduDataH;
    ...
    const isVisible_btnEduDataHList = rawVisible_btnEduDataHList && rawVisible_divWorkFormTitle;
    ...
    const isVisible_btnEduPrint = rawVisible_btnEduPrint;
    const setIsVisible_btnEduPrint = setRawVisible_btnEduPrint;
    const isVisible_btnEduDataPrint = rawVisible_btnEduDataPrint;
    const setIsVisible_btnEduDataPrint = setRawVisible_btnEduDataPrint;
    const isVisible_btnEduChange = rawVisible_btnEduChange;
    const setIsVisible_btnEduChange = setRawVisible_btnEduChange;
    ...
    const isVisible_edRoadPost1 = rawVisible_edRoadPost1;
    const setIsVisible_edRoadPost1 = setRawVisible_edRoadPost1;
    const isVisible_edRoadPost2 = rawVisible_edRoadPost2;
    const setIsVisible_edRoadPost2 = setRawVisible_edRoadPost2;
    const isVisible_medRoadPostZipCode = rawVisible_medRoadPostZipCode;
    const setIsVisible_medRoadPostZipCode = setRawVisible_medRoadPostZipCode;
    const isVisible_cbxAddrGubun = rawVisible_cbxAddrGubun && rawVisible_divWorkFormTitle;
    ...
    const isVisible_cbxPostPlace = rawVisible_cbxPostPlace && rawVisible_Shape3;
    const setIsVisible_cbxPostPlace = setRawVisible_cbxPostPlace;
    ...
    const isVisible_cbxEduPostPlace = rawVisible_cbxEduPostPlace && rawVisible_Shape3;
    const setIsVisible_cbxEduPostPlace = setRawVisible_cbxEduPostPlace;
    ...
    const isVisible_lbNewFMGubun = rawVisible_lbNewFMGubun && rawVisible_Shape4;
    ...
    const isVisible_lbBuildingConvStatus = rawVisible_lbBuildingConvStatus && rawVisible_Shape0;
    const setIsVisible_lbBuildingConvStatus = setRawVisible_lbBuildingConvStatus;
    const isVisible_btnSuppoterInput = rawVisible_btnSuppoterInput && rawVisible_Shape0;
    const setIsVisible_btnSuppoterInput = setRawVisible_btnSuppoterInput;
    const isVisible_btnSuppoterView = rawVisible_btnSuppoterView && rawVisible_Shape0;
    const setIsVisible_btnSuppoterView = setRawVisible_btnSuppoterView;
    const isVisible_lbSuppoter = rawVisible_lbSuppoter && rawVisible_Shape0;
    const setIsVisible_lbSuppoter = setRawVisible_lbSuppoter;
    const isVisible_lbEduExpireDate = rawVisible_lbEduExpireDate && rawVisible_Shape4;
    const setIsVisible_lbEduExpireDate = setRawVisible_lbEduExpireDate;
    const isVisible_calEduExpireDate = rawVisible_calEduExpireDate && rawVisible_Shape4;
    const setIsVisible_calEduExpireDate = setRawVisible_calEduExpireDate;
    const isVisible_btnEduJubsu = rawVisible_btnEduJubsu && rawVisible_Shape4;
    const setIsVisible_btnEduJubsu = setRawVisible_btnEduJubsu;
    const isVisible_lbElectQualify = rawVisible_lbElectQualify && rawVisible_Shape4;
    const setIsVisible_lbElectQualify = setRawVisible_lbElectQualify;
    const isVisible_cbxElectQualify = rawVisible_cbxElectQualify && rawVisible_Shape4;
    const setIsVisible_cbxElectQualify = setRawVisible_cbxElectQualify;
    const isVisible_lbContinue = rawVisible_lbContinue && rawVisible_Shape0;
    const setIsVisible_lbContinue = setRawVisible_lbContinue;
    const isVisible_btnRestore = rawVisible_btnRestore && rawVisible_Shape4;
    const setIsVisible_btnRestore = setRawVisible_btnRestore;
    const isVisible_medPersonKey = rawVisible_medPersonKey && rawVisible_Shape4;
    const setIsVisible_medPersonKey = setRawVisible_medPersonKey;
    const isVisible_btnPostGo = rawVisible_btnPostGo && rawVisible_Shape0;
    const setIsVisible_btnPostGo = setRawVisible_btnPostGo;
    const isVisible_btnUpdateSameManagerInfo = rawVisible_btnUpdateSameManagerInfo && rawVisible_Shape4;
    const setIsVisible_btnUpdateSameManagerInfo = setRawVisible_btnUpdateSameManagerInfo;
    const isVisible_lbSuppoterCnt1 = rawVisible_lbSuppoterCnt1 && rawVisible_Shape0;
    const setIsVisible_lbSuppoterCnt1 = setRawVisible_lbSuppoterCnt1;
    const isVisible_edSuppoterCnt = rawVisible_edSuppoterCnt && rawVisible_Shape0;
    const setIsVisible_edSuppoterCnt = setRawVisible_edSuppoterCnt;
    const isVisible_lbSuppoterCnt2 = rawVisible_lbSuppoterCnt2 && rawVisible_Shape0;
    const setIsVisible_lbSuppoterCnt2 = setRawVisible_lbSuppoterCnt2;
    const isVisible_Static0 = rawVisible_Static0 && rawVisible_Shape2;
    const setIsVisible_Static0 = setRawVisible_Static0;
    const isVisible_edDuplCnt = rawVisible_edDuplCnt && rawVisible_Shape2;
    const setIsVisible_edDuplCnt = setRawVisible_edDuplCnt;
    const isVisible_cbxExpireGubun = rawVisible_cbxExpireGubun && rawVisible_Shape4;
    const setIsVisible_cbxExpireGubun = setRawVisible_cbxExpireGubun;
    const isVisible_lbTJEduExpireDate = rawVisible_lbTJEduExpireDate;
    const setIsVisible_lbTJEduExpireDate = setRawVisible_lbTJEduExpireDate;
    const isVisible_calTJEduExpireDate = rawVisible_calTJEduExpireDate;
    const setIsVisible_calTJEduExpireDate = setRawVisible_calTJEduExpireDate;
    ...
    return {
        ...
        isVisible_cbxPostAddrGubun,
        setIsVisible_cbxPostAddrGubun,
        ...
        isVisible_lbFireManagerHConvStatus,
        setIsVisible_lbFireManagerHConvStatus,
        isVisible_lbLcsNo,
        ...
        isVisible_btnSMSHist,
        setIsVisible_btnSMSHist,
        ...
        isVisible_gdTrainingPassList,
        setIsVisible_gdTrainingPassList,
        isVisible_Shape5,
        setIsVisible_Shape5,
        isVisible_tabTab2,
        ...
        isVisible_btnVAccountCno,
        setIsVisible_btnVAccountCno,
        isVisible_gdEduInfo,
        setIsVisible_gdEduInfo,
        isVisible_btnEduDataH,
        setIsVisible_btnEduDataH,
        isVisible_Shape6,
        setIsVisible_Shape6,
        isVisible_div2,
        setIsVisible_div2,
        ...
        isVisible_btnEduPrint,
        setIsVisible_btnEduPrint,
        isVisible_btnEduDataPrint,
        setIsVisible_btnEduDataPrint,
        isVisible_btnEduChange,
        setIsVisible_btnEduChange,
        isVisible_lbAgency,
        ...
        isVisible_edRoadPost1,
        setIsVisible_edRoadPost1,
        isVisible_edRoadPost2,
        setIsVisible_edRoadPost2,
        isVisible_medRoadPostZipCode,
        setIsVisible_medRoadPostZipCode,
        ...
        isVisible_cbxPostPlace,
        setIsVisible_cbxPostPlace,
        isVisible_Div4,
        setIsVisible_Div4,
        ...
        isVisible_cbxEduPostPlace,
        setIsVisible_cbxEduPostPlace,
        ...
        isVisible_lbBuildingConvStatus,
        setIsVisible_lbBuildingConvStatus,
        isVisible_btnSuppoterInput,
        setIsVisible_btnSuppoterInput,
        isVisible_btnSuppoterView,
        setIsVisible_btnSuppoterView,
        isVisible_lbSuppoter,
        setIsVisible_lbSuppoter,
        isVisible_lbEduExpireDate,
        setIsVisible_lbEduExpireDate,
        isVisible_calEduExpireDate,
        setIsVisible_calEduExpireDate,
        isVisible_btnEduJubsu,
        setIsVisible_btnEduJubsu,
        isVisible_lbElectQualify,
        setIsVisible_lbElectQualify,
        isVisible_cbxElectQualify,
        setIsVisible_cbxElectQualify,
        isVisible_lbContinue,
        setIsVisible_lbContinue,
        isVisible_btnRestore,
        setIsVisible_btnRestore,
        isVisible_medPersonKey,
        setIsVisible_medPersonKey,
        isVisible_btnPostGo,
        setIsVisible_btnPostGo,
        isVisible_btnUpdateSameManagerInfo,
        setIsVisible_btnUpdateSameManagerInfo,
        isVisible_lbSuppoterCnt1,
        setIsVisible_lbSuppoterCnt1,
        isVisible_edSuppoterCnt,
        setIsVisible_edSuppoterCnt,
        isVisible_lbSuppoterCnt2,
        setIsVisible_lbSuppoterCnt2,
        isVisible_Static0,
        setIsVisible_Static0,
        isVisible_edDuplCnt,
        setIsVisible_edDuplCnt,
        isVisible_cbxExpireGubun,
        setIsVisible_cbxExpireGubun,
        isVisible_lbTJEduExpireDate,
        setIsVisible_lbTJEduExpireDate,
        isVisible_calTJEduExpireDate,
        setIsVisible_calTJEduExpireDate,
        isVisible_Static4,
