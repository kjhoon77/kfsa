...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '188px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnSendMail ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnSendMail_OnClick} sx={{ width: '105px', height: '24px', whiteSpace: "nowrap" }}>일괄 메일 발송</Button></Box><Box sx={{ display: hook.isVisible_btnSendSms ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnSendSms_OnClick} sx={{ width: '105px', height: '24px', whiteSpace: "nowrap" }}>문자메시지 발송</Button></Box></Stack>
