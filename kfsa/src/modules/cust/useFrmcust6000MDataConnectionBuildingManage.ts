...
export const useFrmcust6000MDataConnectionBuildingManage = () => {
    ...
    const [ds_ResultExcel, setds_ResultExcel] = useState<Ids_ResultExcel[]>([]);
    const [ds_ioFireManagerInfoForCmp, setds_ioFireManagerInfoForCmp] = useState<Ids_ioFireManagerInfoForCmp[]>([]);
    const [ds_ioKFFireObjForCmp, setds_ioKFFireObjForCmp] = useState<Ids_ioKFFireObjForCmp[]>([]);
    const [ds_ioMFFireObjForCmp2, setds_ioMFFireObjForCmp2] = useState<Ids_ioMFFireObjForCmp2[]>([]);
    ...
    useEffect(() => {
        ...
        setTimeout(() => {
            ...
            setds_ioGubun([]);
            setds_ResultExcel([]);
            setds_ioFireManagerInfoForCmp([]);
            setds_ioKFFireObjForCmp([]);
            setds_ioMFFireObjForCmp2([]);
            setds_ResultExcel2([]);
            setds_ioUSEAT([]);
            setIsLoading(false);
        }, 500);
    ...
    const lfn_CmpSavExcel = () => {
        console.log('lfn_CmpSavExcel clicked');
    };
    const lfn_CmpSavExcel2 = () => {
        console.log('lfn_CmpSavExcel2 clicked');
    };
    const lfn_End = () => {
    ...
    return {
        ...
        ds_ioGubun,
        ds_ResultExcel,
        ds_ioFireManagerInfoForCmp,
        ds_ioKFFireObjForCmp,
