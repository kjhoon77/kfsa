...
export const useFrmcust6201PDataConnectionSokiManageSave = () => {
    ...
    const [isVisible_lbFPISCompanyNm, setIsVisible_lbFPISCompanyNm] = useState(true);
    ...
    const [isVisible_edFPISBizNo, setIsVisible_edFPISBizNo] = useState(true);
    ...
    const [isVisible_edFPISPDetailCourse, setIsVisible_edFPISPDetailCourse] = useState(true);
    const [isVisible_lbFPISPublic, setIsVisible_lbFPISPublic] = useState(true);
    const [isVisible_Static3, setIsVisible_Static3] = useState(true);
    const [isVisible_edFPISCEO, setIsVisible_edFPISCEO] = useState(true);
    const [isVisible_chkBizNo, setIsVisible_chkBizNo] = useState(true);
    const [isVisible_edBizNo, setIsVisible_edBizNo] = useState(true);
    const [isVisible_Static1, setIsVisible_Static1] = useState(true);
    const [isVisible_edFPISNM, setIsVisible_edFPISNM] = useState(true);
    const [isVisible_Static4, setIsVisible_Static4] = useState(true);
    const [isVisible_edFPISIhidnum, setIsVisible_edFPISIhidnum] = useState(true);
    const [isVisible_Static5, setIsVisible_Static5] = useState(true);
    const [isVisible_edFPISPersonGubun, setIsVisible_edFPISPersonGubun] = useState(true);
    const [isVisible_Static7, setIsVisible_Static7] = useState(true);
    const [isVisible_edFPISStartDate, setIsVisible_edFPISStartDate] = useState(true);
    const [isVisible_cbxCompGubun, setIsVisible_cbxCompGubun] = useState(true);
    const [isVisible_chkCompGubun, setIsVisible_chkCompGubun] = useState(true);
    ...
    const [isVisible_edFPISHP, setIsVisible_edFPISHP] = useState(true);
