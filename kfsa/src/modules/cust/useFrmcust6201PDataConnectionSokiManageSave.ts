...
export const useFrmcust6201PDataConnectionSokiManageSave = () => {
    ...
    const [rawVisible_lbFPISCompanyNm, setRawVisible_lbFPISCompanyNm] = useState(true);
    ...
    const [rawVisible_edFPISBizNo, setRawVisible_edFPISBizNo] = useState(true);
    ...
    const [rawVisible_edFPISPDetailCourse, setRawVisible_edFPISPDetailCourse] = useState(true);
    const [rawVisible_lbFPISPublic, setRawVisible_lbFPISPublic] = useState(true);
    const [rawVisible_Static3, setRawVisible_Static3] = useState(true);
    const [rawVisible_edFPISCEO, setRawVisible_edFPISCEO] = useState(true);
    const [rawVisible_chkBizNo, setRawVisible_chkBizNo] = useState(true);
    const [rawVisible_edBizNo, setRawVisible_edBizNo] = useState(true);
    const [rawVisible_Static1, setRawVisible_Static1] = useState(true);
    const [rawVisible_edFPISNM, setRawVisible_edFPISNM] = useState(true);
    const [rawVisible_Static4, setRawVisible_Static4] = useState(true);
    const [rawVisible_edFPISIhidnum, setRawVisible_edFPISIhidnum] = useState(true);
    const [rawVisible_Static5, setRawVisible_Static5] = useState(true);
    const [rawVisible_edFPISPersonGubun, setRawVisible_edFPISPersonGubun] = useState(true);
    const [rawVisible_Static7, setRawVisible_Static7] = useState(true);
    const [rawVisible_edFPISStartDate, setRawVisible_edFPISStartDate] = useState(true);
    const [rawVisible_cbxCompGubun, setRawVisible_cbxCompGubun] = useState(true);
    const [rawVisible_chkCompGubun, setRawVisible_chkCompGubun] = useState(true);
    ...
    const [rawVisible_edFPISHP, setRawVisible_edFPISHP] = useState(true);
    ...
    const isVisible_lbFPISCompanyNm = rawVisible_lbFPISCompanyNm && rawVisible_Shape0;
    const setIsVisible_lbFPISCompanyNm = setRawVisible_lbFPISCompanyNm;
    ...
    const isVisible_edFPISBizNo = rawVisible_edFPISBizNo && rawVisible_Shape0;
    const setIsVisible_edFPISBizNo = setRawVisible_edFPISBizNo;
    ...
    const isVisible_edFPISPDetailCourse = rawVisible_edFPISPDetailCourse && rawVisible_Shape0;
    const setIsVisible_edFPISPDetailCourse = setRawVisible_edFPISPDetailCourse;
    ...
    const isVisible_edFPISCEO = rawVisible_edFPISCEO && rawVisible_Shape0;
    const setIsVisible_edFPISCEO = setRawVisible_edFPISCEO;
    const isVisible_chkBizNo = rawVisible_chkBizNo && rawVisible_Shape9;
    const setIsVisible_chkBizNo = setRawVisible_chkBizNo;
    const isVisible_edBizNo = rawVisible_edBizNo && rawVisible_Shape9;
    const setIsVisible_edBizNo = setRawVisible_edBizNo;
    const isVisible_Static1 = rawVisible_Static1 && rawVisible_Shape6;
    const setIsVisible_Static1 = setRawVisible_Static1;
    const isVisible_edFPISNM = rawVisible_edFPISNM && rawVisible_Shape6;
    const setIsVisible_edFPISNM = setRawVisible_edFPISNM;
    const isVisible_Static4 = rawVisible_Static4 && rawVisible_Shape6;
    const setIsVisible_Static4 = setRawVisible_Static4;
    const isVisible_edFPISIhidnum = rawVisible_edFPISIhidnum && rawVisible_Shape6;
    const setIsVisible_edFPISIhidnum = setRawVisible_edFPISIhidnum;
    const isVisible_Static5 = rawVisible_Static5 && rawVisible_Shape6;
    const setIsVisible_Static5 = setRawVisible_Static5;
    const isVisible_edFPISPersonGubun = rawVisible_edFPISPersonGubun && rawVisible_Shape6;
    const setIsVisible_edFPISPersonGubun = setRawVisible_edFPISPersonGubun;
    const isVisible_Static7 = rawVisible_Static7 && rawVisible_Shape6;
    const setIsVisible_Static7 = setRawVisible_Static7;
    const isVisible_edFPISStartDate = rawVisible_edFPISStartDate && rawVisible_Shape6;
    const setIsVisible_edFPISStartDate = setRawVisible_edFPISStartDate;
    const isVisible_cbxCompGubun = rawVisible_cbxCompGubun && rawVisible_Shape9;
    const setIsVisible_cbxCompGubun = setRawVisible_cbxCompGubun;
    const isVisible_chkCompGubun = rawVisible_chkCompGubun && rawVisible_Shape9;
    const setIsVisible_chkCompGubun = setRawVisible_chkCompGubun;
    ...
    const isVisible_edFPISHP = rawVisible_edFPISHP && rawVisible_Shape6;
    const setIsVisible_edFPISHP = setRawVisible_edFPISHP;
    ...
    return {
        ...
        isVisible_btnEnd,
        setIsVisible_btnEnd,
        isVisible_lbFPISCompanyNm,
        setIsVisible_lbFPISCompanyNm,
        ...
        isVisible_edFPISBizNo,
        setIsVisible_edFPISBizNo,
        isVisible_edFPISTel,
        ...
        isVisible_edFPISPDetailCourse,
        setIsVisible_edFPISPDetailCourse,
        isVisible_lbFPISPublic,
        setIsVisible_lbFPISPublic,
        isVisible_Static3,
        setIsVisible_Static3,
        isVisible_edFPISCEO,
        setIsVisible_edFPISCEO,
        isVisible_chkBizNo,
        setIsVisible_chkBizNo,
        isVisible_edBizNo,
        setIsVisible_edBizNo,
        isVisible_Static1,
        setIsVisible_Static1,
        isVisible_edFPISNM,
        setIsVisible_edFPISNM,
        isVisible_Static4,
        setIsVisible_Static4,
        isVisible_edFPISIhidnum,
        setIsVisible_edFPISIhidnum,
        isVisible_Static5,
        setIsVisible_Static5,
        isVisible_edFPISPersonGubun,
        setIsVisible_edFPISPersonGubun,
        isVisible_Static7,
        setIsVisible_Static7,
        isVisible_edFPISStartDate,
        setIsVisible_edFPISStartDate,
        isVisible_cbxCompGubun,
        setIsVisible_cbxCompGubun,
        isVisible_chkCompGubun,
        setIsVisible_chkCompGubun,
