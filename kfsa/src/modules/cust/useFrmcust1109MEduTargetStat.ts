...
export const useFrmcust1109MEduTargetStat = () => {
    ...
    const [isVisible_Static42, setIsVisible_Static42] = useState(false);
    const [isVisible_radMinap, setIsVisible_radMinap] = useState(false);
    ...
    const [isVisible_lbAlert, setIsVisible_lbAlert] = useState(false);
