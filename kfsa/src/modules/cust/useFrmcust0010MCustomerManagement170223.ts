...
export const useFrmcust0010MCustomerManagement170223 = () => {
    ...
    const [isVisible_cbxReceiveExcept, setIsVisible_cbxReceiveExcept] = useState(true);
    ...
    const [isVisible_cbxTechReceiveExcept, setIsVisible_cbxTechReceiveExcept] = useState(true);
    const [isVisible_lbTechReceiveExcept, setIsVisible_lbTechReceiveExcept] = useState(true);
