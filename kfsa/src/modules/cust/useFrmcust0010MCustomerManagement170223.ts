...
export const useFrmcust0010MCustomerManagement170223 = () => {
    ...
    const [rawVisible_cbxReceiveExcept, setRawVisible_cbxReceiveExcept] = useState(true);
    ...
    const [rawVisible_cbxTechReceiveExcept, setRawVisible_cbxTechReceiveExcept] = useState(true);
    const [rawVisible_lbTechReceiveExcept, setRawVisible_lbTechReceiveExcept] = useState(true);
    ...
    const isVisible_btnEduDataHList = rawVisible_btnEduDataHList;
    ...
    const isVisible_lbReceiveExcept = rawVisible_lbReceiveExcept && rawVisible_Shape2;
    const setIsVisible_lbReceiveExcept = setRawVisible_lbReceiveExcept;
    const isVisible_cbxReceiveExcept = rawVisible_cbxReceiveExcept && rawVisible_Shape2;
    const setIsVisible_cbxReceiveExcept = setRawVisible_cbxReceiveExcept;
    ...
    const isVisible_lbEduExpireDate = rawVisible_lbEduExpireDate;
    const setIsVisible_lbEduExpireDate = setRawVisible_lbEduExpireDate;
    const isVisible_calEduExpireDate = rawVisible_calEduExpireDate;
    const setIsVisible_calEduExpireDate = setRawVisible_calEduExpireDate;
    const isVisible_btnEduJubsu = rawVisible_btnEduJubsu;
    ...
    const isVisible_cbxTechReceiveExcept = rawVisible_cbxTechReceiveExcept && rawVisible_Shape2;
    const setIsVisible_cbxTechReceiveExcept = setRawVisible_cbxTechReceiveExcept;
    const isVisible_lbTechReceiveExcept = rawVisible_lbTechReceiveExcept && rawVisible_Shape2;
    const setIsVisible_lbTechReceiveExcept = setRawVisible_lbTechReceiveExcept;
    ...
    return {
        ...
        isVisible_cbxReceiveExcept,
        setIsVisible_cbxReceiveExcept,
        ...
        isVisible_cbxTechReceiveExcept,
        setIsVisible_cbxTechReceiveExcept,
        isVisible_lbTechReceiveExcept,
        setIsVisible_lbTechReceiveExcept,
