...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_radReport ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '244px', height: '22px' }}><RadioGroup row >{ (Frmcust0090MReturnPostReportData.ds_ds_oReport || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "16px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdCheckList ? undefined : 'none' }}><Paper sx={{ width: '864px', height: '175px', width: '100%', height: 'auto', minHeight: '175px' }}><DataGridWrapper rows={hook.ds_oCheckList} columns={columns_gdCheckList} /></Paper></Box></Stack>
