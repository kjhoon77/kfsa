...
import { useFrmcust1320MEduCertiExecutiveAbilityEvaluation } from './useFrmcust1320MEduCertiExecutiveAbilityEvaluation';
import * as Frmcust1320MEduCertiExecutiveAbilityEvaluationData from './Frmcust1320MEduCertiExecutiveAbilityEvaluationData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmcust1320MEduCertiExecutiveAbilityEvaluation = () => {
    const hook = useFrmcust1320MEduCertiExecutiveAbilityEvaluation();
    const [chk_chk_print, setChk_chk_print] = useState('0');
    return (
        <PageContainer>
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    ...
                    <FormControl size="small" fullWidth sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" } }}><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmcust1320MEduCertiExecutiveAbilityEvaluationData.ds_ds_oJibu || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
                 </Stack></Stack>
...
export default Frmcust1320MEduCertiExecutiveAbilityEvaluation;
