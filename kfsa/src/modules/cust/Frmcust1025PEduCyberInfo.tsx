...
export const Frmcust1025PEduCyberInfo = () => {
    ...
    const columns_gdEduJubsu = [
        ...
        { field: 'col_8', headerName: '회원구분', width: 64 },
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "39px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdEduJubsu ? undefined : 'none' }}><Paper sx={{ width: '826px', height: '476px', width: '100%', height: 'auto', minHeight: '476px' }}><DataGridWrapper rows={hook.ds_oEduJubsu} columns={columns_gdEduJubsu} /></Paper></Box></Stack>
