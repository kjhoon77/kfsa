...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '172px', height: '22px', display: 'flex', alignItems: 'center', ml: '408px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_Static27 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '17px', height: '22px' }}><Typography variant="body2">명</Typography></Box></Box><Box sx={{ display: hook.isVisible_btnSetlmt ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnSetlmt_OnClick} sx={{ width: '184px', height: '66px' }}>교육대상자 배정</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnBuliding ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnBarCodeSearch_OnClick} sx={{ width: '106px', height: '24px' }}>동일 업체명 조회</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static5 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '80px', height: '22px' }}><Typography variant="body2">자료생성여부</Typography></Box></Box><Box sx={{ display: hook.isVisible_chkCheckbox6 ? undefined : 'none' }}><Box sx={{ width: '116px', height: '22px', border: '1px dashed grey' }}>Unknown: Checkbox</Box></Box><Box sx={{ display: hook.isVisible_chkCheckbox4 ? undefined : 'none' }}><Box sx={{ width: '151px', height: '22px', border: '1px dashed grey' }}>Unknown: Checkbox</Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static19 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '72px', height: '22px' }}><Typography variant="body2">출력여부</Typography></Box></Box><Box sx={{ ml: "4px", minWidth: "176px" }}><Box sx={{ display: hook.isVisible_Checkbox1 ? undefined : 'none' }}><Box sx={{ width: '92px', height: '22px', border: '1px dashed grey' }}>Unknown: Checkbox</Box></Box><Box sx={{ display: hook.isVisible_Checkbox2 ? undefined : 'none' }}><Box sx={{ width: '96px', height: '22px', border: '1px dashed grey' }}>Unknown: Checkbox</Box></Box></Box><Box sx={{ display: hook.isVisible_Checkbox7 ? undefined : 'none' }}><Box sx={{ width: '132px', height: '22px', border: '1px dashed grey' }}>Unknown: Checkbox</Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Button0 ? undefined : 'none' }}><Button variant="contained"  onClick={hook.Div0_Button4Yes_OnClick} sx={{ width: '38px', height: '30px' }}>확인</Button></Box><Box sx={{ display: hook.isVisible_Button4 ? undefined : 'none' }}><Button variant="contained"  onClick={hook.Div0_Button4_OnClick} sx={{ width: '38px', height: '30px' }}>취소</Button></Box></Stack>
