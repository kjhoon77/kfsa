...
export const useFrmcust0150MManagerReport = () => {
    ...
    const [rawVisible_medNMemberCnt, setRawVisible_medNMemberCnt] = useState(true);
    ...
    const [rawVisible_radBook1, setRawVisible_radBook1] = useState(true);
    const [rawVisible_Static6, setRawVisible_Static6] = useState(true);
    const [rawVisible_radBook2, setRawVisible_radBook2] = useState(true);
    ...
    const isVisible_medNMemberCnt = rawVisible_medNMemberCnt && rawVisible_Shape1;
    const setIsVisible_medNMemberCnt = setRawVisible_medNMemberCnt;
    ...
    const isVisible_radBook1 = rawVisible_radBook1 && rawVisible_Shape3;
    const setIsVisible_radBook1 = setRawVisible_radBook1;
    const isVisible_Static6 = rawVisible_Static6 && rawVisible_Shape3;
    const setIsVisible_Static6 = setRawVisible_Static6;
    const isVisible_radBook2 = rawVisible_radBook2 && rawVisible_Shape3;
    const setIsVisible_radBook2 = setRawVisible_radBook2;
