...
export const useFrmcust5010 = () => {
    ...
    const [isVisible_edOBJ_MANAGE_NO, setIsVisible_edOBJ_MANAGE_NO] = useState(true);
    ...
    const [isVisible_edTObjNm, setIsVisible_edTObjNm] = useState(true);
    const [isVisible_btnToExcel, setIsVisible_btnToExcel] = useState(true);
    const [isVisible_cbxTObjNm, setIsVisible_cbxTObjNm] = useState(false);
    const [isVisible_edTObjCnt, setIsVisible_edTObjCnt] = useState(false);
