...
export const useFrmcust5010 = () => {
    ...
    const [rawVisible_edOBJ_MANAGE_NO, setRawVisible_edOBJ_MANAGE_NO] = useState(true);
    ...
    const [rawVisible_edTObjNm, setRawVisible_edTObjNm] = useState(true);
    const [rawVisible_btnToExcel, setRawVisible_btnToExcel] = useState(true);
    const [rawVisible_cbxTObjNm, setRawVisible_cbxTObjNm] = useState(false);
    const [rawVisible_edTObjCnt, setRawVisible_edTObjCnt] = useState(false);
    ...
    const isVisible_edOBJ_MANAGE_NO = rawVisible_edOBJ_MANAGE_NO;
    const setIsVisible_edOBJ_MANAGE_NO = setRawVisible_edOBJ_MANAGE_NO;
    ...
    const isVisible_btnMatchCancel = rawVisible_btnMatchCancel && rawVisible_shpBtnBox;
    ...
    const isVisible_edTObjNm = rawVisible_edTObjNm;
    const setIsVisible_edTObjNm = setRawVisible_edTObjNm;
    const isVisible_btnToExcel = rawVisible_btnToExcel && rawVisible_shpBtnBox;
    const setIsVisible_btnToExcel = setRawVisible_btnToExcel;
    const isVisible_cbxTObjNm = rawVisible_cbxTObjNm;
    const setIsVisible_cbxTObjNm = setRawVisible_cbxTObjNm;
    const isVisible_edTObjCnt = rawVisible_edTObjCnt;
    const setIsVisible_edTObjCnt = setRawVisible_edTObjCnt;
    ...
    return {
        ...
        isVisible_edOBJ_MANAGE_NO,
        setIsVisible_edOBJ_MANAGE_NO,
        ...
        isVisible_edTObjNm,
        setIsVisible_edTObjNm,
        isVisible_btnToExcel,
        setIsVisible_btnToExcel,
        isVisible_cbxTObjNm,
        setIsVisible_cbxTObjNm,
        isVisible_edTObjCnt,
        setIsVisible_edTObjCnt,
        tabValue_tabTab1,
        setTabValue_tabTab1,
        tabValue_tabTab2,
        setTabValue_tabTab2,
