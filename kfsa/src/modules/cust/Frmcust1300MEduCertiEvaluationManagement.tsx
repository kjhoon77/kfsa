...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        ...
                        <Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "42px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnSave ? undefined : 'none' }}><Button variant="contained"  onClick={hook.lfn_Save} sx={{ width: '64px', height: '24px' }}>합격</Button></Box><Box sx={{ display: hook.isVisible_btnCancle ? undefined : 'none' }}><Button variant="contained"  onClick={hook.ifn_cancle} sx={{ width: '65px', height: '24px' }}>취소</Button></Box><Box sx={{ ml: "357px", minWidth: "237px" }}><Box sx={{ display: hook.isVisible_btnPrint ? undefined : 'none' }}><Button variant="contained"  onClick={hook.lfn_Print} sx={{ width: '126px', height: '24px' }}>접수자목록출력</Button></Box><Box sx={{ display: hook.isVisible_btnPrintList1 ? undefined : 'none' }}><Button variant="contained"  onClick={hook.lfn_PrintName} sx={{ width: '118px', height: '24px' }}>접수자명단</Button></Box></Box><Box sx={{ display: hook.isVisible_btnPrintList2 ? undefined : 'none' }}><Button variant="contained"  onClick={hook.lfn_PrintNameBoard} sx={{ width: '170px', height: '24px' }}>접수자명단(게시판용)</Button></Box></Stack>
