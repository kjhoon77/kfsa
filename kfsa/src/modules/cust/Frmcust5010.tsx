...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "5px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '238px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                    ...
                    <TextField size="small" fullWidth value={hook.ds_ioFireSurvey?.OBJ_MANAGE_NO || ''} sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '247px', height: '22px', display: 'flex', alignItems: 'center', ml: '3px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_edOBJ_STDR_CODE ? undefined : 'none' }}><TextField size="small" fullWidth value={hook.ds_ioFireSurvey?.OBJ_STDR_CODE || ''} sx={{ width: '117px', height: '22px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '238px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                    ...
                    <Typography variant="body2" sx={{ minWidth: 96, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>대지면적</Typography>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '174px', height: '22px', display: 'flex', alignItems: 'center', ml: '1px' }}>
                    <Typography variant="body2" sx={{ minWidth: 96, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>바닥면적</Typography>
                    ...
                    <Typography variant="body2" sx={{ minWidth: 96, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>연면적</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '488px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '276px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '238px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '345px', height: '22px', display: 'flex', alignItems: 'center', ml: '3px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '178px', height: '22px', display: 'flex', alignItems: 'center', ml: '1px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '238px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_edPBLINSTT_CL_CODE ? undefined : 'none' }}><TextField size="small" fullWidth value={hook.ds_ioFireSurvey?.PBLINSTT_CL_CODE || ''} sx={{ width: '130px', height: '22px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '238px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_edLQTT_SE_CODE ? undefined : 'none' }}><TextField size="small" fullWidth value={hook.ds_ioFireSurvey?.LQTT_SE_CODE || ''} sx={{ width: '101px', height: '22px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '238px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "15px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_tabTab1_3 ? undefined : 'none' }}><Box sx={{ width: '776px', height: '322px', width: "100%", height: "auto", minHeight: "322px" }}><Box sx={{ borderBottom: 1, borderColor: "divider" }}><Tabs value={tabValue_tabTab1_3} onChange={(e, v) => setTabValue_tabTab1_3(v)} aria-label="tabTab1_3"><Tab label="      소방안전관리자정보      " /><Tab label="      소방안전관리보조자정보      " /><Tab label="          관계자정보          " /></Tabs></Box><CustomTabPanel value={tabValue_tabTab1_3} index={0}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "9px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static24 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '24px' }}><Typography variant="body2">소방안전관리자현황</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdAdminList ? undefined : 'none' }}><Paper sx={{ width: '764px', height: '193px', width: '100%', height: 'auto', minHeight: '193px' }}><DataGridWrapper rows={hook.ds_ioFireSurveyAdministratorInfo} columns={columns_gdAdminList} /></Paper></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static0 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '24px' }}><Typography variant="body2">자격증정보</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdLicense ? undefined : 'none' }}><Paper sx={{ width: '764px', height: '174px', width: '100%', height: 'auto', minHeight: '174px' }}><DataGridWrapper rows={hook.ds_ioFireSurveyLicenseInfo} columns={columns_gdLicense} /></Paper></Box></Stack>
</CustomTabPanel><CustomTabPanel value={tabValue_tabTab1_3} index={1}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "7px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static24_2 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '163px', height: '24px' }}><Typography variant="body2">소방안전관리보조자현황</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdAdminList_2 ? undefined : 'none' }}><Paper sx={{ width: '764px', height: '193px', width: '100%', height: 'auto', minHeight: '193px' }}><DataGridWrapper rows={hook.ds_ioFireSurveySubAdministratorInfo} columns={columns_gdAdminList_2} /></Paper></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static0_2 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '24px' }}><Typography variant="body2">자격증정보</Typography></Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '237px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '476px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static7_2 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '85px', height: '22px' }}><Typography variant="body2">층</Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '61px', height: '22px', display: 'flex', alignItems: 'center', ml: '7px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '64px', height: '22px', display: 'flex', alignItems: 'center', ml: '19px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_Static5_2 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '85px', height: '22px' }}><Typography variant="body2">면적</Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '100px', height: '22px', display: 'flex', alignItems: 'center', ml: '11px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '119px', height: '22px', display: 'flex', alignItems: 'center', ml: '5px' }}>
                    <Typography variant="body2" sx={{ minWidth: 53, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>연면적</Typography>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '100px', height: '22px', display: 'flex', alignItems: 'center', ml: '0px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "14px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static12_2 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">인허가정보</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "5px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '237px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "13px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static15_2 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">동시설정보</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "5px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static16 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '85px', height: '22px' }}><Typography variant="body2">계단수</Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '133px', height: '22px', display: 'flex', alignItems: 'center', ml: '1px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '108px', height: '22px', display: 'flex', alignItems: 'center', ml: '6px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '107px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '105px', height: '22px', display: 'flex', alignItems: 'center', ml: '4px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '183px', height: '22px', display: 'flex', alignItems: 'center', ml: '4px' }}>
                    <Typography variant="body2" sx={{ minWidth: 85, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>경사로</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '183px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                    <Typography variant="body2" sx={{ minWidth: 85, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>일반승강기</Typography>
                    ...
                    <Typography variant="body2" sx={{ minWidth: 85, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>비상승강기</Typography>
                    ...
                    <Typography variant="body2" sx={{ minWidth: 85, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>에스컬레이트</Typography>
                    ...
                    <Typography variant="body2" sx={{ minWidth: 85, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>비상구</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "12px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static17_2 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">시스템변경정보</Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '237px', height: '22px', display: 'flex', alignItems: 'center', ml: '7px' }}>
...
</CustomTabPanel><CustomTabPanel value={tabValue_tabTab1_2} index={2}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "6px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static8_3 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">층별현황</Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '246px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                    <Typography variant="body2" sx={{ minWidth: 96, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>동명</Typography>
                    <FormControl size="small" fullWidth sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" } }}><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmcust5010Data.ds_ds_ioFireSurveyDong || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
                 </Stack></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdFloorStatus ? undefined : 'none' }}><Paper sx={{ width: '766px', height: '145px', width: '100%', height: 'auto', minHeight: '145px' }}><DataGridWrapper rows={hook.ds_ioFireSurveyFloorStatus} columns={columns_gdFloorStatus} /></Paper></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '258px', height: '22px', display: 'flex', alignItems: 'center', ml: '6px' }}>
                    <Typography variant="body2" sx={{ minWidth: 120, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>특수용도현황</Typography>
                    <FormControl component="fieldset" sx={{ width: "max-content", whiteSpace: "nowrap" }}><RadioGroup row sx={{ flexWrap: "nowrap" }} >{ (Frmcust5010Data.ds_ds_oSGubun || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} sx={{ whiteSpace: 'nowrap', flexShrink: 0, mr: 2 }} />) }</RadioGroup></FormControl>
                 </Stack></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "5px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '238px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                    ...
                    <Typography variant="body2" sx={{ minWidth: 96, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>대상구분</Typography>
                    <TextField size="small" fullWidth value={hook.ds_ioFireSurvey?.OBJ_SE_CODE || ''} sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_edOBJ_STDR_CODE_2 ? undefined : 'none' }}><TextField size="small" fullWidth value={hook.ds_ioFireSurvey?.OBJ_STDR_CODE || ''} sx={{ width: '117px', height: '22px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '238px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                    <Typography variant="body2" sx={{ minWidth: 96, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>주용도</Typography>
                    <TextField size="small" fullWidth value={hook.ds_ioFireSurvey?.MAIN_PRPOS_CODE || ''} sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '175px', height: '22px', display: 'flex', alignItems: 'center', ml: '3px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '238px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                    ...
                    <Typography variant="body2" sx={{ minWidth: 96, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>공공기관</Typography>
                    <TextField size="small" fullWidth value={hook.ds_ioFireSurvey?.PBLINSTT_AT || ''} sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_edPBLINSTT_CL_CODE_2 ? undefined : 'none' }}><TextField size="small" fullWidth value={hook.ds_ioFireSurvey?.PBLINSTT_CL_CODE || ''} sx={{ width: '130px', height: '22px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '238px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                    <Typography variant="body2" sx={{ minWidth: 96, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>위험물대상</Typography>
                    <TextField size="small" fullWidth value={hook.ds_ioFireSurvey?.DGST_TRGET_AT || ''} sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '247px', height: '22px', display: 'flex', alignItems: 'center', ml: '3px' }}>
                    ...
                    <Typography variant="body2" sx={{ minWidth: 126, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>대량위험물제조소등</Typography>
                    <TextField size="small" fullWidth value={hook.ds_ioFireSurvey?.LQTT_AT || ''} sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_edLQTT_SE_CODE_2 ? undefined : 'none' }}><TextField size="small" fullWidth value={hook.ds_ioFireSurvey?.LQTT_SE_CODE || ''} sx={{ width: '101px', height: '22px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '238px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                    <Typography variant="body2" sx={{ minWidth: 96, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>사용여부</Typography>
                    <TextField size="small" fullWidth value={hook.ds_ioFireSurvey?.USE_AT || ''} sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '247px', height: '22px', display: 'flex', alignItems: 'center', ml: '3px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "15px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_tabTab1_4 ? undefined : 'none' }}><Box sx={{ width: '776px', height: '322px', width: "100%", height: "auto", minHeight: "322px" }}><Box sx={{ borderBottom: 1, borderColor: "divider" }}><Tabs value={tabValue_tabTab1_4} onChange={(e, v) => setTabValue_tabTab1_4(v)} aria-label="tabTab1_4"><Tab label="      소방안전관리자정보      " /><Tab label="      소방안전관리보조자정보      " /><Tab label="          관계자정보          " /></Tabs></Box><CustomTabPanel value={tabValue_tabTab1_4} index={0}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "9px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static24_4 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '24px' }}><Typography variant="body2">소방안전관리자현황</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdAdminList_3 ? undefined : 'none' }}><Paper sx={{ width: '764px', height: '193px', width: '100%', height: 'auto', minHeight: '193px' }}><DataGridWrapper rows={hook.ds_ioFireSurveyAdministratorInfo} columns={columns_gdAdminList_3} /></Paper></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static0_6 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '24px' }}><Typography variant="body2">자격증정보</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdLicense_3 ? undefined : 'none' }}><Paper sx={{ width: '764px', height: '174px', width: '100%', height: 'auto', minHeight: '174px' }}><DataGridWrapper rows={hook.ds_ioFireSurveyLicenseInfo} columns={columns_gdLicense_3} /></Paper></Box></Stack>
</CustomTabPanel><CustomTabPanel value={tabValue_tabTab1_4} index={1}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "7px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static24_5 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '163px', height: '24px' }}><Typography variant="body2">소방안전관리보조자현황</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdAdminList_4 ? undefined : 'none' }}><Paper sx={{ width: '764px', height: '193px', width: '100%', height: 'auto', minHeight: '193px' }}><DataGridWrapper rows={hook.ds_ioFireSurveySubAdministratorInfo} columns={columns_gdAdminList_4} /></Paper></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static0_7 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '24px' }}><Typography variant="body2">자격증정보</Typography></Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static7_4 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '85px', height: '22px' }}><Typography variant="body2">층</Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '61px', height: '22px', display: 'flex', alignItems: 'center', ml: '7px' }}>
                    <Typography variant="body2" sx={{ minWidth: 29, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>지상</Typography>
                    <TextField size="small" fullWidth value={hook.ds_ioFireSurveyDong?.TRRPHNM_FLOOR_QT || ''} sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '64px', height: '22px', display: 'flex', alignItems: 'center', ml: '19px' }}>
                    <Typography variant="body2" sx={{ minWidth: 29, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>지하</Typography>
                    <TextField size="small" fullWidth value={hook.ds_ioFireSurveyDong?.UNDGRND_FLOOR_QT || ''} sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_Static5_4 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '85px', height: '22px' }}><Typography variant="body2">면적</Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '100px', height: '22px', display: 'flex', alignItems: 'center', ml: '11px' }}>
                    <Typography variant="body2" sx={{ minWidth: 29, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>부지</Typography>
                    <TextField size="small" fullWidth value={hook.ds_ioFireSurveyDong?.PLOT_AR || ''} sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '99px', height: '22px', display: 'flex', alignItems: 'center', ml: '0px' }}>
                    <Typography variant="body2" sx={{ minWidth: 29, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>바닥</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "14px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static12_4 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">인허가정보</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "5px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '237px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                    <Typography variant="body2" sx={{ minWidth: 85, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>허가일자</Typography>
                    <TextField size="small" fullWidth value={hook.ds_ioFireSurveyDong?.PRMISN_DE_8 || ''} sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '237px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "13px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static15_4 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">동시설정보</Typography></Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "12px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static17_4 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">시스템변경정보</Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '237px', height: '22px', display: 'flex', alignItems: 'center', ml: '7px' }}>
                    <Typography variant="body2" sx={{ minWidth: 85, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>최초등록일</Typography>
                    <TextField size="small" fullWidth value={hook.ds_ioFireSurveyDong?.REGIST_DE_14 || ''} sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '237px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                    <Typography variant="body2" sx={{ minWidth: 85, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>최종수정일</Typography>
...
</CustomTabPanel><CustomTabPanel value={tabValue_tabTab1} index={1}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "6px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static8_7 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">허가 정보</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '246px', height: '22px', display: 'flex', alignItems: 'center', ml: '89px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_edMNFCTRETC_DETAIL_SE_CODE ? undefined : 'none' }}><TextField size="small" fullWidth value={hook.ds_ioDanMnfctretcInfo?.MNFCTRETC_DETAIL_SE_CODE_NM || ''} sx={{ width: '144px', height: '22px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '246px', height: '22px', display: 'flex', alignItems: 'center', ml: '89px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '143px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                    <Typography variant="body2" sx={{ minWidth: 64, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>완공일자</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '148px', height: '22px', display: 'flex', alignItems: 'center', ml: '89px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '163px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '185px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '271px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                    <Typography variant="body2" sx={{ minWidth: 88, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>용도폐지사유</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "7px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static4_6 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">설치자 정보</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '149px', height: '22px', display: 'flex', alignItems: 'center', ml: '89px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '183px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '153px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                    <Typography variant="body2" sx={{ minWidth: 61, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>생년월일</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '149px', height: '22px', display: 'flex', alignItems: 'center', ml: '89px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '196px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '424px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "5px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static14_6 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">제조소등 정보</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '313px', height: '22px', display: 'flex', alignItems: 'center', ml: '89px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '281px', height: '22px', display: 'flex', alignItems: 'center', ml: '1px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '176px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                    <Typography variant="body2" sx={{ minWidth: 84, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>건물동/층</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '458px', height: '22px', display: 'flex', alignItems: 'center', ml: '89px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_Static19_5 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '14px', height: '18px' }}><Typography variant="body2">배</Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '108px', height: '22px', display: 'flex', alignItems: 'center', ml: '1px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '66px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                    <Typography variant="body2" sx={{ minWidth: 42, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>군용</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '774px', height: '38px', display: 'flex', alignItems: 'center', ml: '89px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "6px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static0_12 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">시스템변경정보</Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '174px', height: '22px', display: 'flex', alignItems: 'center', ml: '3px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "10px", py: 0.5, width: "100%" }}><Box sx={{ ml: "85px", minWidth: "780px" }}><Box sx={{ display: hook.isVisible_tabTab2_2 ? undefined : 'none' }}><Box sx={{ width: '780px', height: '259px', width: "100%", height: "auto", minHeight: "259px" }}><Box sx={{ borderBottom: 1, borderColor: "divider" }}><Tabs value={tabValue_tabTab2_2} onChange={(e, v) => setTabValue_tabTab2_2(v)} aria-label="tabTab2_2"><Tab label="      부가정보      " /><Tab label="       지위승계       " /><Tab label="      선임자정보      " /></Tabs></Box><CustomTabPanel value={tabValue_tabTab2_2} index={0}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "14px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static8_6 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">차량정보</Typography></Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "6px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static2_5 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">위험물정보</Typography></Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "6px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static9_5 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">탱크정보</Typography></Box></Box></Stack>
...
</CustomTabPanel><CustomTabPanel value={tabValue_tabTab2_2} index={1}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "8px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdStatusSucces ? undefined : 'none' }}><Paper sx={{ width: '764px', height: '223px', width: '100%', height: 'auto', minHeight: '223px' }}><DataGridWrapper rows={hook.ds_ioDanStatusSuccession} columns={columns_gdStatusSucces} /></Paper></Box></Stack>
</CustomTabPanel><CustomTabPanel value={tabValue_tabTab2_2} index={2}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "8px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdManagerInfo ? undefined : 'none' }}><Paper sx={{ width: '764px', height: '223px', width: '100%', height: 'auto', minHeight: '223px' }}><DataGridWrapper rows={hook.ds_ioDanManagerInfo} columns={columns_gdManagerInfo} /></Paper></Box></Stack>
</CustomTabPanel></Box></Box><Box sx={{ display: hook.isVisible_tabTab1_5 ? undefined : 'none' }}><Box sx={{ width: '780px', height: '259px', width: "100%", height: "auto", minHeight: "259px" }}><Box sx={{ borderBottom: 1, borderColor: "divider" }}><Tabs value={tabValue_tabTab1_5} onChange={(e, v) => setTabValue_tabTab1_5(v)} aria-label="tabTab1_5"><Tab label="      선임자정보      " /><Tab label="      설비정보      " /><Tab label="    탱크유별현황    " /><Tab label="       지위승계       " /></Tabs></Box><CustomTabPanel value={tabValue_tabTab1_5} index={0}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "8px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdManagerInfo_2 ? undefined : 'none' }}><Paper sx={{ width: '764px', height: '223px', width: '100%', height: 'auto', minHeight: '223px' }}><DataGridWrapper rows={hook.ds_ioDanManagerInfo} columns={columns_gdManagerInfo_2} /></Paper></Box></Stack>
...
</CustomTabPanel><CustomTabPanel value={tabValue_tabTab1_5} index={2}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "8px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdTankInfo ? undefined : 'none' }}><Paper sx={{ width: '764px', height: '223px', width: '100%', height: 'auto', minHeight: '223px' }}><DataGridWrapper rows={hook.ds_ioDanTankInfo} columns={columns_gdTankInfo} /></Paper></Box></Stack>
</CustomTabPanel><CustomTabPanel value={tabValue_tabTab1_5} index={3}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "8px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdStatusSucces_2 ? undefined : 'none' }}><Paper sx={{ width: '764px', height: '223px', width: '100%', height: 'auto', minHeight: '223px' }}><DataGridWrapper rows={hook.ds_ioDanStatusSuccession} columns={columns_gdStatusSucces_2} /></Paper></Box></Stack>
</CustomTabPanel></Box></Box></Box></Stack>
</CustomTabPanel><CustomTabPanel value={tabValue_tabTab1} index={2}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static6_7 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '128px', height: '22px' }}><Typography variant="body2">업체정보</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '345px', height: '22px', display: 'flex', alignItems: 'center', ml: '87px' }}>
                    <Typography variant="body2" sx={{ minWidth: 139, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>업체명</Typography>
                 ...
                 </Stack><Box sx={{ ml: "0px", minWidth: "435px" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '274px', height: '22px', display: 'flex', alignItems: 'center', ml: '0px' }}>
                    <Typography variant="body2" sx={{ minWidth: 139, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>업체구분</Typography>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_edENTRPS_DETAIL_SENM ? undefined : 'none' }}><TextField size="small" fullWidth value={hook.ds_ioFightFireCompany?.ENTRPS_DETAIL_SENM || ''} sx={{ width: '167px', height: '22px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '345px', height: '22px', display: 'flex', alignItems: 'center', ml: '87px' }}>
                    <Typography variant="body2" sx={{ minWidth: 139, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>사업자(법인)등록번호</Typography>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '274px', height: '22px', display: 'flex', alignItems: 'center', ml: '0px' }}>
                    <Typography variant="body2" sx={{ minWidth: 139, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>대표자</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '345px', height: '22px', display: 'flex', alignItems: 'center', ml: '87px' }}>
                    <Typography variant="body2" sx={{ minWidth: 139, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>관할서/센터</Typography>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '435px', height: '22px', display: 'flex', alignItems: 'center', ml: '0px' }}>
                    <Typography variant="body2" sx={{ minWidth: 139, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>주소</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '345px', height: '22px', display: 'flex', alignItems: 'center', ml: '87px' }}>
                    <Typography variant="body2" sx={{ minWidth: 139, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>전화번호</Typography>
                    ...
                    <Typography variant="body2" sx={{ minWidth: 139, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>팩스번호</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '345px', height: '22px', display: 'flex', alignItems: 'center', ml: '87px' }}>
                    <Typography variant="body2" sx={{ minWidth: 139, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>최초등록일</Typography>
                    ...
                    <Typography variant="body2" sx={{ minWidth: 139, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>최종수정일</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "8px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static11_7 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '128px', height: '22px' }}><Typography variant="body2">기술자정보</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdPHuman ? undefined : 'none' }}><Paper sx={{ width: '784px', height: '261px', width: '100%', height: 'auto', minHeight: '261px' }}><DataGridWrapper rows={hook.ds_ioFightFireCompanyPossessionHuman} columns={columns_gdPHuman} /></Paper></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static12_7 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '128px', height: '22px' }}><Typography variant="body2">보유자격정보</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdLicenscInfo ? undefined : 'none' }}><Paper sx={{ width: '784px', height: '144px', width: '100%', height: 'auto', minHeight: '144px' }}><DataGridWrapper rows={hook.ds_ioFightFireCompanyFireLicenseInfo} columns={columns_gdLicenscInfo} /></Paper></Box></Stack>
