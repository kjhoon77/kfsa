...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_radReport ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '484px', height: '42px' }}><RadioGroup row >{ (Frmcust1141MCyberEduReportData.ds_ds_ioReport || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_radPrintGubun1 ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '232px', height: '22px' }}><RadioGroup row >{ (Frmcust1141MCyberEduReportData.ds_ds_ioPrintGubun1 || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box><Box sx={{ display: hook.isVisible_radPrintGubun2 ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '240px', height: '22px' }}><RadioGroup row >{ (Frmcust1141MCyberEduReportData.ds_ds_ioPrintGubun2 || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Stack>
