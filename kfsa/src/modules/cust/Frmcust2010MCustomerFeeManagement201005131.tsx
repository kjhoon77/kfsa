...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '336px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnBuildingNm ? undefined : 'none' }}><Button variant="outlined" onClick={hook.btnBuildingNm_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '22px', height: '24px' }}><Search fontSize="small" /></Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '164px', height: '22px', display: 'flex', alignItems: 'center', ml: '11px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '136px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnManagerNo ? undefined : 'none' }}><Button variant="outlined" onClick={hook.btnManagerNo_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '22px', height: '24px' }}><Search fontSize="small" /></Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '172px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                    <Typography variant="body2" sx={{ minWidth: 60, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>주민번호</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnManagerNm ? undefined : 'none' }}><Button variant="outlined" onClick={hook.btnManagerNm_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '22px', height: '24px' }}><Search fontSize="small" /></Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '120px', height: '22px', display: 'flex', alignItems: 'center', ml: '11px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '360px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnOverBiz ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnOverBiz_OnClick} sx={{ width: '79px', height: '24px' }}>겸직현황</Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '120px', height: '22px', display: 'flex', alignItems: 'center', ml: '9px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '144px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnSunapReady ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnSunapReady_OnClick} sx={{ width: '105px', height: '24px' }}>수납결제 대기</Button></Box><Box sx={{ display: hook.isVisible_btnMunje ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnMunje_OnClick} sx={{ width: '105px', height: '24px' }}>승계면제 저장</Button></Box><Box sx={{ display: hook.isVisible_Static12 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '104px', height: '22px' }}><Typography variant="body2">결제 정보(POS)</Typography></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnDel ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnDel_OnClick} sx={{ width: '79px', height: '24px' }}>결제삭제</Button></Box><Box sx={{ display: hook.isVisible_btnRepay ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnRepay_OnClick} sx={{ width: '105px', height: '24px' }}>환불결제 대기</Button></Box><Box sx={{ display: hook.isVisible_btnSunapPosInfo ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnSunapPosInfo_OnClick} sx={{ width: '79px', height: '24px' }}>상세정보</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '168px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    <Typography variant="body2" sx={{ minWidth: 73, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>마감일</Typography>
                    <DatePicker format="yyyy/MM/dd" slotProps={{ textField: { size: "small", fullWidth: true, sx: { "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } } } }} />
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '187px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                    <Typography variant="body2" sx={{ minWidth: 92, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>미납금액</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnPrintGoji ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnPrintGoji_OnClick} sx={{ width: '106px', height: '24px' }}>조회건 회비고지</Button></Box><Box sx={{ display: hook.isVisible_Button0 ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnPrintAllReadyGoji_OnClick} sx={{ width: '158px', height: '24px' }}>수납대기 일괄 회비고지</Button></Box><Box sx={{ display: hook.isVisible_btnPosResultList ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnPosResultList_OnClick} sx={{ width: '118px', height: '24px' }}>결제처리결과조회</Button></Box><Box sx={{ display: hook.isVisible_btnShowVirtualAccount ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnShowVirtualAccount_OnClick} sx={{ width: '92px', height: '24px' }}>가상계좌보기</Button></Box><Box sx={{ display: hook.isVisible_btnChangeProcDate ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnChangeSunapInfo_OnClick} sx={{ width: '92px', height: '24px' }}>수납정보변경</Button></Box><Box sx={{ display: hook.isVisible_btnProcRct ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnProcRct_OnClick} sx={{ width: '118px', height: '24px' }}>현금영수증 처리</Button></Box><Box sx={{ display: hook.isVisible_btnPrintReRct ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnPrintReRct_OnClick} sx={{ width: '92px', height: '24px' }}>영수증재발행</Button></Box><Box sx={{ display: hook.isVisible_btnPosvath ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnPrintEstimate_OnClick} sx={{ width: '92px', height: '24px' }}>부가세정보</Button></Box></Stack>
