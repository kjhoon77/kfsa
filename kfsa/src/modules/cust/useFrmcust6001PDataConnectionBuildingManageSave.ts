...
export const useFrmcust6001PDataConnectionBuildingManageSave = () => {
    ...
    const [isVisible_lbFPISPublic, setIsVisible_lbFPISPublic] = useState(true);
    const [isVisible_EdFPISPublic, setIsVisible_EdFPISPublic] = useState(true);
    ...
    const [isVisible_lbFPISAgency, setIsVisible_lbFPISAgency] = useState(true);
    const [isVisible_edFPISAgency, setIsVisible_edFPISAgency] = useState(true);
    ...
    const [isVisible_lbFPISOwner, setIsVisible_lbFPISOwner] = useState(true);
    const [isVisible_gdFPISOwner, setIsVisible_gdFPISOwner] = useState(true);
    ...
    const [isVisible_gdOwner, setIsVisible_gdOwner] = useState(true);
    ...
    const [isVisible_gdFPISAgency, setIsVisible_gdFPISAgency] = useState(true);
    const [isVisible_gdAgency, setIsVisible_gdAgency] = useState(true);
    ...
    const [isVisible_chkAgencyYn, setIsVisible_chkAgencyYn] = useState(true);
