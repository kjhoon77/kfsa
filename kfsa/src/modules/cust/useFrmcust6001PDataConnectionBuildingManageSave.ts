...
export const useFrmcust6001PDataConnectionBuildingManageSave = () => {
    ...
    const [ds_ioFPISEntrpsVrscInfo, setds_ioFPISEntrpsVrscInfo] = useState<Ids_ioFPISEntrpsVrscInfo[]>([]);
    ...
    const [rawVisible_lbFPISBuildingNm, setRawVisible_lbFPISBuildingNm] = useState(true);
    ...
    const [rawVisible_lbFPISAddr1, setRawVisible_lbFPISAddr1] = useState(true);
    ...
    const [rawVisible_lbFPISPublic, setRawVisible_lbFPISPublic] = useState(true);
    const [rawVisible_EdFPISPublic, setRawVisible_EdFPISPublic] = useState(true);
    const [rawVisible_Static10, setRawVisible_Static10] = useState(true);
    const [rawVisible_edFPISBiz, setRawVisible_edFPISBiz] = useState(true);
    ...
    const [rawVisible_lbFPISAgency, setRawVisible_lbFPISAgency] = useState(true);
    const [rawVisible_edFPISAgency, setRawVisible_edFPISAgency] = useState(true);
    ...
    const [rawVisible_lbFPISOwner, setRawVisible_lbFPISOwner] = useState(true);
    const [rawVisible_gdFPISOwner, setRawVisible_gdFPISOwner] = useState(true);
    ...
    const [rawVisible_cbxBiz, setRawVisible_cbxBiz] = useState(true);
    const [rawVisible_chkBiz, setRawVisible_chkBiz] = useState(true);
    ...
    const [rawVisible_gdOwner, setRawVisible_gdOwner] = useState(true);
    ...
    const [rawVisible_gdFPISAgency, setRawVisible_gdFPISAgency] = useState(true);
    const [rawVisible_gdAgency, setRawVisible_gdAgency] = useState(true);
    ...
    const [rawVisible_chkAgencyYn, setRawVisible_chkAgencyYn] = useState(true);
    const [rawVisible_cbxAgencyYn, setRawVisible_cbxAgencyYn] = useState(true);
    const [rawVisible_btnAllChk, setRawVisible_btnAllChk] = useState(true);
    ...
    const isVisible_lbFPISBuildingNm = rawVisible_lbFPISBuildingNm && rawVisible_Shape0;
    const setIsVisible_lbFPISBuildingNm = setRawVisible_lbFPISBuildingNm;
    ...
    const isVisible_lbFPISAddr1 = rawVisible_lbFPISAddr1 && rawVisible_Shape0;
    const setIsVisible_lbFPISAddr1 = setRawVisible_lbFPISAddr1;
    ...
    const isVisible_lbFPISPublic = rawVisible_lbFPISPublic && rawVisible_Shape0;
    const setIsVisible_lbFPISPublic = setRawVisible_lbFPISPublic;
    const isVisible_EdFPISPublic = rawVisible_EdFPISPublic && rawVisible_Shape0;
    const setIsVisible_EdFPISPublic = setRawVisible_EdFPISPublic;
    const isVisible_Static10 = rawVisible_Static10 && rawVisible_Shape0;
    const setIsVisible_Static10 = setRawVisible_Static10;
    const isVisible_edFPISBiz = rawVisible_edFPISBiz && rawVisible_Shape0;
    const setIsVisible_edFPISBiz = setRawVisible_edFPISBiz;
    const isVisible_edFPISTel = rawVisible_edFPISTel && rawVisible_Shape0;
    const setIsVisible_edFPISTel = setRawVisible_edFPISTel;
    const isVisible_lbFPISTel = rawVisible_lbFPISTel && rawVisible_Shape0;
    const setIsVisible_lbFPISTel = setRawVisible_lbFPISTel;
    const isVisible_lbFPISAgency = rawVisible_lbFPISAgency && rawVisible_Shape0;
    const setIsVisible_lbFPISAgency = setRawVisible_lbFPISAgency;
    const isVisible_edFPISAgency = rawVisible_edFPISAgency && rawVisible_Shape0;
    const setIsVisible_edFPISAgency = setRawVisible_edFPISAgency;
    ...
    const isVisible_lbFPISOwner = rawVisible_lbFPISOwner;
    const setIsVisible_lbFPISOwner = setRawVisible_lbFPISOwner;
    const isVisible_gdFPISOwner = rawVisible_gdFPISOwner && rawVisible_Shape7;
    const setIsVisible_gdFPISOwner = setRawVisible_gdFPISOwner;
    ...
    const isVisible_cbxBiz = rawVisible_cbxBiz && rawVisible_Shape9;
    const setIsVisible_cbxBiz = setRawVisible_cbxBiz;
    const isVisible_chkBiz = rawVisible_chkBiz && rawVisible_Shape9;
    const setIsVisible_chkBiz = setRawVisible_chkBiz;
    ...
    const isVisible_gdOwner = rawVisible_gdOwner && rawVisible_Shape11;
    const setIsVisible_gdOwner = setRawVisible_gdOwner;
    const isVisible_chkFireManager = rawVisible_chkFireManager;
    const setIsVisible_chkFireManager = setRawVisible_chkFireManager;
    const isVisible_Shape12 = rawVisible_Shape12;
    const setIsVisible_Shape12 = setRawVisible_Shape12;
    const isVisible_gdFPISAgency = rawVisible_gdFPISAgency && rawVisible_Shape8;
    const setIsVisible_gdFPISAgency = setRawVisible_gdFPISAgency;
    const isVisible_gdAgency = rawVisible_gdAgency && rawVisible_Shape12;
    const setIsVisible_gdAgency = setRawVisible_gdAgency;
    ...
    const isVisible_chkAgencyYn = rawVisible_chkAgencyYn && rawVisible_Shape4;
    const setIsVisible_chkAgencyYn = setRawVisible_chkAgencyYn;
    const isVisible_cbxAgencyYn = rawVisible_cbxAgencyYn && rawVisible_Shape4;
    const setIsVisible_cbxAgencyYn = setRawVisible_cbxAgencyYn;
    const isVisible_btnAllChk = rawVisible_btnAllChk;
    const setIsVisible_btnAllChk = setRawVisible_btnAllChk;
    ...
    const chkAgencyYn_OnClick = () => {
        console.log('chkAgencyYn_OnClick clicked');
    };
    ...
    return {
        ...
        isVisible_lbFPISPublic,
        setIsVisible_lbFPISPublic,
        isVisible_EdFPISPublic,
        setIsVisible_EdFPISPublic,
        isVisible_Static10,
        ...
        isVisible_lbFPISAgency,
        setIsVisible_lbFPISAgency,
        isVisible_edFPISAgency,
        setIsVisible_edFPISAgency,
        isVisible_Shape6,
        setIsVisible_Shape6,
        ...
        isVisible_Shape7,
        setIsVisible_Shape7,
        isVisible_lbFPISOwner,
        setIsVisible_lbFPISOwner,
        isVisible_gdFPISOwner,
        setIsVisible_gdFPISOwner,
        isVisible_Shape8,
        setIsVisible_Shape8,
        isVisible_Static17,
        ...
        isVisible_gdOwner,
        setIsVisible_gdOwner,
        isVisible_chkFireManager,
        setIsVisible_chkFireManager,
        isVisible_Shape12,
        setIsVisible_Shape12,
        isVisible_gdFPISAgency,
        setIsVisible_gdFPISAgency,
        isVisible_gdAgency,
        setIsVisible_gdAgency,
        ...
        isVisible_chkAgencyYn,
        setIsVisible_chkAgencyYn,
