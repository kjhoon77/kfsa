...
export const useFrmcust6580MDataMatchErrorReport = () => {
    ...
    const [isVisible_radComparison, setIsVisible_radComparison] = useState(true);
    const [isVisible_chkObjNm, setIsVisible_chkObjNm] = useState(true);
    const [isVisible_chkCourse, setIsVisible_chkCourse] = useState(true);
    const [isVisible_chkManagerJumin, setIsVisible_chkManagerJumin] = useState(true);
    const [isVisible_chkAddress, setIsVisible_chkAddress] = useState(true);
    const [isVisible_chkManagerNm, setIsVisible_chkManagerNm] = useState(true);
    ...
    const [isVisible_radSearchGubn, setIsVisible_radSearchGubn] = useState(true);
