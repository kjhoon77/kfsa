...
export const useFrmcust0030MInetCustomerManagement = () => {
    ...
    const [isVisible_gdCustomerList, setIsVisible_gdCustomerList] = useState(true);
    ...
    const [isVisible_cbxPlace, setIsVisible_cbxPlace] = useState(true);
    ...
    const [isVisible_edTimer, setIsVisible_edTimer] = useState(false);
