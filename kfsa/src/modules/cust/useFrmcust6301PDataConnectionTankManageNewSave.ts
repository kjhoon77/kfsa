...
export const useFrmcust6301PDataConnectionTankManageNewSave = () => {
    ...
    const isVisible_lbCarNo = rawVisible_lbCarNo && rawVisible_Shape11;
    ...
    const isVisible_lbCarYear = rawVisible_lbCarYear && rawVisible_Shape11;
    ...
    const isVisible_lbPerMissionNo = rawVisible_lbPerMissionNo && rawVisible_Shape11;
    ...
    const isVisible_lbRemark = rawVisible_lbRemark && rawVisible_Shape11;
    ...
    const isVisible_lbPostGubun = rawVisible_lbPostGubun && rawVisible_Shape11;
    ...
    const isVisible_lbParkPlace = rawVisible_lbParkPlace && rawVisible_Shape11;
    ...
    const isVisible_lbInstlrAddr = rawVisible_lbInstlrAddr && rawVisible_Shape11;
    const setIsVisible_lbInstlrAddr = setRawVisible_lbInstlrAddr;
    const isVisible_medInstlrZipCode = rawVisible_medInstlrZipCode && rawVisible_Shape11;
