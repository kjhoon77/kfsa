...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><FormControlLabel control={<Checkbox checked={chk_chkAll === '1'} onChange={(e) => setChk_chkAll(e.target.checked ? '1' : '0')} />} label="전체선택" /></Stack>
