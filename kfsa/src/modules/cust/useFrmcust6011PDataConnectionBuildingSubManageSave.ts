...
export const useFrmcust6011PDataConnectionBuildingSubManageSave = () => {
    ...
    const [rawVisible_btnBuildingSearch, setRawVisible_btnBuildingSearch] = useState(false);
    ...
    const [rawVisible_btnFPISInfo, setRawVisible_btnFPISInfo] = useState(false);
    ...
    const [rawVisible_btnMainBuildingSearch, setRawVisible_btnMainBuildingSearch] = useState(true);
    const [rawVisible_edMainCMgno, setRawVisible_edMainCMgno] = useState(true);
    const [rawVisible_lbMainCMgno, setRawVisible_lbMainCMgno] = useState(true);
    const [rawVisible_Static0, setRawVisible_Static0] = useState(true);
    const [rawVisible_edBMgno, setRawVisible_edBMgno] = useState(true);
    ...
    const [rawVisible_lbFMElectQualify, setRawVisible_lbFMElectQualify] = useState(true);
    ...
    const isVisible_btnMainBuildingSearch = rawVisible_btnMainBuildingSearch;
    const setIsVisible_btnMainBuildingSearch = setRawVisible_btnMainBuildingSearch;
    const isVisible_edMainCMgno = rawVisible_edMainCMgno;
    const setIsVisible_edMainCMgno = setRawVisible_edMainCMgno;
    const isVisible_lbMainCMgno = rawVisible_lbMainCMgno;
    const setIsVisible_lbMainCMgno = setRawVisible_lbMainCMgno;
    const isVisible_Static0 = rawVisible_Static0 && rawVisible_Shape4;
    const setIsVisible_Static0 = setRawVisible_Static0;
    const isVisible_edBMgno = rawVisible_edBMgno && rawVisible_Shape4;
    const setIsVisible_edBMgno = setRawVisible_edBMgno;
    const isVisible_cbxElectQualify = rawVisible_cbxElectQualify && rawVisible_Shape10;
    ...
    const isVisible_lbFMElectQualify = rawVisible_lbFMElectQualify && rawVisible_Shape10;
    const setIsVisible_lbFMElectQualify = setRawVisible_lbFMElectQualify;
