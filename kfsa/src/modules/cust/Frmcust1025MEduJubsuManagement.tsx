...
export const Frmcust1025MEduJubsuManagement = () => {
    ...
    const columns_gdSunap = [
        { field: 'id_seq', headerName: 'No', width: 24, renderCell: (params) => params.api.getAllRowIds().indexOf(params.id) + 1, sortable: false },
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">실무교육접수관리</Typography>
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        ...
                        <Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "42px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Button0 ? undefined : 'none' }}><Button variant="contained" color="success"  onClick={hook.Button0_OnClick} sx={{ width: '105px', height: '24px', whiteSpace: "nowrap" }}>엑셀업로드저장</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '179px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnCustNo ? undefined : 'none' }}><Button variant="outlined"  onClick={hook.btnCustNo_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '35px', height: '24px', whiteSpace: "nowrap" }}><TouchApp fontSize="small" /></Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '188px', height: '22px', display: 'flex', alignItems: 'center', ml: '3px' }}>
                    <Typography variant="body2" sx={{ minWidth: 88, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>관리바코드</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnCmgno ? undefined : 'none' }}><Button variant="outlined"  onClick={hook.btnCmgno_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '35px', height: '24px', whiteSpace: "nowrap" }}><TouchApp fontSize="small" /></Button></Box><Box sx={{ display: hook.isVisible_gdExcel ? undefined : 'none' }}><Paper sx={{ width: '271px', height: '274px', width: '100%', height: 'auto', minHeight: '274px' }}><DataGridWrapper rows={hook.ds_ioExcel} columns={columns_gdExcel} /></Paper></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '322px', height: '74px', display: 'flex', alignItems: 'center', ml: '6px' }}>
                    ...
                    <FormControl component="fieldset" sx={{ width: "max-content", whiteSpace: "nowrap" }}><RadioGroup row sx={{ flexWrap: "nowrap" }} >{ (Frmcust1025MEduJubsuManagementData.ds_ds_oCourse || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} sx={{ whiteSpace: 'nowrap', flexShrink: 0, mr: 2 }} />) }</RadioGroup></FormControl>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnBnm ? undefined : 'none' }}><Button variant="outlined"  onClick={hook.btnBnm_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '35px', height: '24px', whiteSpace: "nowrap" }}><TouchApp fontSize="small" /></Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '289px', height: '22px', display: 'flex', alignItems: 'center', ml: '3px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "6px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_lbTrainingPersonInfo ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '120px', height: '22px' }}><Typography variant="body2">선임자 정보</Typography></Box></Box><Box sx={{ display: hook.isVisible_btn_ExcelUpload ? undefined : 'none' }}><Button variant="contained" color="success"  onClick={hook.btn_ExcelUpload_OnClick} sx={{ width: '80px', height: '24px', whiteSpace: "nowrap" }}>엑셀업로드</Button></Box><Box sx={{ display: hook.isVisible_btnSearchPersonInfoChange ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnSearchPersonInfoChange_OnClick} sx={{ width: '105px', height: '24px', whiteSpace: "nowrap" }}>접수자정보변경</Button></Box><Box sx={{ display: hook.isVisible_radChangeTpmgno ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '96px', height: '22px', width: "max-content", whiteSpace: "nowrap", pr: 2 }}><RadioGroup row sx={{ flexWrap: "nowrap" }} >{ (Frmcust1025MEduJubsuManagementData.ds_ds_oChangeTpmgno || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} sx={{ whiteSpace: 'nowrap', flexShrink: 0, mr: 2 }} />) }</RadioGroup></FormControl></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '120px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnSearchEduOrder ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnSearchEduOrder_OnClick} sx={{ width: '92px', height: '24px', whiteSpace: "nowrap" }}>접수가능회차</Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '198px', height: '22px', display: 'flex', alignItems: 'center', ml: '112px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnNm ? undefined : 'none' }}><Button variant="outlined"  onClick={hook.btnNm_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '35px', height: '24px', whiteSpace: "nowrap" }}><TouchApp fontSize="small" /></Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '156px', height: '22px', display: 'flex', alignItems: 'center', ml: '9px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '142px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnJubsuNo ? undefined : 'none' }}><Button variant="outlined"  onClick={hook.btnJubsuNo_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '35px', height: '24px', whiteSpace: "nowrap" }}><TouchApp fontSize="small" /></Button></Box><Box sx={{ display: hook.isVisible_btnSeqList ? undefined : 'none' }}><Button variant="contained" color="secondary"  onClick={hook.btnSeqList_OnClick} sx={{ width: '66px', height: '24px', whiteSpace: "nowrap" }}>접수목록</Button></Box><Box sx={{ display: hook.isVisible_btnUnUseJubsuNo ? undefined : 'none' }}><Button variant="contained"   onClick={hook.lfn_SearchUnUseJubsuNo} sx={{ width: '53px', height: '24px', whiteSpace: "nowrap" }}>빈번호</Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '157px', height: '22px', display: 'flex', alignItems: 'center', ml: '11px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnSmsStat ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnSmsStat_OnClick} sx={{ width: '66px', height: '24px', whiteSpace: "nowrap" }}>문자현황</Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '208px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_calEduExpireDate1yearold ? undefined : 'none' }}><DoubleClickDatePicker sx={{ width: "102px", "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 0px", fontSize: "12px", marginLeft: "-2px" } }} /></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static10 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '36px', height: '22px' }}><Typography variant="body2">상태</Typography></Box></Box><Box sx={{ display: hook.isVisible_lbInputStatus ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '131px', height: '25px' }}><Typography variant="body2">신규/수정</Typography></Box></Box><Box sx={{ display: hook.isVisible_lbJubsuStatus ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '131px', height: '25px' }}><Typography variant="body2">접수상태</Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '198px', height: '22px', display: 'flex', alignItems: 'center', ml: '17px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnSendSms ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnSendSms_OnClick} sx={{ width: '66px', height: '24px', whiteSpace: "nowrap" }}>문자발송</Button></Box><Box sx={{ display: hook.isVisible_btnAutologinSms ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnAutologinSms_OnClick} sx={{ width: '131px', height: '24px', whiteSpace: "nowrap" }}>간편로그인 문자발송</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_lbTrainingInfo ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '36px', height: '48px' }}><Typography variant="body2">회차정보</Typography></Box></Box><Box sx={{ display: hook.isVisible_lbEduInfo1 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '272px', height: '24px' }}><Typography variant="body2"></Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '186px', height: '22px', display: 'flex', alignItems: 'center', ml: '17px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_lbOrderChange ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '88px', height: '22px' }}><Typography variant="body2">회차변경</Typography></Box></Box><Box sx={{ display: hook.isVisible_btnEduJubsuModify ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnEduJubsuModify_OnClick} sx={{ width: '85px', height: '24px', whiteSpace: "nowrap" }}>회차변경</Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '127px', height: '22px', display: 'flex', alignItems: 'center', ml: '3px' }}>
                 ...
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '145px', height: '46px', display: 'flex', alignItems: 'center', ml: '21px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ ml: "8px", minWidth: "88px" }}><Box sx={{ display: hook.isVisible_lbPassYn ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '88px', height: '22px' }}><Typography variant="body2">이수여부</Typography></Box></Box><Box sx={{ display: hook.isVisible_btnIssue ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnIssue_OnClick} sx={{ width: '30px', height: '24px', whiteSpace: "nowrap" }}>이수</Button></Box></Box><Box sx={{ display: hook.isVisible_edPassYn ? undefined : 'none' }}><TextField size="small" fullWidth value={hook.ds_ioEduJubsu?.EJISUGUBUN || ''} sx={{ width: '28px', height: '22px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '79px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnCyberInfo ? undefined : 'none' }}><Button variant="outlined"  onClick={hook.btnCyberInfo_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '22px', height: '24px', whiteSpace: "nowrap" }}><Search fontSize="small" /></Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '79px', height: '22px', display: 'flex', alignItems: 'center', ml: '4px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '156px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnJubsuHistory ? undefined : 'none' }}><Button variant="contained" color="secondary"  onClick={hook.btnJubsuHistory_OnClick} sx={{ width: '66px', height: '24px', whiteSpace: "nowrap" }}>접수이력</Button></Box><Box sx={{ display: hook.isVisible_btnModifyHistory ? undefined : 'none' }}><Button variant="contained" color="secondary"  onClick={hook.btnModifyHistory_OnClick} sx={{ width: '66px', height: '24px', whiteSpace: "nowrap" }}>변경이력</Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '262px', height: '22px', display: 'flex', alignItems: 'center', ml: '12px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '177px', height: '22px', display: 'flex', alignItems: 'center', ml: '12px' }}>
                    <Typography variant="body2" sx={{ minWidth: 88, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>성명</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnExistNM ? undefined : 'none' }}><Button variant="outlined"  onClick={hook.btnExistNM_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '35px', height: '24px', whiteSpace: "nowrap" }}><TouchApp fontSize="small" /></Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '198px', height: '22px', display: 'flex', alignItems: 'center', ml: '157px' }}>
                    <Typography variant="body2" sx={{ minWidth: 126, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>교육년도 기준 미납액</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnSetlmt ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnSetlmt_OnClick} sx={{ width: '170px', height: '24px', whiteSpace: "nowrap" }}>회비/교육비 결제하기</Button></Box><Box sx={{ display: hook.isVisible_btnPrintReRct ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnPrintReRct_OnClick} sx={{ width: '92px', height: '24px', whiteSpace: "nowrap" }}>영수증재발행</Button></Box><Box sx={{ display: hook.isVisible_btnPrintReRctPDF ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnPrintReRctPDF_OnClick} sx={{ width: '92px', height: '24px', whiteSpace: "nowrap" }}>영수증PDF</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '276px', height: '22px', display: 'flex', alignItems: 'center', ml: '12px' }}>
                    <Typography variant="body2" sx={{ minWidth: 88, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>선임대상물</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnExistBnm ? undefined : 'none' }}><Button variant="outlined"  onClick={hook.btnExistBnm_OnClick} size="small" sx={{ minWidth: 26, p: 0.2, width: '35px', height: '24px', whiteSpace: "nowrap" }}><TouchApp fontSize="small" /></Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "47px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnShowVirtualAccount ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnShowVirtualAccount_OnClick} sx={{ width: '212px', height: '24px', whiteSpace: "nowrap" }}>가상계좌(유효기간 부여&문자발송) </Button></Box></Stack>
