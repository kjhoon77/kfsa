...
import { useFrmcust1351MCustSMSSend } from './useFrmcust1351MCustSMSSend';
import * as Frmcust1351MCustSMSSendData from './Frmcust1351MCustSMSSendData';

export const Frmcust1351MCustSMSSend = () => {
    const hook = useFrmcust1351MCustSMSSend();
...
export default Frmcust1351MCustSMSSend;
