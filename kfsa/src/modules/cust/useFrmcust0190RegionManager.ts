...
export const useFrmcust0190RegionManager = () => {
    ...
    const [rawVisible_gdRegionManager, setRawVisible_gdRegionManager] = useState(true);
    ...
    const isVisible_gdRegionManager = rawVisible_gdRegionManager;
    const setIsVisible_gdRegionManager = setRawVisible_gdRegionManager;
