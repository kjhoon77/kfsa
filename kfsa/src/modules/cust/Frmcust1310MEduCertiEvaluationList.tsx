...
import { useFrmcust1310MEduCertiEvaluationList } from './useFrmcust1310MEduCertiEvaluationList';
import * as Frmcust1310MEduCertiEvaluationListData from './Frmcust1310MEduCertiEvaluationListData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmcust1310MEduCertiEvaluationList = () => {
    const hook = useFrmcust1310MEduCertiEvaluationList();
    const columns_gdTrainingEvaluation = [
        { field: 'CGROUPNICKNM', headerName: '직능', width: 120 },
        ...
        { field: 'EJCERTIYN', headerName: '합격여부', width: 64 },
        { field: 'EJADDR1', headerName: '주소1', width: 166 },
        { field: 'EJADDR2', headerName: '주소2', width: 188 },
    ];
    return (
        <PageContainer>

            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">실무능력평가현황</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "7px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '180px', height: '22px', display: 'flex', alignItems: 'center', ml: '5px' }}>
...
export default Frmcust1310MEduCertiEvaluationList;
