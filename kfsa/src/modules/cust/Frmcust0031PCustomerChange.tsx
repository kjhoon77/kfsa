...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnJubsu ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnJubsu_OnClick} sx={{ width: '80px', height: '24px' }}>접수처리</Button></Box><Box sx={{ display: hook.isVisible_btnDefer ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnDefer_OnClick} sx={{ width: '80px', height: '24px' }}>보류처리</Button></Box><Box sx={{ display: hook.isVisible_btnCancle ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnCancle_OnClick} sx={{ width: '92px', height: '24px' }}>신청취소 처리</Button></Box><Box sx={{ display: hook.isVisible_btnComplete ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnComplete_OnClick} sx={{ width: '80px', height: '24px' }}>완료처리</Button></Box></Stack>
