...
import { useFrmcust2022PPosResultCard } from './useFrmcust2022PPosResultCard';
import * as Frmcust2022PPosResultCardData from './Frmcust2022PPosResultCardData';

export const Frmcust2022PPosResultCard = () => {
    const hook = useFrmcust2022PPosResultCard();
    return (
        <PageContainer>

            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">카드 결제 처리결과</Typography>
...
export default Frmcust2022PPosResultCard;
