...
import { useFrmcust2024PPosResultCas } from './useFrmcust2024PPosResultCas';
import * as Frmcust2024PPosResultCasData from './Frmcust2024PPosResultCasData';

export const Frmcust2024PPosResultCas = () => {
    const hook = useFrmcust2024PPosResultCas();
    return (
        <PageContainer>

            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">가상계좌 결제 처리결과</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "10px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_lbResult ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '156px', height: '22px' }}><Typography variant="body2">현금영수증 처리결과</Typography></Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '304px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    <Typography variant="body2" sx={{ minWidth: 88, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>LG U+</Typography>
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "7px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnSetlmt ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnSetlmt_OnClick} sx={{ width: '116px', height: '30px', whiteSpace: "nowrap" }}>결제 재시도</Button></Box><Box sx={{ display: hook.isVisible_btnEnd ? undefined : 'none' }}><Button variant="contained"   onClick={hook.lfn_End} sx={{ width: '116px', height: '30px', whiteSpace: "nowrap" }}>결제 완료</Button></Box></Stack>
...
export default Frmcust2024PPosResultCas;
