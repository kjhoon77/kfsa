...
</CustomTabPanel><CustomTabPanel value={tabValue_tabTab2} index={1}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdEduInfo ? undefined : 'none' }}><Paper sx={{ width: '476px', height: '174px', width: '100%', height: 'auto', minHeight: '174px' }}><DataGridWrapper rows={hook.ds_ioEducationPassInfo} columns={columns_gdEduInfo} /></Paper></Box></Stack>
