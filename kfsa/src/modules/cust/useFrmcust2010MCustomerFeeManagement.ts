...
export const useFrmcust2010MCustomerFeeManagement = () => {
    ...
    const [isVisible_btnManagerNo, setIsVisible_btnManagerNo] = useState(false);
    ...
    const [isVisible_btnPrintGojiImage, setIsVisible_btnPrintGojiImage] = useState(true);
    const [isVisible_btnPrintReRctPDF, setIsVisible_btnPrintReRctPDF] = useState(true);
    const [isVisible_edManagerNo, setIsVisible_edManagerNo] = useState(true);
    const [isVisible_btnOldPrintGoji, setIsVisible_btnOldPrintGoji] = useState(true);
