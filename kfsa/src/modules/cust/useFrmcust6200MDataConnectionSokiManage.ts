...
export const useFrmcust6200MDataConnectionSokiManage = () => {
    ...
    const [isVisible_cbxMFObjGubun, setIsVisible_cbxMFObjGubun] = useState(true);
    ...
    const [isVisible_edMFTLPHON_NO, setIsVisible_edMFTLPHON_NO] = useState(true);
    const [isVisible_edMFBSNM_REGIST_NO2, setIsVisible_edMFBSNM_REGIST_NO2] = useState(true);
    const [isVisible_edMFCMPN119SC_NM, setIsVisible_edMFCMPN119SC_NM] = useState(true);
    const [isVisible_edMFENTRPSSE_NM, setIsVisible_edMFENTRPSSE_NM] = useState(true);
    const [isVisible_edMFMainAddr, setIsVisible_edMFMainAddr] = useState(true);
    const [isVisible_edMFENTRPSDETAILSE_NM, setIsVisible_edMFENTRPSDETAILSE_NM] = useState(true);
    const [isVisible_Static32, setIsVisible_Static32] = useState(true);
    const [isVisible_edMFRPRSNTV, setIsVisible_edMFRPRSNTV] = useState(true);
    ...
    const [isVisible_edMFENTRPSSTTUS_NM, setIsVisible_edMFENTRPSSTTUS_NM] = useState(true);
    ...
    const [isVisible_edMFNM, setIsVisible_edMFNM] = useState(true);
    const [isVisible_Static47, setIsVisible_Static47] = useState(true);
    const [isVisible_edMFIHIDNUM, setIsVisible_edMFIHIDNUM] = useState(true);
    const [isVisible_Static48, setIsVisible_Static48] = useState(true);
    const [isVisible_edMFAPNT_DE_8, setIsVisible_edMFAPNT_DE_8] = useState(true);
    ...
    const [isVisible_edMFHNFSE_NM, setIsVisible_edMFHNFSE_NM] = useState(true);
    ...
    const [isVisible_Static72, setIsVisible_Static72] = useState(true);
