...
export const useFrmcust6200MDataConnectionSokiManage = () => {
    ...
    const [rawVisible_cbxMFObjGubun, setRawVisible_cbxMFObjGubun] = useState(true);
    ...
    const [rawVisible_edMFTLPHON_NO, setRawVisible_edMFTLPHON_NO] = useState(true);
    const [rawVisible_edMFBSNM_REGIST_NO2, setRawVisible_edMFBSNM_REGIST_NO2] = useState(true);
    const [rawVisible_edMFCMPN119SC_NM, setRawVisible_edMFCMPN119SC_NM] = useState(true);
    const [rawVisible_edMFENTRPSSE_NM, setRawVisible_edMFENTRPSSE_NM] = useState(true);
    const [rawVisible_edMFMainAddr, setRawVisible_edMFMainAddr] = useState(true);
    const [rawVisible_edMFENTRPSDETAILSE_NM, setRawVisible_edMFENTRPSDETAILSE_NM] = useState(true);
    const [rawVisible_Static32, setRawVisible_Static32] = useState(true);
    const [rawVisible_edMFRPRSNTV, setRawVisible_edMFRPRSNTV] = useState(true);
    ...
    const [rawVisible_edKFBCONO, setRawVisible_edKFBCONO] = useState(true);
    ...
    const [rawVisible_edKFCOMPANYGUBUN, setRawVisible_edKFCOMPANYGUBUN] = useState(true);
    ...
    const [rawVisible_edKFCNO, setRawVisible_edKFCNO] = useState(true);
    ...
    const [rawVisible_edMFENTRPSSTTUS_NM, setRawVisible_edMFENTRPSSTTUS_NM] = useState(true);
    ...
    const [rawVisible_edMFREGIST_DE_14, setRawVisible_edMFREGIST_DE_14] = useState(true);
    const [rawVisible_Static58, setRawVisible_Static58] = useState(true);
    const [rawVisible_edMFUPDT_DE_14, setRawVisible_edMFUPDT_DE_14] = useState(true);
    ...
    const [rawVisible_radMFGubun, setRawVisible_radMFGubun] = useState(true);
    ...
    const [rawVisible_edMFNM, setRawVisible_edMFNM] = useState(true);
    const [rawVisible_Static47, setRawVisible_Static47] = useState(true);
    const [rawVisible_edMFIHIDNUM, setRawVisible_edMFIHIDNUM] = useState(true);
    const [rawVisible_Static48, setRawVisible_Static48] = useState(true);
    const [rawVisible_edMFAPNT_DE_8, setRawVisible_edMFAPNT_DE_8] = useState(true);
    ...
    const [rawVisible_edMFHNFSE_NM, setRawVisible_edMFHNFSE_NM] = useState(true);
    ...
    const [rawVisible_Static72, setRawVisible_Static72] = useState(true);
    ...
    const isVisible_cbxMFObjGubun = rawVisible_cbxMFObjGubun;
    const setIsVisible_cbxMFObjGubun = setRawVisible_cbxMFObjGubun;
    ...
    const isVisible_edMFTLPHON_NO = rawVisible_edMFTLPHON_NO;
    const setIsVisible_edMFTLPHON_NO = setRawVisible_edMFTLPHON_NO;
    const isVisible_edMFBSNM_REGIST_NO2 = rawVisible_edMFBSNM_REGIST_NO2;
    const setIsVisible_edMFBSNM_REGIST_NO2 = setRawVisible_edMFBSNM_REGIST_NO2;
    const isVisible_edMFCMPN119SC_NM = rawVisible_edMFCMPN119SC_NM;
    const setIsVisible_edMFCMPN119SC_NM = setRawVisible_edMFCMPN119SC_NM;
    const isVisible_edMFENTRPSSE_NM = rawVisible_edMFENTRPSSE_NM;
    const setIsVisible_edMFENTRPSSE_NM = setRawVisible_edMFENTRPSSE_NM;
    const isVisible_edMFMainAddr = rawVisible_edMFMainAddr;
    const setIsVisible_edMFMainAddr = setRawVisible_edMFMainAddr;
    const isVisible_edMFENTRPSDETAILSE_NM = rawVisible_edMFENTRPSDETAILSE_NM;
    const setIsVisible_edMFENTRPSDETAILSE_NM = setRawVisible_edMFENTRPSDETAILSE_NM;
    const isVisible_Static32 = rawVisible_Static32;
    const setIsVisible_Static32 = setRawVisible_Static32;
    const isVisible_edMFRPRSNTV = rawVisible_edMFRPRSNTV;
    const setIsVisible_edMFRPRSNTV = setRawVisible_edMFRPRSNTV;
    ...
    const isVisible_edKFBCONO = rawVisible_edKFBCONO;
    const setIsVisible_edKFBCONO = setRawVisible_edKFBCONO;
    ...
    const isVisible_edKFCOMPANYGUBUN = rawVisible_edKFCOMPANYGUBUN;
    const setIsVisible_edKFCOMPANYGUBUN = setRawVisible_edKFCOMPANYGUBUN;
    ...
    const isVisible_edKFCNO = rawVisible_edKFCNO;
    const setIsVisible_edKFCNO = setRawVisible_edKFCNO;
    ...
    const isVisible_edMFENTRPSSTTUS_NM = rawVisible_edMFENTRPSSTTUS_NM;
    const setIsVisible_edMFENTRPSSTTUS_NM = setRawVisible_edMFENTRPSSTTUS_NM;
    ...
    const isVisible_edMFREGIST_DE_14 = rawVisible_edMFREGIST_DE_14;
    const setIsVisible_edMFREGIST_DE_14 = setRawVisible_edMFREGIST_DE_14;
    const isVisible_Static58 = rawVisible_Static58;
    const setIsVisible_Static58 = setRawVisible_Static58;
    const isVisible_edMFUPDT_DE_14 = rawVisible_edMFUPDT_DE_14;
    const setIsVisible_edMFUPDT_DE_14 = setRawVisible_edMFUPDT_DE_14;
    ...
    const isVisible_radMFGubun = rawVisible_radMFGubun;
    const setIsVisible_radMFGubun = setRawVisible_radMFGubun;
    ...
    const isVisible_edMFNM = rawVisible_edMFNM;
    const setIsVisible_edMFNM = setRawVisible_edMFNM;
    const isVisible_Static47 = rawVisible_Static47;
    const setIsVisible_Static47 = setRawVisible_Static47;
    const isVisible_edMFIHIDNUM = rawVisible_edMFIHIDNUM;
    const setIsVisible_edMFIHIDNUM = setRawVisible_edMFIHIDNUM;
    const isVisible_Static48 = rawVisible_Static48;
    const setIsVisible_Static48 = setRawVisible_Static48;
    const isVisible_edMFAPNT_DE_8 = rawVisible_edMFAPNT_DE_8;
    const setIsVisible_edMFAPNT_DE_8 = setRawVisible_edMFAPNT_DE_8;
    ...
    const isVisible_edMFHNFSE_NM = rawVisible_edMFHNFSE_NM;
    const setIsVisible_edMFHNFSE_NM = setRawVisible_edMFHNFSE_NM;
    ...
    return {
        ...
        isVisible_cbxMFObjGubun,
        setIsVisible_cbxMFObjGubun,
        isVisible_Static10,
        ...
        isVisible_edMFTLPHON_NO,
        setIsVisible_edMFTLPHON_NO,
        isVisible_edMFBSNM_REGIST_NO2,
        setIsVisible_edMFBSNM_REGIST_NO2,
        isVisible_edMFCMPN119SC_NM,
        setIsVisible_edMFCMPN119SC_NM,
        isVisible_edMFENTRPSSE_NM,
        setIsVisible_edMFENTRPSSE_NM,
        isVisible_edMFMainAddr,
        setIsVisible_edMFMainAddr,
        isVisible_edMFENTRPSDETAILSE_NM,
        setIsVisible_edMFENTRPSDETAILSE_NM,
        isVisible_Static32,
        setIsVisible_Static32,
        isVisible_edMFRPRSNTV,
        setIsVisible_edMFRPRSNTV,
        isVisible_Static24,
        ...
        isVisible_edKFBCONO,
        setIsVisible_edKFBCONO,
        isVisible_edKFCNM,
        setIsVisible_edKFCNM,
        isVisible_Static35,
        setIsVisible_Static35,
        isVisible_edKFCOMPANYGUBUN,
        setIsVisible_edKFCOMPANYGUBUN,
        isVisible_edKFBTEL,
        setIsVisible_edKFBTEL,
        isVisible_Static36,
        setIsVisible_Static36,
        isVisible_edKFCNO,
        setIsVisible_edKFCNO,
        ...
        isVisible_edMFENTRPSSTTUS_NM,
        setIsVisible_edMFENTRPSSTTUS_NM,
        isVisible_Static53,
        ...
        isVisible_edMFIHIDNUM,
        setIsVisible_edMFIHIDNUM,
        isVisible_Static48,
        setIsVisible_Static48,
        isVisible_edMFAPNT_DE_8,
        setIsVisible_edMFAPNT_DE_8,
        isVisible_Static65,
        ...
        isVisible_edMFHNFSE_NM,
        setIsVisible_edMFHNFSE_NM,
        isVisible_Static59,
