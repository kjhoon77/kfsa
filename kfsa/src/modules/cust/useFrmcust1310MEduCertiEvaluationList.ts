...
import type { Ids_oTrainingEvaluation, Ids_oSearchGubun, Ids_oCourse, Ids_oJibu, Ids_oTrainingEvaluationTemp } from './Frmcust1310MEduCertiEvaluationListData';

export const useFrmcust1310MEduCertiEvaluationList = () => {
