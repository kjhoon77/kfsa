...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Button0 ? undefined : 'none' }}><Button variant="contained"  onClick={hook.Div0_Button4Yes_OnClick} sx={{ width: '38px', height: '26px' }}>확인</Button></Box><Box sx={{ display: hook.isVisible_Button4 ? undefined : 'none' }}><Button variant="contained"  onClick={hook.Div0_Button4_OnClick} sx={{ width: '38px', height: '26px' }}>취소</Button></Box></Stack>
...
</Stack></Paper></Box></Box><Box sx={{ display: hook.isVisible_radNotMemberFirsSecondHalf ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '192px', height: '22px' }}><RadioGroup row >{ (Frmcust2040MCustomerFeeGojiData.ds_ds_ioUpDown || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_radOrderBy ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '440px', height: '22px' }}><RadioGroup row >{ (Frmcust2040MCustomerFeeGojiData.ds_ds_ioMemberGubun_1 || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Stack>
