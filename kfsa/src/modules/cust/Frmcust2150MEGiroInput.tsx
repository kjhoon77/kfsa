...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnOpenFile ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnOpenFile_OnClick} sx={{ width: '84px', height: '46px' }}>지로 파일
불러오기</Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '192px', height: '22px', display: 'flex', alignItems: 'center', ml: '12px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnSave ? undefined : 'none' }}><Button variant="contained"  onClick={hook.lfn_Save} sx={{ width: '152px', height: '46px' }}>지로 처리(저장)</Button></Box></Stack>
