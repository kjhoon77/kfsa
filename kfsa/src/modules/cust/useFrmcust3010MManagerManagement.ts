...
export const useFrmcust3010MManagerManagement = () => {
    ...
    const [rawVisible_gdManagerPassList, setRawVisible_gdManagerPassList] = useState(true);
    ...
    const isVisible_gdManagerPassList = rawVisible_gdManagerPassList && rawVisible_shpGubunBox2;
    const setIsVisible_gdManagerPassList = setRawVisible_gdManagerPassList;
    const isVisible_btnMutilSort2 = rawVisible_btnMutilSort2 && rawVisible_shpGubunBox2;
