// @ts-nocheck
export const Frmcust1107MFireDefDMDataData = {};
...
export const ds_ds_oAgency: Ids_oAgency[] = [
    { CD: '', DATA: '전체' },
    { CD: '1', DATA: '강습미수료(강습대상)' },
    { CD: '2', DATA: '강습미수료제외(실무대상)' },
];
...
export interface Ids_oNoIsuGubun {
    CD?: string;
    DATA?: string;
}

export const ds_ds_oNoIsuGubun: Ids_oNoIsuGubun[] = [
    { CD: '', DATA: '전체' },
    { CD: '1', DATA: '선임 후 6개월 대상' },
    { CD: '2', DATA: '교육 유효기한 만기 대상' },
];
