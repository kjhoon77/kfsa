    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">실무교육접수통계</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "24px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdEduJubsu ? undefined : 'none' }}><Paper sx={{ width: '792px', height: '490px', width: '100%', height: 'auto', minHeight: '490px' }}><MultiDataGridWrapper rows={hook.ds_oEduJubsuStat} columns={columns_gdEduJubsu} rowHeight={25} headerHeight={50} hideFooter={true} /></Paper></Box></Stack>
