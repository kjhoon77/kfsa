...
export const useFrmcust6520MFPISDataConnectionReport = () => {
    ...
    const [rawVisible_cbxFireStation1, setRawVisible_cbxFireStation1] = useState(true);
    const [rawVisible_radFireStation, setRawVisible_radFireStation] = useState(true);
    const [rawVisible_cbxFireStation2, setRawVisible_cbxFireStation2] = useState(true);
    ...
    const isVisible_cbxFireStation1 = rawVisible_cbxFireStation1 && rawVisible_Shape0;
    const setIsVisible_cbxFireStation1 = setRawVisible_cbxFireStation1;
    const isVisible_radFireStation = rawVisible_radFireStation && rawVisible_Shape0;
    const setIsVisible_radFireStation = setRawVisible_radFireStation;
    const isVisible_cbxFireStation2 = rawVisible_cbxFireStation2 && rawVisible_Shape0;
    const setIsVisible_cbxFireStation2 = setRawVisible_cbxFireStation2;
