...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_lbBuildingInfo ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '96px', height: '22px' }}><Typography variant="body2">대상물 정보</Typography></Box></Box><Box sx={{ display: hook.isVisible_btnChangeBuilding ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnChangeBuilding_OnClick} sx={{ width: '79px', height: '24px' }}>대상물변경</Button></Box><Box sx={{ display: hook.isVisible_btnSearchManagerList ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnSearchManagerList_OnClick} sx={{ width: '66px', height: '24px' }}>선임현황</Button></Box><Box sx={{ display: hook.isVisible_cbxAddPost ? undefined : 'none' }}><FormControl size="small" fullWidth sx={{ width: '62px', height: '22px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" }, bgcolor: "#fff" }}><Select value={hook.ds_ioCustomerInfo?.CPOSTREQGUBUN || ''} displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmcust6666MCustomerManagementData.ds_ds_oAddPost || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl></Box><Box sx={{ ml: "0px", minWidth: "433px" }}><Box sx={{ display: hook.isVisible_Div0 ? undefined : 'none' }}><Paper sx={{ p: 2, width: '433px', height: '115px', width: '100%', height: 'auto', minHeight: '115px', overflow: 'auto' }}><Typography variant="subtitle2" sx={{ mb: 1, fontWeight: "bold" }}>Div0</Typography><Stack direction="column" spacing={0}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "50px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '332px', height: '22px', display: 'flex', alignItems: 'center', ml: '1px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnSearchReturnPostH ? undefined : 'none' }}><Button variant="contained"  onClick={hook.Div0_btnSearchReturnPostH_OnClick} sx={{ width: '92px', height: '26px' }}>우편반송이력</Button></Box></Stack>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnSearchEduReturnPostH ? undefined : 'none' }}><Button variant="contained"  onClick={hook.Div4_btnSearchEduReturnPostH_OnClick} sx={{ width: '92px', height: '26px' }}>우편반송이력</Button></Box></Stack>
...
안전원정보를 사용합니다.</Typography>
                 ...
                 </Stack></Box><Box sx={{ display: hook.isVisible_btnCustFee ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnCustFee_OnClick} sx={{ width: '60px', height: '22px' }}>회비고지서</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '161px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnEduNoti ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnEduNoti_OnClick} sx={{ width: '60px', height: '22px' }}>교육통지서</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '416px', height: '22px', display: 'flex', alignItems: 'center', ml: '72px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnSearchCivilAppeal ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnSearchCivilAppeal_OnClick} sx={{ width: '80px', height: '24px' }}>연계정보</Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '175px', height: '22px', display: 'flex', alignItems: 'center', ml: '4px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnDelRow ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnDelRow2_OnClick} sx={{ width: '20px', height: '44px' }}>-</Button></Box></Stack>
