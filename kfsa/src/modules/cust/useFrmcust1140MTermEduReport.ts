...
export const useFrmcust1140MTermEduReport = () => {
    ...
    const [rawVisible_radProcJibuGubun, setRawVisible_radProcJibuGubun] = useState(true);
    const [rawVisible_Static12, setRawVisible_Static12] = useState(true);
    const [rawVisible_radEduCyberGubun, setRawVisible_radEduCyberGubun] = useState(true);
    ...
    const isVisible_radProcJibuGubun = rawVisible_radProcJibuGubun && rawVisible_Shape0;
    const setIsVisible_radProcJibuGubun = setRawVisible_radProcJibuGubun;
    const isVisible_Static12 = rawVisible_Static12 && rawVisible_Shape0;
    const setIsVisible_Static12 = setRawVisible_Static12;
    const isVisible_radEduCyberGubun = rawVisible_radEduCyberGubun && rawVisible_Shape0;
    const setIsVisible_radEduCyberGubun = setRawVisible_radEduCyberGubun;
