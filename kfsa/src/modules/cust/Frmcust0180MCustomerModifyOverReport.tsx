...
export const Frmcust0180MCustomerModifyOverReport = () => {
    ...
    const columns_gdList = [
        ...
        { field: 'CLAS_NM', headerName: '', width: 165 },
        ...
        { field: 'DEL_TOT_CNT', headerName: '대 상 제 외 소계', width: 60 },
        ...
        { field: 'BF_COVER_CNT', headerName: '겸 직 현 황 전월', width: 60 },
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">고객변동 및 겸직현황</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "16px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdList ? undefined : 'none' }}><Paper sx={{ width: '448px', height: '110px', width: '100%', height: 'auto', minHeight: '110px' }}><MultiDataGridWrapper rows={hook.ds_CustomerList} columns={columns_gdList} rowHeight={20} headerHeight={40} hideFooter={true} /></Paper></Box></Stack>
