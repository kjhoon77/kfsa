...
export const useFrmcust1320MEduCertiExecutiveAbilityEvaluation = () => {
    ...
    const [rawVisible_chk_print, setRawVisible_chk_print] = useState(true);
    ...
    const isVisible_chk_print = rawVisible_chk_print && rawVisible_shpBtnBox;
    const setIsVisible_chk_print = setRawVisible_chk_print;
