...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '412px', height: '54px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <FormControl component="fieldset"><RadioGroup row >{ (Frmcust0020MCustomerSearchJibuData.ds_ds_oCourse || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl>
                 </Stack></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '173px', height: '22px', display: 'flex', alignItems: 'center', ml: '423px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ ml: "64px", minWidth: "136px" }}><Box sx={{ display: hook.isVisible_Static4 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '136px', height: '18px' }}><Typography variant="body2">(                      ,        )</Typography></Box></Box><Box sx={{ display: hook.isVisible_chkPerson ? undefined : 'none' }}><Box sx={{ width: '119px', height: '16px', border: '1px dashed grey' }}>Unknown: Checkbox</Box></Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnFeeDetailInfo1 ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnFeeDetailInfo1_OnClick} sx={{ width: '92px', height: '24px' }}>상세정보</Button></Box><Box sx={{ display: hook.isVisible_Button3 ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnBarCodeSearch_OnClick} sx={{ width: '92px', height: '24px' }}>상세정보</Button></Box></Stack>
