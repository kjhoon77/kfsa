...
export const useFrmcust6300MDataConnectionDangerTankManage = () => {
    ...
    const [rawVisible_edMFADDR1, setRawVisible_edMFADDR1] = useState(true);
    ...
    const [rawVisible_edKFTPARKPLACEADDR, setRawVisible_edKFTPARKPLACEADDR] = useState(true);
    ...
    const [rawVisible_edKFRCCDNM, setRawVisible_edKFRCCDNM] = useState(true);
    ...
    const [rawVisible_edKFTCARNO, setRawVisible_edKFTCARNO] = useState(true);
    const [rawVisible_Static42, setRawVisible_Static42] = useState(true);
    const [rawVisible_edKFTCARYEAR, setRawVisible_edKFTCARYEAR] = useState(true);
    const [rawVisible_Static43, setRawVisible_Static43] = useState(true);
    const [rawVisible_edKFTPERMISSIONNO, setRawVisible_edKFTPERMISSIONNO] = useState(true);
    const [rawVisible_Static44, setRawVisible_Static44] = useState(true);
    const [rawVisible_edKFTREMARK, setRawVisible_edKFTREMARK] = useState(true);
    ...
    const [rawVisible_edKFCOURSENM, setRawVisible_edKFCOURSENM] = useState(true);
    ...
    const [rawVisible_edMFADDR2, setRawVisible_edMFADDR2] = useState(true);
    const [rawVisible_Static6, setRawVisible_Static6] = useState(true);
    const [rawVisible_Static7, setRawVisible_Static7] = useState(true);
    const [rawVisible_edMFVHCLE_NO, setRawVisible_edMFVHCLE_NO] = useState(true);
    const [rawVisible_Static21, setRawVisible_Static21] = useState(true);
    const [rawVisible_edMFCARNM, setRawVisible_edMFCARNM] = useState(true);
    ...
    const [rawVisible_edMFVHCLE_YEAR, setRawVisible_edMFVHCLE_YEAR] = useState(true);
    ...
    const [rawVisible_edKFTINSTLRADDR, setRawVisible_edKFTINSTLRADDR] = useState(true);
    ...
    const isVisible_edMFADDR1 = rawVisible_edMFADDR1;
    const setIsVisible_edMFADDR1 = setRawVisible_edMFADDR1;
    ...
    const isVisible_edKFTPARKPLACEADDR = rawVisible_edKFTPARKPLACEADDR;
    const setIsVisible_edKFTPARKPLACEADDR = setRawVisible_edKFTPARKPLACEADDR;
    ...
    const isVisible_edKFRCCDNM = rawVisible_edKFRCCDNM;
    const setIsVisible_edKFRCCDNM = setRawVisible_edKFRCCDNM;
    ...
    const isVisible_edKFTCARNO = rawVisible_edKFTCARNO;
    const setIsVisible_edKFTCARNO = setRawVisible_edKFTCARNO;
    const isVisible_Static42 = rawVisible_Static42;
    const setIsVisible_Static42 = setRawVisible_Static42;
    const isVisible_edKFTCARYEAR = rawVisible_edKFTCARYEAR;
    const setIsVisible_edKFTCARYEAR = setRawVisible_edKFTCARYEAR;
    const isVisible_Static43 = rawVisible_Static43;
    const setIsVisible_Static43 = setRawVisible_Static43;
    const isVisible_edKFTPERMISSIONNO = rawVisible_edKFTPERMISSIONNO;
    const setIsVisible_edKFTPERMISSIONNO = setRawVisible_edKFTPERMISSIONNO;
    const isVisible_Static44 = rawVisible_Static44;
    const setIsVisible_Static44 = setRawVisible_Static44;
    const isVisible_edKFTREMARK = rawVisible_edKFTREMARK;
    const setIsVisible_edKFTREMARK = setRawVisible_edKFTREMARK;
    ...
    const isVisible_edKFCOURSENM = rawVisible_edKFCOURSENM;
    const setIsVisible_edKFCOURSENM = setRawVisible_edKFCOURSENM;
    ...
    const isVisible_edMFADDR2 = rawVisible_edMFADDR2;
    const setIsVisible_edMFADDR2 = setRawVisible_edMFADDR2;
    ...
    const isVisible_edMFVHCLE_NO = rawVisible_edMFVHCLE_NO;
    const setIsVisible_edMFVHCLE_NO = setRawVisible_edMFVHCLE_NO;
    const isVisible_Static21 = rawVisible_Static21;
    const setIsVisible_Static21 = setRawVisible_Static21;
    const isVisible_edMFCARNM = rawVisible_edMFCARNM;
    const setIsVisible_edMFCARNM = setRawVisible_edMFCARNM;
    ...
    const isVisible_edMFVHCLE_YEAR = rawVisible_edMFVHCLE_YEAR;
    const setIsVisible_edMFVHCLE_YEAR = setRawVisible_edMFVHCLE_YEAR;
    ...
    const isVisible_edKFTINSTLRADDR = rawVisible_edKFTINSTLRADDR;
    const setIsVisible_edKFTINSTLRADDR = setRawVisible_edKFTINSTLRADDR;
