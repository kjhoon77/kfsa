...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnOK ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnOK_OnClick} sx={{ width: '119px', height: '24px' }}>미리보기</Button></Box><Box sx={{ display: hook.isVisible_btnNO ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnNO_OnClick} sx={{ width: '119px', height: '24px' }}>출 력(고객요청시)</Button></Box><Box sx={{ display: hook.isVisible_btnCancel ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnCancel_OnClick} sx={{ width: '119px', height: '24px' }}>닫  기</Button></Box></Stack>
