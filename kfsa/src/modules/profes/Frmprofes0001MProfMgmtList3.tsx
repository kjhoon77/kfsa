...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdList ? undefined : 'none' }}><Paper sx={{ width: '1171px', height: '451px', width: '100%', height: 'auto', minHeight: '451px' }}><DataGridWrapper rows={hook.ds_ioList} columns={columns_gdList} /></Paper></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Grid0 ? undefined : 'none' }}><Paper sx={{ width: '1178px', height: '201px', width: '100%', height: 'auto', minHeight: '201px' }}><DataGridWrapper rows={hook.ds_ioList3} columns={columns_Grid0} /></Paper></Box></Stack>
