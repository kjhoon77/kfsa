...
export const Frmprofes0001MProfMgmtList5 = () => {
    ...
    const columns_gdList = [
        ...
        { field: 'MQTIMECOUNT', headerName: '교수 자격별 기준 미준수 건수', width: 70 },
    ...
    const columns_gdList2 = [
        { field: 'id_seq', headerName: '순번', width: 40, renderCell: (params) => params.api.getAllRowIds().indexOf(params.id) + 1, sortable: false },
        { field: 'GTDEPTNM', headerName: '지부', width: 127 },
        { field: 'CB_CNT', headerName: '강의시간 배정 위반 기타교수 > 부교수', width: 134 },
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">지부별 자격유지시간 등 현황</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdList2 ? undefined : 'none' }}><Paper sx={{ width: '600px', height: '587px', width: '100%', height: 'auto', minHeight: '587px' }}><MultiDataGridWrapper rows={hook.ds_ioList2} columns={columns_gdList2} rowHeight={20} headerHeight={40} hideFooter={true} /></Paper></Box></Stack>
