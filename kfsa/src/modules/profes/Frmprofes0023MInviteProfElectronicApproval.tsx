...
export const Frmprofes0023MInviteProfElectronicApproval = () => {
    ...
    const columns_gdProfessor = [
        ...
        { field: 'ATM_RE_APPROVER_STATUS', headerName: '결재 위촉', width: 150 },
        { field: 'col_5', headerName: '', width: 23 },
        { field: 'AVM_RE_APPROVER_STATUS', headerName: '승인', width: 150 },
        { field: 'col_7', headerName: '', width: 23 },
    ];
    return (
        <PageContainer>

            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">초빙강사 승인관리</Typography>
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        ...
                        <Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "55px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Static15 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '50px', height: '15px' }}><Typography variant="body2">조회조건</Typography></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '461px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdProfessor ? undefined : 'none' }}><Paper sx={{ width: '791px', height: '520px', width: '100%', height: 'auto', minHeight: '520px' }}><MultiDataGridWrapper rows={hook.ds_Professor} columns={columns_gdProfessor} rowHeight={22} headerHeight={40} hideFooter={true} /></Paper></Box></Stack>
