...
export const Frmprofes0001MProfMgmtList = () => {
    ...
    const columns_gdList3 = [
        ...
        { field: 'APFGUBUNNM', headerName: '지부 교수요원(명단) 강의전담 교수', width: 156 },
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">강의전담 본부 교수요원 현황</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "5px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdList3 ? undefined : 'none' }}><Paper sx={{ width: '547px', height: '677px', width: '100%', height: 'auto', minHeight: '677px' }}><MultiDataGridWrapper rows={hook.ds_ioList3} columns={columns_gdList3} rowHeight={20} headerHeight={40} hideFooter={true} /></Paper></Box></Stack>
