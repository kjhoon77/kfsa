...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdListH ? undefined : 'none' }}><Paper sx={{ width: '879px', height: '188px', width: '100%', height: 'auto', minHeight: '188px' }}><DataGridWrapper rows={hook.ds_ProfesListH} columns={columns_gdListH} /></Paper></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "7px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdListD ? undefined : 'none' }}><Paper sx={{ width: '879px', height: '353px', width: '100%', height: 'auto', minHeight: '353px' }}><DataGridWrapper rows={hook.ds_ProfesListD} columns={columns_gdListD} /></Paper></Box></Stack>
