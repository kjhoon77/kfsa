...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        ...
                        <Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "57px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnUID ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnUID_OnClick} sx={{ width: '135px', height: '24px', whiteSpace: "nowrap" }}>Call ID 가져오기</Button></Box></Stack>
...
</CustomTabPanel></Box></Box><Box sx={{ display: hook.isVisible_fileCallCenterConnect ? undefined : 'none' }}><Button variant="contained" color="success" startIcon={<Description />} sx={{ width: '24px', height: '26px', whiteSpace: "nowrap" }}>fileCallCenterConnect</Button></Box></Box></Stack>
