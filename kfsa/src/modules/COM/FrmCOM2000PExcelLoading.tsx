...
import { useFrmCOM2000PExcelLoading } from './useFrmCOM2000PExcelLoading';
import * as FrmCOM2000PExcelLoadingData from './FrmCOM2000PExcelLoadingData';

export const FrmCOM2000PExcelLoading = () => {
    const hook = useFrmCOM2000PExcelLoading();
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        ...
                        <Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "58px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_grd_parent ? undefined : 'none' }}><Paper sx={{ width: '240px', height: '570px', width: '100%', height: 'auto', minHeight: '570px' }}><DataGridWrapper rows={hook.DS_PARENT} columns={columns_grd_parent} /></Paper></Box><Box sx={{ display: hook.isVisible_grd_excelLoad ? undefined : 'none' }}><Paper sx={{ width: '748px', height: '570px', width: '100%', height: 'auto', minHeight: '570px' }}><DataGridWrapper rows={hook.ds_grid} columns={columns_grd_excelLoad} /></Paper></Box></Stack>
...
export default FrmCOM2000PExcelLoading;
