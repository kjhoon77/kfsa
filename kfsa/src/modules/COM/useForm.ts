...
export const useForm = () => {
    ...
    const [rawVisible_edKFFMRESIDENTNO, setRawVisible_edKFFMRESIDENTNO] = useState(true);
    ...
    const [rawVisible_cbxMFPBLINSTT, setRawVisible_cbxMFPBLINSTT] = useState(true);
    ...
    const [rawVisible_Edit11111, setRawVisible_Edit11111] = useState(true);
    ...
    const isVisible_edKFFMRESIDENTNO = rawVisible_edKFFMRESIDENTNO;
    const setIsVisible_edKFFMRESIDENTNO = setRawVisible_edKFFMRESIDENTNO;
    ...
    const isVisible_cbxMFPBLINSTT = rawVisible_cbxMFPBLINSTT;
    ...
    const isVisible_Edit11111 = rawVisible_Edit11111;
    const setIsVisible_Edit11111 = setRawVisible_Edit11111;
    ...
    return {
        ...
        isVisible_edKFFMRESIDENTNO,
        setIsVisible_edKFFMRESIDENTNO,
        isVisible_Static43,
