...
export const useFrmCOM1010PTrainingPersonModify = () => {
    ...
    const [isVisible_lbText01, setIsVisible_lbText01] = useState(false);
    ...
    const [isVisible_medHP1, setIsVisible_medHP1] = useState(true);
    const [isVisible_medHP2, setIsVisible_medHP2] = useState(true);
    const [isVisible_lbText03, setIsVisible_lbText03] = useState(false);
    const [isVisible_lbText04, setIsVisible_lbText04] = useState(false);
