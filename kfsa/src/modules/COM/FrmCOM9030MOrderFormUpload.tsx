...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_MSIE0 ? undefined : 'none' }}><Box sx={{ width: '323px', height: '507px', border: '1px dashed grey' }}>Unknown: MSIE</Box></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_lbnotice ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '160px', height: '62px' }}><Typography variant="body2"> ※ 기 등록 자료의 수정은
     첨부파일을 확인하여
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '190px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnScan ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnScan_OnClick} sx={{ width: '92px', height: '26px' }}>① 스 캔</Button></Box><Box sx={{ display: hook.isVisible_btn_load ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btn_load_OnClick} sx={{ width: '92px', height: '26px' }}>② 미리보기</Button></Box><Box sx={{ display: hook.isVisible_btnSave ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnSave_OnClick} sx={{ width: '92px', height: '26px' }}>③ 저 장</Button></Box></Stack>
