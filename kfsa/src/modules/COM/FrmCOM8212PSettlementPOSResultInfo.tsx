...
import { useFrmCOM8212PSettlementPOSResultInfo } from './useFrmCOM8212PSettlementPOSResultInfo';
import * as FrmCOM8212PSettlementPOSResultInfoData from './FrmCOM8212PSettlementPOSResultInfoData';

export const FrmCOM8212PSettlementPOSResultInfo = () => {
    const hook = useFrmCOM8212PSettlementPOSResultInfo();
    return (
        <PageContainer>
...
export default FrmCOM8212PSettlementPOSResultInfo;
