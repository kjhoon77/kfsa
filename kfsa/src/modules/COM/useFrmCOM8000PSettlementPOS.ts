...
export const useFrmCOM8000PSettlementPOS = () => {
    ...
    const [rawVisible_chkCardChangeYn, setRawVisible_chkCardChangeYn] = useState(false);
    const [rawVisible_lbTrainingAndLicenseCostInfo, setRawVisible_lbTrainingAndLicenseCostInfo] = useState(true);
    const [rawVisible_cbxEarlySunapingAmount, setRawVisible_cbxEarlySunapingAmount] = useState(false);
    const [rawVisible_edSunapingAmount_Edit, setRawVisible_edSunapingAmount_Edit] = useState(false);
    const [rawVisible_edSunapingAmount_Edit_View, setRawVisible_edSunapingAmount_Edit_View] = useState(false);
    const [rawVisible_divSETTLEBANKPos, setRawVisible_divSETTLEBANKPos] = useState(false);
    ...
    const isVisible_chkCardChangeYn = rawVisible_chkCardChangeYn && rawVisible_divProcGubun;
    const setIsVisible_chkCardChangeYn = setRawVisible_chkCardChangeYn;
    const isVisible_lbTrainingAndLicenseCostInfo = rawVisible_lbTrainingAndLicenseCostInfo && rawVisible_shpGubunBox2;
    const setIsVisible_lbTrainingAndLicenseCostInfo = setRawVisible_lbTrainingAndLicenseCostInfo;
    const isVisible_cbxEarlySunapingAmount = rawVisible_cbxEarlySunapingAmount && rawVisible_divSunap;
    const setIsVisible_cbxEarlySunapingAmount = setRawVisible_cbxEarlySunapingAmount;
    const isVisible_edSunapingAmount_Edit = rawVisible_edSunapingAmount_Edit && rawVisible_shpGubunBox3;
    const setIsVisible_edSunapingAmount_Edit = setRawVisible_edSunapingAmount_Edit;
    const isVisible_edSunapingAmount_Edit_View = rawVisible_edSunapingAmount_Edit_View && rawVisible_shpGubunBox3;
    const setIsVisible_edSunapingAmount_Edit_View = setRawVisible_edSunapingAmount_Edit_View;
    const isVisible_divSETTLEBANKPos = rawVisible_divSETTLEBANKPos;
    const setIsVisible_divSETTLEBANKPos = setRawVisible_divSETTLEBANKPos;
