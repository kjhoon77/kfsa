...
export const useFrmCOM8205PSettlementPOSResult = () => {
    ...
    const [rawVisible_AccountNm, setRawVisible_AccountNm] = useState(true);
    ...
    const [rawVisible_lbResultSB, setRawVisible_lbResultSB] = useState(true);
    const [rawVisible_edResultSB, setRawVisible_edResultSB] = useState(true);
    ...
    const isVisible_AccountNm = rawVisible_AccountNm && rawVisible_shpGubunBox4;
    const setIsVisible_AccountNm = setRawVisible_AccountNm;
    ...
    const isVisible_lbResultSB = rawVisible_lbResultSB && rawVisible_shpGubunBox2;
    const setIsVisible_lbResultSB = setRawVisible_lbResultSB;
    const isVisible_edResultSB = rawVisible_edResultSB && rawVisible_shpGubunBox2;
    const setIsVisible_edResultSB = setRawVisible_edResultSB;
