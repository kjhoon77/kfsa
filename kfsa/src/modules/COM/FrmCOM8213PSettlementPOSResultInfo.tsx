...
import { useFrmCOM8213PSettlementPOSResultInfo } from './useFrmCOM8213PSettlementPOSResultInfo';
import * as FrmCOM8213PSettlementPOSResultInfoData from './FrmCOM8213PSettlementPOSResultInfoData';

export const FrmCOM8213PSettlementPOSResultInfo = () => {
    const hook = useFrmCOM8213PSettlementPOSResultInfo();
    return (
        <PageContainer>
...
export default FrmCOM8213PSettlementPOSResultInfo;
