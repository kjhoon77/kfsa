...
export const useFrmCOM0080MFrameBottom = () => {
    ...
    const [rawVisible_imgCascade, setRawVisible_imgCascade] = useState(true);
    const [rawVisible_imgVertical, setRawVisible_imgVertical] = useState(true);
    const [rawVisible_imgHorizont, setRawVisible_imgHorizont] = useState(true);
    ...
    const [rawVisible_imgMenuExpand, setRawVisible_imgMenuExpand] = useState(true);
