...
import { useFrmCOM1100MOneSMSSend200909291448 } from './useFrmCOM1100MOneSMSSend200909291448';
import * as FrmCOM1100MOneSMSSend200909291448Data from './FrmCOM1100MOneSMSSend200909291448Data';

export const FrmCOM1100MOneSMSSend200909291448 = () => {
    const hook = useFrmCOM1100MOneSMSSend200909291448();
    const [chk_chkReseve, setChk_chkReseve] = useState('0');
    return (
        <PageContainer>

            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">단일문자메시지발송팝업</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_taMessage ? undefined : 'none' }}><TextField size="small" fullWidth  sx={{ width: '117px', height: '114px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '198px', height: '22px', display: 'flex', alignItems: 'center', ml: '23px' }}>
...
export default FrmCOM1100MOneSMSSend200909291448;
