...
export const FrmCOM9040MFormUploadList = () => {
    ...
    const columns_gdStatus = [
        ...
        { field: 'OKDATE', headerName: '', width: 90 },
        { field: 'REGY', headerName: '등록현황 등록', width: 50 },
        { field: 'REGN', headerName: '미등록', width: 50 },
        { field: 'col_8', headerName: '바로가기', width: 68 },
    ];
    return (
        <PageContainer>

            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">개인정보 민원서식 등록현황</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdStatus ? undefined : 'none' }}><Paper sx={{ width: '784px', height: '460px', width: '100%', height: 'auto', minHeight: '460px' }}><MultiDataGridWrapper rows={hook.ds_oTotalselect} columns={columns_gdStatus} rowHeight={20} headerHeight={40} hideFooter={true} /></Paper></Box></Stack>
