...
import { useFrmCOM3212PSettlementPOSResultInfo } from './useFrmCOM3212PSettlementPOSResultInfo';
import * as FrmCOM3212PSettlementPOSResultInfoData from './FrmCOM3212PSettlementPOSResultInfoData';

export const FrmCOM3212PSettlementPOSResultInfo = () => {
    const hook = useFrmCOM3212PSettlementPOSResultInfo();
    return (
        <PageContainer>
...
<Button variant="contained"  onClick={hook.lfn_ChangeKfsaResultOk}>안전원 성공으로 반영</Button>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "16px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_lbResult ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '100px', height: '22px' }}><Typography variant="body2">처리결과</Typography></Box></Box></Stack>
...
export default FrmCOM3212PSettlementPOSResultInfo;
