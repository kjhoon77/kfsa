...
export const FrmCOM8000PSettlementPOS = () => {
    ...
    const [chk_chkCardChangeYn, setChk_chkCardChangeYn] = useState('0');
    return (
        <PageContainer>
