...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '173px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_radSubulGubunH ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '200px', height: '22px' }}><RadioGroup row >{ (Frmitem0007MEduItemHMgmtData.ds_ds_oSubulGubunH || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ ml: "8px", minWidth: "354px" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '242px', height: '22px', display: 'flex', alignItems: 'center', ml: '0px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_radUseTargetC ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '167px', height: '22px' }}><RadioGroup row >{ (Frmitem0007MEduItemHMgmtData.ds_ds_oUseTargetC || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box><Box sx={{ display: hook.isVisible_radUseTargetL ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '279px', height: '22px' }}><RadioGroup row >{ (Frmitem0007MEduItemHMgmtData.ds_ds_oUseTargetL || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box><Box sx={{ display: hook.isVisible_radUseTargetB ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '207px', height: '22px' }}><RadioGroup row >{ (Frmitem0007MEduItemHMgmtData.ds_ds_oUseTargetB || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Box></Stack>
