...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ ml: "8px", minWidth: "560px" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '560px', height: '22px', display: 'flex', alignItems: 'center', ml: '0px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_radSubulGubunV ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '200px', height: '22px' }}><RadioGroup row >{ (Frmitem0002MEduItemHMgmtData.ds_ds_oSubulGubunV || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ ml: "8px", minWidth: "352px" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '242px', height: '22px', display: 'flex', alignItems: 'center', ml: '0px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_radUseTargetC ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '167px', height: '22px' }}><RadioGroup row >{ (Frmitem0002MEduItemHMgmtData.ds_ds_oUseTargetC || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box><Box sx={{ display: hook.isVisible_radUseTargetL ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '277px', height: '22px' }}><RadioGroup row >{ (Frmitem0002MEduItemHMgmtData.ds_ds_oUseTargetL || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box><Box sx={{ display: hook.isVisible_radUseTargetB ? undefined : 'none' }}><FormControl component="fieldset" sx={{ width: '277px', height: '22px' }}><RadioGroup row >{ (Frmitem0002MEduItemHMgmtData.ds_ds_oUseTargetB || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} />) }</RadioGroup></FormControl></Box></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '186px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
