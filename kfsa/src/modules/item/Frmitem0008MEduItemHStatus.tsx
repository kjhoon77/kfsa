...
export const Frmitem0008MEduItemHStatus = () => {
    ...
    const columns_gdEduItemH = [
        ...
        { field: 'USE_CNT', headerName: '사용 합계', width: 60 },
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">제서식수불현황</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Box sx={{ ml: "4px", minWidth: "792px" }}><Box sx={{ display: hook.isVisible_gdEduItemH ? undefined : 'none' }}><Paper sx={{ width: '792px', height: '516px', width: '100%', height: 'auto', minHeight: '516px' }}><MultiDataGridWrapper rows={hook.ds_ioEduItemH} columns={columns_gdEduItemH} rowHeight={20} headerHeight={40} hideFooter={true} /></Paper></Box><Box sx={{ display: hook.isVisible_gdEduItemH2 ? undefined : 'none' }}><Paper sx={{ width: '792px', height: '516px', width: '100%', height: 'auto', minHeight: '516px' }}><MultiDataGridWrapper rows={hook.ds_ioEduItemH} columns={columns_gdEduItemH2} rowHeight={20} headerHeight={40} hideFooter={true} /></Paper></Box><Box sx={{ display: hook.isVisible_gdEduItemH3 ? undefined : 'none' }}><Paper sx={{ width: '792px', height: '516px', width: '100%', height: 'auto', minHeight: '516px' }}><MultiDataGridWrapper rows={hook.ds_ioEduItemH} columns={columns_gdEduItemH3} rowHeight={20} headerHeight={40} hideFooter={true} /></Paper></Box></Box></Stack>
