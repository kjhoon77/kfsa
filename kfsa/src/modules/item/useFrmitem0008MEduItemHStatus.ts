...
export const useFrmitem0008MEduItemHStatus = () => {
    ...
    const [isVisible_calSubulDateSearch, setIsVisible_calSubulDateSearch] = useState(true);
    ...
    const [isVisible_gdEduItemH2, setIsVisible_gdEduItemH2] = useState(true);
    const [isVisible_gdEduItemH3, setIsVisible_gdEduItemH3] = useState(true);
