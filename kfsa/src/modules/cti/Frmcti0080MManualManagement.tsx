...
import { useFrmcti0080MManualManagement } from './useFrmcti0080MManualManagement';
import * as Frmcti0080MManualManagementData from './Frmcti0080MManualManagementData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmcti0080MManualManagement = () => {
    const hook = useFrmcti0080MManualManagement();
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        ...
                        <Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "46px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '170px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '1176px', height: '150px', display: 'flex', alignItems: 'center', ml: '8px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdBoard ? undefined : 'none' }}><Paper sx={{ width: '1184px', height: '426px', width: '100%', height: 'auto', minHeight: '426px' }}><DataGridWrapper rows={hook.ds_ioBoard} columns={columns_gdBoard} /></Paper></Box></Stack>
...
export default Frmcti0080MManualManagement;
