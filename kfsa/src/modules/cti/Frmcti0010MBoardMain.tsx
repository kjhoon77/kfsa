...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Button0 ? undefined : 'none' }}><Button variant="contained"   onClick={hook.api_Ringing} sx={{ width: '95px', height: '30px', whiteSpace: "nowrap" }}>Ringing</Button></Box></Stack>
