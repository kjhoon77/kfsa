...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdCallList ? undefined : 'none' }}><Paper sx={{ width: '1168px', height: '367px', width: '100%', height: 'auto', minHeight: '367px' }}><DataGridWrapper rows={hook.ds_oMinwonCallList} columns={columns_gdCallList} /></Paper></Box></Stack>
</CustomTabPanel><CustomTabPanel value={tabValue_tab} index={1}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "19px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '199px', height: '22px', display: 'flex', alignItems: 'center', ml: '6px' }}>
                    <Typography variant="body2" sx={{ minWidth: 80, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>부서</Typography>
                    <FormControl size="small" fullWidth sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" } }}><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmcti0010SMinwonCallJubsuData.ds_ds_ioDeptList || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
                 </Stack><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '193px', height: '22px', display: 'flex', alignItems: 'center', ml: '1px' }}>
                    <Typography variant="body2" sx={{ minWidth: 72, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>상담원</Typography>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_cbxCICDS ? undefined : 'none' }}><FormControl size="small" fullWidth sx={{ width: '202px', height: '24px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" }, bgcolor: "#fff" }}><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmcti0010SMinwonCallJubsuData.ds_ds_oCallCode2ChaH1 || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl></Box><Box sx={{ display: hook.isVisible_btnExcel_2 ? undefined : 'none' }}><Button variant="contained" color="success"  onClick={hook.tab_minwonH_btnExcel_OnClick} sx={{ width: '79px', height: '26px', whiteSpace: "nowrap" }}>엑셀</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '193px', height: '22px', display: 'flex', alignItems: 'center', ml: '206px' }}>
                 ...
                 </Stack><FormControlLabel control={<Checkbox checked={chk_cbRemoteChk === '1'} onChange={(e) => setChk_cbRemoteChk(e.target.checked ? '1' : '0')} />} label="PC원격" /><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '208px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ ml: "13px", minWidth: "272px" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '199px', height: '22px', display: 'flex', alignItems: 'center', ml: '0px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_taCICONENTS_2 ? undefined : 'none' }}><TextField size="small" fullWidth value={hook.ds_oHMinwonCallRow?.CICONENTS || ''} sx={{ width: '424px', height: '134px', "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" }, bgcolor: "#fff" }} /></Box></Stack>
...
</CustomTabPanel><CustomTabPanel value={tabValue_tab} index={3}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "15px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Div0_2 ? undefined : 'none' }}><Paper sx={{ p: 2, width: '1193px', height: '789px', width: '100%', height: 'auto', minHeight: '789px', overflow: 'auto' }}><Typography variant="subtitle2" sx={{ mb: 1, fontWeight: "bold" }}>Div0</Typography><Stack direction="column" spacing={0}></Stack></Paper></Box></Stack>
</CustomTabPanel><CustomTabPanel value={tabValue_tab} index={4}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "15px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Div0_3 ? undefined : 'none' }}><Paper sx={{ p: 2, width: '1192px', height: '781px', width: '100%', height: 'auto', minHeight: '781px', overflow: 'auto' }}><Typography variant="subtitle2" sx={{ mb: 1, fontWeight: "bold" }}>Div0</Typography><Stack direction="column" spacing={0}></Stack></Paper></Box></Stack>
</CustomTabPanel><CustomTabPanel value={tabValue_tab} index={5}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "15px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_Div0_4 ? undefined : 'none' }}><Paper sx={{ p: 2, width: '1192px', height: '781px', width: '100%', height: 'auto', minHeight: '781px', overflow: 'auto' }}><Typography variant="subtitle2" sx={{ mb: 1, fontWeight: "bold" }}>Div0</Typography><Stack direction="column" spacing={0}></Stack></Paper></Box></Stack>
