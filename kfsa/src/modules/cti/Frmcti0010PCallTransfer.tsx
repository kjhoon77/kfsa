...
export const Frmcti0010PCallTransfer = () => {
    ...
    const columns_gdUserList = [
        { field: 'id_seq', headerName: '즐겨찾기', width: 0, renderCell: (params) => params.api.getAllRowIds().indexOf(params.id) + 1, sortable: false },
        { field: 'PPERSONNM', headerName: '담당자', width: 68 },
        { field: 'PPOSITNNM', headerName: '직위', width: 58 },
        { field: 'col_3', headerName: '업무', width: 44 },
        { field: 'IPDN', headerName: '내선번호', width: 62 },
        { field: 'IPSTATE', headerName: '상태', width: 64 },
        { field: 'col_6', headerName: '호전환가능', width: 75 },
    ];
    return (
        <PageContainer>

            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">호전환/내선전환</Typography>
