...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnPrintAllAddr ? undefined : 'none' }}><Button variant="contained"    sx={{ width: '119px', height: '24px', whiteSpace: "nowrap" }}>주소라벨일괄출력</Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '232px', height: '22px', display: 'flex', alignItems: 'center', ml: '14px' }}>
