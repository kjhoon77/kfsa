...
import type { Ids_oInternetJusu, Ids_oWorkGubun, Ids_oCourse, Ids_oJibu, Ids_oInternetJubsuStatus, Ids_oGubun, Ids_oPrintReceiptMast, Ids_oPrintReceiptDtl, Ids_oJubsuGubun, Ids_ioReport, Ids_ioReportInternetJusuFilter } from './Frmspcledu0060MInternetTrainingJubsuStatisticsData';

export const useFrmspcledu0060MInternetTrainingJubsuStatistics = () => {
    ...
    const [rawVisible_btnPrintLect, setRawVisible_btnPrintLect] = useState(true);
    const [rawVisible_btnPrintTraining, setRawVisible_btnPrintTraining] = useState(true);
    ...
    const isVisible_btnPrintLect = rawVisible_btnPrintLect;
    const setIsVisible_btnPrintLect = setRawVisible_btnPrintLect;
    const isVisible_btnPrintTraining = rawVisible_btnPrintTraining;
    const setIsVisible_btnPrintTraining = setRawVisible_btnPrintTraining;
