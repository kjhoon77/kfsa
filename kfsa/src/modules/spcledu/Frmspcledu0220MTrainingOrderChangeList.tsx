...
import { useFrmspcledu0220MTrainingOrderChangeList } from './useFrmspcledu0220MTrainingOrderChangeList';
import * as Frmspcledu0220MTrainingOrderChangeListData from './Frmspcledu0220MTrainingOrderChangeListData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmspcledu0220MTrainingOrderChangeList = () => {
    const hook = useFrmspcledu0220MTrainingOrderChangeList();
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '392px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <FormControl component="fieldset" sx={{ width: "max-content", whiteSpace: "nowrap" }}><RadioGroup row sx={{ flexWrap: "nowrap" }} >{ (Frmspcledu0220MTrainingOrderChangeListData.ds_ds_oSort || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} sx={{ whiteSpace: 'nowrap', flexShrink: 0, mr: 2 }} />) }</RadioGroup></FormControl>
                 </Stack></Stack>
...
export default Frmspcledu0220MTrainingOrderChangeList;
