...
import { useFrmspcledu0080MInternetTrainingJubsuDateModify } from './useFrmspcledu0080MInternetTrainingJubsuDateModify';
import * as Frmspcledu0080MInternetTrainingJubsuDateModifyData from './Frmspcledu0080MInternetTrainingJubsuDateModifyData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmspcledu0080MInternetTrainingJubsuDateModify = () => {
    const hook = useFrmspcledu0080MInternetTrainingJubsuDateModify();
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">인터넷강습접수처리일자변경</Typography>
...
export default Frmspcledu0080MInternetTrainingJubsuDateModify;
