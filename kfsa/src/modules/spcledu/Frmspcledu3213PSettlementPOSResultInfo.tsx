...
import { useFrmspcledu3213PSettlementPOSResultInfo } from './useFrmspcledu3213PSettlementPOSResultInfo';
import * as Frmspcledu3213PSettlementPOSResultInfoData from './Frmspcledu3213PSettlementPOSResultInfoData';

export const Frmspcledu3213PSettlementPOSResultInfo = () => {
    const hook = useFrmspcledu3213PSettlementPOSResultInfo();
    return (
        <PageContainer>
...
export default Frmspcledu3213PSettlementPOSResultInfo;
