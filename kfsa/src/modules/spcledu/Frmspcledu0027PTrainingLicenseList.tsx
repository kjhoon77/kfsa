...
import { useFrmspcledu0027PTrainingLicenseList } from './useFrmspcledu0027PTrainingLicenseList';
import * as Frmspcledu0027PTrainingLicenseListData from './Frmspcledu0027PTrainingLicenseListData';

export const Frmspcledu0027PTrainingLicenseList = () => {
    const hook = useFrmspcledu0027PTrainingLicenseList();
...
export default Frmspcledu0027PTrainingLicenseList;
