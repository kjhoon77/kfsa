...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdExamPass ? undefined : 'none' }}><Paper sx={{ width: '792px', height: '522px', width: '100%', height: 'auto', minHeight: '522px' }}><DataGridWrapper rows={hook.ds_ioJubsuList} columns={columns_gdExamPass} /></Paper></Box></Stack>
...
export default Frmspcledu0640MExamLicenseNoCreateAfterOMR;
