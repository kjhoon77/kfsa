...
export const useFrmspcledu0020MTrainingJubsuManagement = () => {
    ...
    const [isVisible_cbxRemarkGubun, setIsVisible_cbxRemarkGubun] = useState(false);
    ...
    const [isVisible_imgPicture, setIsVisible_imgPicture] = useState(false);
    const [isVisible_imgLastestPicture, setIsVisible_imgLastestPicture] = useState(false);
    ...
    const [isVisible_lbBarCodeInfo, setIsVisible_lbBarCodeInfo] = useState(true);
    ...
    const [isVisible_chkDiscountYn, setIsVisible_chkDiscountYn] = useState(true);
    const [isVisible_lbDiscountYn, setIsVisible_lbDiscountYn] = useState(true);
