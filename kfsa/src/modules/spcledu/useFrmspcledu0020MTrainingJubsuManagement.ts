...
export const useFrmspcledu0020MTrainingJubsuManagement = () => {
    ...
    const [rawVisible_cbxRemarkGubun, setRawVisible_cbxRemarkGubun] = useState(false);
    ...
    const [rawVisible_imgPicture, setRawVisible_imgPicture] = useState(false);
    const [rawVisible_imgLastestPicture, setRawVisible_imgLastestPicture] = useState(false);
    ...
    const [rawVisible_lbBarCodeInfo, setRawVisible_lbBarCodeInfo] = useState(true);
    ...
    const [rawVisible_chkDiscountYn, setRawVisible_chkDiscountYn] = useState(true);
    const [rawVisible_lbDiscountYn, setRawVisible_lbDiscountYn] = useState(true);
    ...
    const isVisible_hfImage = rawVisible_hfImage && rawVisible_shpBtnBox;
    ...
    const isVisible_lbBarCodeInfo = rawVisible_lbBarCodeInfo;
    const setIsVisible_lbBarCodeInfo = setRawVisible_lbBarCodeInfo;
    ...
    const isVisible_fiImageFile = rawVisible_fiImageFile && rawVisible_shpBtnBox;
    ...
    const isVisible_chkDiscountYn = rawVisible_chkDiscountYn && rawVisible_shpGubunBox3;
    const setIsVisible_chkDiscountYn = setRawVisible_chkDiscountYn;
    const isVisible_lbDiscountYn = rawVisible_lbDiscountYn && rawVisible_shpGubunBox3;
    const setIsVisible_lbDiscountYn = setRawVisible_lbDiscountYn;
    ...
    return {
        ...
        isVisible_lbBarCodeInfo,
        setIsVisible_lbBarCodeInfo,
        isVisible_lbBarCode,
        ...
        isVisible_chkDiscountYn,
        setIsVisible_chkDiscountYn,
        isVisible_lbDiscountYn,
        setIsVisible_lbDiscountYn,
