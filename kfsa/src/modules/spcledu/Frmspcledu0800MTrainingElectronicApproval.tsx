...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnCreateList ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnCreateList_OnClick} sx={{ width: '314px', height: '24px' }}>      (1)  세부내역 리스트 생성 (전자결재 첨부용)</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnProcElecApv ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnProcElecApv_OnClick} sx={{ width: '314px', height: '24px' }}>      (2) 전자결재 연동 처리 (기안)</Button></Box></Stack>
