...
import { useFrmspcledu0415MExamSeatNoPrint } from './useFrmspcledu0415MExamSeatNoPrint';
import * as Frmspcledu0415MExamSeatNoPrintData from './Frmspcledu0415MExamSeatNoPrintData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmspcledu0415MExamSeatNoPrint = () => {
    const hook = useFrmspcledu0415MExamSeatNoPrint();
    const columns_gdExamJubsu = [
        ...
        { field: 'EJRESIDENTNO_SANG', headerName: '생년월일', width: 78 },
...
export default Frmspcledu0415MExamSeatNoPrint;
