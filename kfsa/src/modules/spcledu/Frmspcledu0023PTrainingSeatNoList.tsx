...
import { useFrmspcledu0023PTrainingSeatNoList } from './useFrmspcledu0023PTrainingSeatNoList';
import * as Frmspcledu0023PTrainingSeatNoListData from './Frmspcledu0023PTrainingSeatNoListData';

export const Frmspcledu0023PTrainingSeatNoList = () => {
    const hook = useFrmspcledu0023PTrainingSeatNoList();
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">강습좌석검색팝업</Typography>
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        ...
                        <Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "58px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdTrainingSeatNo ? undefined : 'none' }}><Paper sx={{ width: '684px', height: '386px', width: '100%', height: 'auto', minHeight: '386px' }}><DataGridWrapper rows={hook.ds_oTrainingSeatNo} columns={columns_gdTrainingSeatNo} /></Paper></Box></Stack>
...
export default Frmspcledu0023PTrainingSeatNoList;
