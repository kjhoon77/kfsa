...
import { useFrmspcledu0093SInternetJubsuJubsuInfo } from './useFrmspcledu0093SInternetJubsuJubsuInfo';
import * as Frmspcledu0093SInternetJubsuJubsuInfoData from './Frmspcledu0093SInternetJubsuJubsuInfoData';

export const Frmspcledu0093SInternetJubsuJubsuInfo = () => {
    const hook = useFrmspcledu0093SInternetJubsuJubsuInfo();
    return (
        <PageContainer>
...
export default Frmspcledu0093SInternetJubsuJubsuInfo;
