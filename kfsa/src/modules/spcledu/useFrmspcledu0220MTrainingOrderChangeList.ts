...
import type { Ids_oCourse, Ids_oTrainingJubsu, Ids_oJibu, Ids_oSort } from './Frmspcledu0220MTrainingOrderChangeListData';

export const useFrmspcledu0220MTrainingOrderChangeList = () => {
