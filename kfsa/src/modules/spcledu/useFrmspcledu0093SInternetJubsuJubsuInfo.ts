...
export const useFrmspcledu0093SInternetJubsuJubsuInfo = () => {
    ...
    const [rawVisible_meResidentNo, setRawVisible_meResidentNo] = useState(true);
    const isVisible_Shape1 = rawVisible_Shape1;
    const setIsVisible_Shape1 = setRawVisible_Shape1;
    const isVisible_lbResidentNo = rawVisible_lbResidentNo && rawVisible_Shape1;
    ...
    const isVisible_meResidentNo = rawVisible_meResidentNo && rawVisible_Shape1;
    const setIsVisible_meResidentNo = setRawVisible_meResidentNo;
