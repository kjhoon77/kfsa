...
import { useFrmspcledu0710MEmailSendStatistics } from './useFrmspcledu0710MEmailSendStatistics';
import * as Frmspcledu0710MEmailSendStatisticsData from './Frmspcledu0710MEmailSendStatisticsData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmspcledu0710MEmailSendStatistics = () => {
    const hook = useFrmspcledu0710MEmailSendStatistics();
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    ...
                    <FormControl size="small" fullWidth sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" } }}><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmspcledu0710MEmailSendStatisticsData.ds_ds_oJibu || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
...
export default Frmspcledu0710MEmailSendStatistics;
