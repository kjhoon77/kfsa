...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '185px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnPrintAddrAll ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnPrintAddrAll_OnClick} sx={{ width: '119px', height: '24px' }}>주소라벨일괄출력</Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '220px', height: '22px', display: 'flex', alignItems: 'center', ml: '10px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '200px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnSearch ? undefined : 'none' }}><Button variant="contained" startIcon={<Search />} onClick={hook.lfn_Search} sx={{ width: '85px', height: '24px' }}>조회</Button></Box><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '164px', height: '22px', display: 'flex', alignItems: 'center', ml: '39px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btnPrintApplication ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnPrintApplication_OnClick} sx={{ width: '92px', height: '24px' }}>신청서출력</Button></Box><Box sx={{ display: hook.isVisible_btnJubsu ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnJubsu_OnClick} sx={{ width: '92px', height: '24px' }}>접수 처리</Button></Box><Box sx={{ display: hook.isVisible_btnReIssue ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnReIssue_OnClick} sx={{ width: '92px', height: '24px' }}>수첩 재발급</Button></Box><Box sx={{ display: hook.isVisible_btnLicensePrint ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnLicensePrint_OnClick} sx={{ width: '92px', height: '24px' }}>수첩 출력</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '188px', height: '22px', display: 'flex', alignItems: 'center', ml: '336px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnReturn ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnReturn_OnClick} sx={{ width: '92px', height: '24px' }}>반송 처리</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '188px', height: '22px', display: 'flex', alignItems: 'center', ml: '336px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_Static0 ? undefined : 'none' }}><Box sx={{ display: "flex", alignItems: "center", width: '43px', height: '22px' }}><Typography variant="body2">&apos;-&apos;제외</Typography></Box></Box><Box sx={{ display: hook.isVisible_btnTransSave ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnTransSave_OnClick} sx={{ width: '105px', height: '24px' }}>운송장번호저장</Button></Box><Box sx={{ display: hook.isVisible_btnTransSearch ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnTransSearch_OnClick} sx={{ width: '105px', height: '24px' }}>운송장번호조회</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "6px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_tabSettlement ? undefined : 'none' }}><Box sx={{ width: '464px', height: '162px', width: "100%", height: "auto", minHeight: "162px" }}><Box sx={{ borderBottom: 1, borderColor: "divider" }}><Tabs value={tabValue_tabSettlement} onChange={(e, v) => setTabValue_tabSettlement(v)} aria-label="tabSettlement"><Tab label="수납정보" /><Tab label="환불정보" /></Tabs></Box><CustomTabPanel value={tabValue_tabSettlement} index={0}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "51px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '224px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnPrintReRct ? undefined : 'none' }}><Button variant="contained"  onClick={hook.tabSettlement_tabSunap_btnPrintReRct_OnClick} sx={{ width: '92px', height: '26px' }}>영수증재발행</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '224px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnVirtualAccount ? undefined : 'none' }}><Button variant="contained"  onClick={hook.tabSettlement_tabSunap_btnVirtualAccount_OnClick} sx={{ width: '92px', height: '26px' }}>가상계좌보기</Button></Box><Box sx={{ display: hook.isVisible_btnReapy ? undefined : 'none' }}><Button variant="contained"  onClick={hook.tabSettlement_tabSunap_btnReapy_OnClick} sx={{ width: '92px', height: '26px' }}>환불 신청</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '168px', height: '22px', display: 'flex', alignItems: 'center', ml: '2px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnJubsu ? undefined : 'none' }}><Button variant="contained"  onClick={hook.tabSettlement_tabRepay_btnJubsu_OnClick} sx={{ width: '92px', height: '26px' }}>환불 접수</Button></Box><Box sx={{ display: hook.isVisible_btnRepay ? undefined : 'none' }}><Button variant="contained"  onClick={hook.tabSettlement_tabRepay_btnRepay_OnClick} sx={{ width: '92px', height: '26px' }}>환불 완료</Button></Box><Box sx={{ display: hook.isVisible_btnCancel ? undefined : 'none' }}><Button variant="contained"  onClick={hook.tabSettlement_tabRepay_btnCancel_OnClick} sx={{ width: '92px', height: '26px' }}>환불 취소</Button></Box></Stack>
