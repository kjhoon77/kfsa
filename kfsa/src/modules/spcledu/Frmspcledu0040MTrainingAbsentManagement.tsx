...
import { useFrmspcledu0040MTrainingAbsentManagement } from './useFrmspcledu0040MTrainingAbsentManagement';
import * as Frmspcledu0040MTrainingAbsentManagementData from './Frmspcledu0040MTrainingAbsentManagementData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmspcledu0040MTrainingAbsentManagement = () => {
    const hook = useFrmspcledu0040MTrainingAbsentManagement();
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">강습출결관리</Typography>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '594px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <FormControl component="fieldset" sx={{ width: "max-content", whiteSpace: "nowrap" }}><RadioGroup row sx={{ flexWrap: "nowrap" }} >{ (Frmspcledu0040MTrainingAbsentManagementData.ds_ds_oAbsentDateGubun || []).map(opt => <FormControlLabel key={opt.CD} value={opt.CD} control={<Radio />} label={opt.DATA} sx={{ whiteSpace: 'nowrap', flexShrink: 0, mr: 2 }} />) }</RadioGroup></FormControl>
                 </Stack></Stack>
...
export default Frmspcledu0040MTrainingAbsentManagement;
