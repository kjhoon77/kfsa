...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '128px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnLicenseList ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnLicenseList_OnClick} sx={{ width: '92px', height: '24px' }}>수첩보유현황</Button></Box><Box sx={{ display: hook.isVisible_btnModifyHistory ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnModifyHistory_OnClick} sx={{ width: '66px', height: '24px' }}>변경이력</Button></Box><Box sx={{ display: hook.isVisible_btnPosReport ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnPosReport_OnClick} sx={{ width: '92px', height: '24px' }}>통합영수증조회</Button></Box></Stack>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "5px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '184px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnBarCodeSearch ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnBarCodeSearch_OnClick} sx={{ width: '119px', height: '24px' }}>바코드로 조회</Button></Box></Stack>
