...
import { useFrmspcledu3211PSettlementPOSResultInfo } from './useFrmspcledu3211PSettlementPOSResultInfo';
import * as Frmspcledu3211PSettlementPOSResultInfoData from './Frmspcledu3211PSettlementPOSResultInfoData';

export const Frmspcledu3211PSettlementPOSResultInfo = () => {
    const hook = useFrmspcledu3211PSettlementPOSResultInfo();
    return (
        <PageContainer>
...
export default Frmspcledu3211PSettlementPOSResultInfo;
