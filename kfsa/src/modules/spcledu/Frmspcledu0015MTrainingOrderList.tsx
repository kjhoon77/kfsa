...
import { useFrmspcledu0015MTrainingOrderList } from './useFrmspcledu0015MTrainingOrderList';
import * as Frmspcledu0015MTrainingOrderListData from './Frmspcledu0015MTrainingOrderListData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmspcledu0015MTrainingOrderList = () => {
    const hook = useFrmspcledu0015MTrainingOrderList();
    const columns_gdTrainingOrder = [
        ...
        { field: 'PERSONCNT', headerName: '접수인원수', width: 70 },
    ];
    return (
        <PageContainer>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '190px', height: '22px', display: 'flex', alignItems: 'center', ml: '88px' }}>
...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_gdTrainingOrder ? undefined : 'none' }}><Paper sx={{ width: '792px', height: '490px', width: '100%', height: 'auto', minHeight: '490px' }}><DataGridWrapper rows={hook.ds_oTrainingOrder} columns={columns_gdTrainingOrder} /></Paper></Box></Stack>
...
export default Frmspcledu0015MTrainingOrderList;
