...
import { useFrmspcledu3212PSettlementPOSResultInfo } from './useFrmspcledu3212PSettlementPOSResultInfo';
import * as Frmspcledu3212PSettlementPOSResultInfoData from './Frmspcledu3212PSettlementPOSResultInfoData';

export const Frmspcledu3212PSettlementPOSResultInfo = () => {
    const hook = useFrmspcledu3212PSettlementPOSResultInfo();
    return (
        <PageContainer>
...
export default Frmspcledu3212PSettlementPOSResultInfo;
