...
import { useFrmspcledu1051PInternetTrainingRepayBatchProcResult } from './useFrmspcledu1051PInternetTrainingRepayBatchProcResult';
import * as Frmspcledu1051PInternetTrainingRepayBatchProcResultData from './Frmspcledu1051PInternetTrainingRepayBatchProcResultData';

export const Frmspcledu1051PInternetTrainingRepayBatchProcResult = () => {
    const hook = useFrmspcledu1051PInternetTrainingRepayBatchProcResult();
    ...
    return (
        <PageContainer>
            ...
            <Stack direction="row" alignItems="center" justifyContent="space-between" mb={2}>
                <Typography variant="h5">인터넷시험환불일괄처리 결과팝업</Typography>
...
export default Frmspcledu1051PInternetTrainingRepayBatchProcResult;
