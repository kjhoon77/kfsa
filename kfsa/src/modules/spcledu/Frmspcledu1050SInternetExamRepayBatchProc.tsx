...
import { useFrmspcledu1050SInternetExamRepayBatchProc } from './useFrmspcledu1050SInternetExamRepayBatchProc';
import * as Frmspcledu1050SInternetExamRepayBatchProcData from './Frmspcledu1050SInternetExamRepayBatchProcData';
import { FrmCOM3010SPOS } from '../COM/FrmCOM3010SPOS';

export const Frmspcledu1050SInternetExamRepayBatchProc = () => {
    const hook = useFrmspcledu1050SInternetExamRepayBatchProc();
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    ...
                    <FormControl size="small" fullWidth sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" } }}><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmspcledu1050SInternetExamRepayBatchProcData.ds_ds_oIProcStatus || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
...
export default Frmspcledu1050SInternetExamRepayBatchProc;
