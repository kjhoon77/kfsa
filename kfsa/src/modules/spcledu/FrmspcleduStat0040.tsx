...
export const FrmspcleduStat0040 = () => {
    ...
    const columns_gdList = [
        ...
        { field: 'LSCNT_2', headerName: '총계', width: 95 },
        { field: 'BANG0_2', headerName: '방화관리자', width: 80 },
        { field: 'BANG1_2', headerName: '1급', width: 80 },
        { field: 'BANG2_2', headerName: '2급', width: 80 },
        { field: 'DAN1_2', headerName: '위험물', width: 80 },
        { field: 'DAN2_2', headerName: '운송자', width: 80 },
    ];
    return (
        <PageContainer>
