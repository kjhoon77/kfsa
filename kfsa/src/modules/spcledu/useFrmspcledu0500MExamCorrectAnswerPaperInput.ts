...
import type { Ids_ioLoadedAnswer, Ids_ioExcel, Ids_oCourse, Ids_ioExcelDetail, Ids_oAnswer, Ids_ioExcelCopy } from './Frmspcledu0500MExamCorrectAnswerPaperInputData';

export const useFrmspcledu0500MExamCorrectAnswerPaperInput = () => {
    ...
    const isVisible_gdExcel = rawVisible_gdExcel && rawVisible_shpBtnBox;
