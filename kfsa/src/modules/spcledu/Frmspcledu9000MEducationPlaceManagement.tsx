...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "3px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '688px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                 ...
                 </Stack><Box sx={{ display: hook.isVisible_btnGenerateSeat ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnGenerateSeat_OnClick} sx={{ width: '93px', height: '24px' }}>좌석배치관리</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '500px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    ...
                    <TextField size="small" fullWidth  sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnUploadFile ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnUploadFile_OnClick} sx={{ width: '66px', height: '24px' }}>약도보기</Button></Box><Box sx={{ display: hook.isVisible_btnViewSeat ? undefined : 'none' }}><Button variant="contained"  onClick={hook.btnViewSeat_OnClick} sx={{ width: '93px', height: '24px' }}>좌석배치보기</Button></Box></Stack>
