...
import { useFrmspcledu0820MTrainingProcStatistics } from './useFrmspcledu0820MTrainingProcStatistics';
import * as Frmspcledu0820MTrainingProcStatisticsData from './Frmspcledu0820MTrainingProcStatisticsData';
import { FrmCOM0100SWorkFormTitle } from '../COM/FrmCOM0100SWorkFormTitle';

export const Frmspcledu0820MTrainingProcStatistics = () => {
    const hook = useFrmspcledu0820MTrainingProcStatistics();
    return (
        <PageContainer>
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    ...
                    <FormControl size="small" fullWidth sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" } }}><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmspcledu0820MTrainingProcStatisticsData.ds_ds_oJibu || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
                 </Stack></Stack>
...
export default Frmspcledu0820MTrainingProcStatistics;
