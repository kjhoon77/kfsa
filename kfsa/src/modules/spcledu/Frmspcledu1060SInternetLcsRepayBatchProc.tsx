...
import { useFrmspcledu1060SInternetLcsRepayBatchProc } from './useFrmspcledu1060SInternetLcsRepayBatchProc';
import * as Frmspcledu1060SInternetLcsRepayBatchProcData from './Frmspcledu1060SInternetLcsRepayBatchProcData';

export const Frmspcledu1060SInternetLcsRepayBatchProc = () => {
    const hook = useFrmspcledu1060SInternetLcsRepayBatchProc();
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={12}>
                    ...
                    <FormControl size="small" fullWidth sx={{ "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiSelect-select": { padding: "4px 6px !important" } }}><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmspcledu1060SInternetLcsRepayBatchProcData.ds_ds_oIProcStatus || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
...
export default Frmspcledu1060SInternetLcsRepayBatchProc;
