...
import {
  ...
  useForkRef_default,
  useId_default
} from "./chunk-RGVSFJ72.js";
import {
  GlobalStyles_default,
  useDefaultProps
} from "./chunk-TOCBLSOR.js";
import {
  Box_default,
  boxClasses_default
} from "./chunk-KVKWLFX6.js";
import {
  require_react_dom
...
var MobileStepper = React38.forwardRef(function MobileStepper2(inProps, ref) {
  ...
  return (0, import_jsx_runtime41.jsxs)(RootSlot, {
    ...rootSlotProps,
    children: [backButton, variant === "text" && (0, import_jsx_runtime41.jsxs)(React38.Fragment, {
...
function SliderValueLabel(props) {
  ...
  }, (0, import_jsx_runtime56.jsxs)(React50.Fragment, {
...
var Step = React61.forwardRef(function Step2(inProps, ref) {
  ...
  return (0, import_jsx_runtime65.jsx)(StepContext_default.Provider, {
    value: contextValue,
    children: connector && !alternativeLabel && index !== 0 ? (0, import_jsx_runtime65.jsxs)(React61.Fragment, {
...
var StepButton = React64.forwardRef(function StepButton2(inProps, ref) {
  ...
  const child = isMuiElement_default(children, ["StepLabel"]) ? React64.cloneElement(children, childProps) : (0, import_jsx_runtime70.jsx)(StepLabel_default, {
    ...childProps,
    children
  });
...
var TableBody = React71.forwardRef(function TableBody2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTableBody"
  });
...
var TableRow = React75.forwardRef(function TableRow2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiTableRow"
  });
...
var ToggleButtonGroup = React77.forwardRef(function ToggleButtonGroup2(inProps, ref) {
  const props = useDefaultProps({
    props: inProps,
    name: "MuiToggleButtonGroup"
  });
  ...
  const handleChange = React77.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
  ...
  const handleExclusiveChange = React77.useCallback((event, buttonValue) => {
    if (!onChange) {
      return;
    }
...
function useScrollTrigger(options = {}) {
  ...
  const store = React78.useRef();
  const [trigger, setTrigger] = React78.useState(() => getTrigger(store, other));
  React78.useEffect(() => {
    if (target === null) {
