...
<Grid item xs={12}><Box sx={{ width: "100%" }}><Box sx={{ borderBottom: 1, borderColor: "divider" }}><Tabs value={tabValue_TabAddr} onChange={(e, v) => setTabValue_TabAddr(v)} aria-label="TabAddr"><Tab label="도로명주소 조회" /><Tab label="지번→도로명 조회" /></Tabs></Box><CustomTabPanel value={tabValue_TabAddr} index={0}><Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Box>[동/호수, 층 등]</Box></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.TabAddr_tabRoad_btnRoadApply_OnClick}>적용</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Box>[건물/아파트 등]</Box></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.TabAddr_tabRoad_btnRoadApplyCancel_OnClick}>적용 취소</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Box>[동/호수, 층 등]</Box></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.TabAddr_tabPost_btnRoadApply_OnClick}>적용</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Box>[건물/아파트 등]</Box></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.TabAddr_tabPost_btnRoadApplyCancel_OnClick}>적용 취소</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
