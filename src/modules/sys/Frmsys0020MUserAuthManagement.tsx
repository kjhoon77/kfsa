...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>권한삭제여부</Box></Grid><Grid item xs={12} md={3}><Box>교육종합관리시스템 사용권한 삭제여부</Box></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnDeleteKemsAuth_OnClick}>권한삭제</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
