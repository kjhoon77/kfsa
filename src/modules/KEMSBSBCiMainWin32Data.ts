// @ts-nocheck
export const KEMSBSBCiMainWin32Data = {};
...
export const ds_gds_oDesign = [
    { MAINBKCOLOR: 'user30', MEMUIMGID: 'IMG_LEFT_TITLE_BK01', SUBBKCOLOR: 'user40', MSYSGUBUN: 'mem', TABIMGID: 'BTN_TAB_BK01' },
    ...
    { MAINBKCOLOR: 'user33', MEMUIMGID: 'IMG_LEFT_TITLE_BK04', SUBBKCOLOR: 'user43', MSYSGUBUN: 'supt', TABIMGID: 'BTN_TAB_BK04' },
    ...
    { MAINBKCOLOR: 'user38', MEMUIMGID: 'IMG_LEFT_TITLE_BK09', SUBBKCOLOR: 'user48', MSYSGUBUN: '예비용', TABIMGID: 'BTN_TAB_BK09' },
    { MAINBKCOLOR: 'user39', MEMUIMGID: 'IMG_LEFT_TITLE_BK10', SUBBKCOLOR: 'user49', MSYSGUBUN: '예비용', TABIMGID: 'BTN_TAB_BK10' },
];
