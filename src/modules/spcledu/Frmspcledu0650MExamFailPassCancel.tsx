...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>불합격자</Box></Grid><Grid item xs={12} md={2}><Box>[합격여부] N:불합격 X:미응시</Box></Grid><Grid item xs={12} md={2}><Tooltip title="BTN_MULTI_SORT"><Button variant="outlined" size="small" color="primary" onClick={hook.btnMutilSort_OnClick} sx={{ minWidth: 30, p: 0.5 }}><Sort fontSize="small" /></Button></Tooltip></Grid><Grid item xs={12} md={2}><Box>합격취소</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
