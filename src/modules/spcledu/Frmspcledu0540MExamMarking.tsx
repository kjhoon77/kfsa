...
<Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                    <Paper sx={{ height: 400, width: '100%' }}>
                        <DataGridWrapper rows={hook.ds_oExamOrder} columns={columns_gdExam} />
                    </Paper>
                </Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
{ hook.isVisible_Static0 && (
                <Grid item xs={12} md={2}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        <Typography variant="subtitle2" sx={{ mb: 1, fontWeight: "bold" }}>정답지</Typography>
                        <Grid container spacing={2}>
...
{ hook.isVisible_Static1 && (
                <Grid item xs={12} md={2}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        <Typography variant="subtitle2" sx={{ mb: 1, fontWeight: "bold" }}>답안지</Typography>
                        <Grid container spacing={2}>
...
<Grid container spacing={2} alignItems="center">
{ hook.isVisible_Static2 && (
                <Grid item xs={12} md={2}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        <Typography variant="subtitle2" sx={{ mb: 1, fontWeight: "bold" }}>시험결과</Typography>
                        <Grid container spacing={2}>
