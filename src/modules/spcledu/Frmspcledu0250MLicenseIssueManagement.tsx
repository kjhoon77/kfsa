...
<Grid item xs={12} md={2}><Box>조회</Box></Grid>
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained">기본정보조회</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">접수자 정보 변경</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained">실명인증</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained">바코드조회</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>개인정보</Box></Grid>
                ...
                </Grid><Grid item xs={12} md={2}><Tooltip title="BTN_SEARCH"><IconButton color="primary"><Search /></IconButton></Tooltip></Grid><Grid item xs={12} md={4}><Box></Box></Grid><Grid item xs={12} md={2}><Box></Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={5}><Box></Box></Grid><Grid item xs={12} md={2}><Button variant="contained">최근사진반영</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">사진스캔실행</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained">등록사진조회</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">스캔사진불러오기</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid item xs={12} md={2}><Box>수첩정보</Box></Grid>
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained">수첩 재발급</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>직능</Box></Grid><Grid item xs={12} md={4}><Box></Box></Grid><Grid item xs={12} md={2}><Box>구분</Box></Grid><Grid item xs={12} md={3}><Box></Box></Grid><Grid item xs={12} md={2}><Button variant="contained">수첩 출력</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Button variant="contained">수첩 폐기</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>수첩보유현황</Box></Grid>
                ...
                </Grid><Grid item xs={12} md={2}><Box>수첩발급이력</Box></Grid><Grid item xs={12} md={2}><Button variant="contained">이미지보기</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
