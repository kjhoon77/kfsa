...
</CustomTabPanel><CustomTabPanel value={tabValue_TAB_Training} index={1}></CustomTabPanel></Box></Grid><Grid item xs={12} md={2}><Box>[단위 :</Box></Grid><Grid item xs={12} md={2}><Box> 건, 원]</Box></Grid></Grid>
