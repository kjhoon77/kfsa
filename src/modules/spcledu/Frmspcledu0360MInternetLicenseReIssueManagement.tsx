...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={4}>
                    <Stack direction="row" alignItems="center" spacing={1} sx={{  }}>
                        ...
                        <FormControl size="small" sx={{ width: 150 }}><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmspcledu0360MInternetLicenseReIssueManagementData.ds_ds_oJibu || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
                    </Stack>
                </Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnPrintAddrAll_OnClick}>주소라벨일괄출력</Button></Grid>
                <Grid item xs={12} md={4}>
                    <Stack direction="row" alignItems="center" spacing={1} sx={{  }}>
                ...
                ) }<Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={2}><Box>최근사진</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                <Grid item xs={12} md={4}>
                    <Stack direction="row" alignItems="center" spacing={1} sx={{  }}>
                        ...
                        <FormControl size="small" sx={{ width: 150 }}><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmspcledu0360MInternetLicenseReIssueManagementData.ds_ds_oStatus || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
                    </Stack>
                </Grid>
                <Grid item xs={12} md={4}>
                    <Stack direction="row" alignItems="center" spacing={1} sx={{  }}>
...
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained" startIcon={<Search />} onClick={hook.lfn_Search}>조회</Button></Grid>
                <Grid item xs={12} md={4}>
                    <Stack direction="row" alignItems="center" spacing={1} sx={{  }}>
...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnPrintApplication_OnClick}>신청서출력</Button></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnJubsu_OnClick}>접수 처리</Button></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnReIssue_OnClick}>수첩 재발급</Button></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnLicensePrint_OnClick}>수첩 출력</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={3}><Box></Box></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnPrintAddr_OnClick}>주소라벨출력</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnReturn_OnClick}>반송 처리</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Box>&apos;-&apos;제외</Box></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnTransSave_OnClick}>운송장번호저장</Button></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnTransSearch_OnClick}>운송장번호조회</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12}><Box sx={{ width: "100%" }}><Box sx={{ borderBottom: 1, borderColor: "divider" }}><Tabs value={tabValue_tabSettlement} onChange={(e, v) => setTabValue_tabSettlement(v)} aria-label="tabSettlement"><Tab label="수납정보" /><Tab label="환불정보" /></Tabs></Box><CustomTabPanel value={tabValue_tabSettlement} index={0}><Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.tabSettlement_tabSunap_btnPrintReRct_OnClick}>영수증재발행</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.tabSettlement_tabSunap_btnVirtualAccount_OnClick}>가상계좌보기</Button></Grid>{ hook.isVisible_btnReapy && (
                <Grid item xs={12} md={2}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        <Typography variant="subtitle2" sx={{ mb: 1, fontWeight: "bold" }}>환불 신청</Typography>
                        <Grid container spacing={2}>
...
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.tabSettlement_tabRepay_btnJubsu_OnClick}>환불 접수</Button></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.tabSettlement_tabRepay_btnRepay_OnClick}>환불 완료</Button></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.tabSettlement_tabRepay_btnCancel_OnClick}>환불 취소</Button></Grid></Grid>
