// @ts-nocheck
export const Frmcust6400MDataConnectionChangeManageData = {};
...
export const ds_ds_ioChangeApplyGubun: Ids_ioChangeApplyGubun[] = [
    { CD: '', DATA: '전체' },
    { CD: '1', DATA: '적용' },
    { CD: '0', DATA: '미적용' },
];
...
export const ds_ds_ioApplyGubun: Ids_ioApplyGubun[] = [
    { APPLYCD: '0', APPLYNM: '미처리' },
    { APPLYCD: '1', APPLYNM: '반영' },
    { APPLYCD: '2', APPLYNM: '미반영' },
];
...
export const ds_ds_oModifyColumnList: Ids_oModifyColumnList[] = [
    ...
    { COLKORNM: '대표주소구분', COLNM: 'BADDRGUBUN', COMBOGUBUN: 'N', INNERDSNM: '', TBLNM: 'BUILDING' },
    ...
    { COLKORNM: '대표주소구분', COLNM: 'FMHADDRGUBUN', COMBOGUBUN: 'N', INNERDSNM: '', TBLNM: 'FIREMANAGERH' },
...
export const ds_ds_oSearchChoice: Ids_oSearchChoice[] = [
    { CD: '', DATA: '없음' },
    { CD: '1', DATA: '대상물명' },
    { CD: '2', DATA: '주소' },
];
