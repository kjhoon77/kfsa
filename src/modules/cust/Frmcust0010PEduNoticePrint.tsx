...
<Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnSearchEduSchedule_OnClick}>실무교육일정 선택</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Button variant="contained" onClick={hook.lfn_Print}>교육통지서 출력</Button></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.lfn_PDFPrint}>PDF 출력</Button></Grid></Grid>
