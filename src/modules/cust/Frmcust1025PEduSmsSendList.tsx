...
import { useFrmcust1025PEduSmsSendList } from './useFrmcust1025PEduSmsSendList';
import * as Frmcust1025PEduSmsSendListData from './Frmcust1025PEduSmsSendListData';

export const Frmcust1025PEduSmsSendList = () => {
    const hook = useFrmcust1025PEduSmsSendList();
...
export default Frmcust1025PEduSmsSendList;
