...
import { useFrmcust2021PPosResultMoney } from './useFrmcust2021PPosResultMoney';
import * as Frmcust2021PPosResultMoneyData from './Frmcust2021PPosResultMoneyData';

export const Frmcust2021PPosResultMoney = () => {
    const hook = useFrmcust2021PPosResultMoney();
    return (
        <PageContainer>
...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Button variant="contained" onClick={hook.lfn_End}>결제 완료</Button></Grid></Grid>
...
export default Frmcust2021PPosResultMoney;
