...
<Grid item xs={12} md={2}><Box> ① 메인 소방안전관리자 선택</Box></Grid><Grid item xs={12} md={2}><Button variant="contained">조  회</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">선택</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained">조  회</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">선택</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">신규추가</Button></Grid><Grid item xs={12} md={2}><Box>삭제자료포함</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
