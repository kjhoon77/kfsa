...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Button variant="contained">조회건 회비고지</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">수납대기 일괄 회비고지</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">결제처리결과조회</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">가상계좌보기</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">수납정보변경</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">현금영수증 처리</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">영수증재발행</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">부가세정보</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
