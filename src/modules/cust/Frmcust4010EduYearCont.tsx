...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={4}>
                    <Stack direction="row" alignItems="center" spacing={1} sx={{  }}>
                        ...
                        <FormControl size="small" sx={{ width: 150 }}><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmcust4010EduYearContData.ds_ds_oJibu || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
                    </Stack>
                </Grid><Grid item xs={12} md={5}><Box>※ 교육년도를 위에서 아래로 순차적(오름차순)으로 입력하세요!!</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>소방안전관리자</Box></Grid><Grid item xs={12} md={2}><Box>위험물관리자</Box></Grid><Grid item xs={12} md={2}><Box>소방기술자</Box></Grid><Grid item xs={12} md={2}><Box>위험물운송자</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
