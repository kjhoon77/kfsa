...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>▶ 신용카드번호 :</Box></Grid><Grid item xs={12} md={2}><Box></Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>▶ 할부개월수 :</Box></Grid><Grid item xs={12} md={2}><Box></Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
