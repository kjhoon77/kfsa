...
전</Box></Grid><Grid item xs={12} md={2}><Box>(                      ,        )</Box></Grid><Grid item xs={12} md={2}><Box>해당 문자열 포함</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
후</Box></Grid>
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.lfn_SearchBuilding}>대상물조회</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnNewBuilding_OnClick}>신규추가</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>대상물(업체)정보</Box></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnSave_OnClick}>대상물변경</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
