...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={3}><Button variant="contained" onClick={hook.Button0_OnClick}>Binding</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">

                <Grid item xs={12}>
                    <Paper sx={{ height: 400, width: '100%' }}>
                        <DataGridWrapper rows={hook.Dataset0} columns={columns_Grid0} />
                    </Paper>
                </Grid></Grid>
<Grid container spacing={2} alignItems="center">
