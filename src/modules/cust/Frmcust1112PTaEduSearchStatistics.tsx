...
export const Frmcust1112PTaEduSearchStatistics = () => {
...
<Grid item xs={12} md={3}><Box></Box></Grid><Grid item xs={12} md={2}><Button variant="contained"></Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
export default Frmcust1112PTaEduSearchStatistics;
