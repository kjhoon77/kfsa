// @ts-nocheck
export const Frmcust0010MCustomerManagementData = {};
...
export const ds_ds_oPersonGubun: Ids_oPersonGubun[] = [
    ...
    { CD: '5', DATA: '개인회원 희망자', PCD: '60' },
    { CD: '6', DATA: '초빙강사', PCD: '60' },
];
...
export const ds_ds_oModifyColumnList: Ids_oModifyColumnList[] = [
    ...
    { COLKORNM: '소방안전지 수령제외구분', COLNM: 'CRECEIVEEXCEPTGUBUN', COMBOGUBUN: 'Y', INNERDSNM: 'ds_oReceiveExcept', TBLNM: 'CUSTOMER' },
    { COLKORNM: '수첩번호1', COLNM: 'FMLICENSENO1', COMBOGUBUN: 'N', INNERDSNM: '', TBLNM: 'FIREMANAGER' },
    { COLKORNM: '소방안전지 수령제외일자', COLNM: 'CRECEIVEEXCEPTDATE', COMBOGUBUN: 'N', INNERDSNM: '', TBLNM: 'CUSTOMER' },
    ...
    { COLKORNM: '선임자격', COLNM: 'CELECTQUALIFY', COMBOGUBUN: 'N', INNERDSNM: '', TBLNM: 'CUSTOMER' },
    { COLKORNM: '소방기술지 수령제외구분', COLNM: 'CTECHBOOKEXCEPTGUBUN', COMBOGUBUN: 'Y', INNERDSNM: 'ds_oTechReceiveExcept', TBLNM: 'CUSTOMER' },
    ...
    { COLKORNM: '실무교육유효기간구분', COLNM: 'CEDUEXPIREGUBUN', COMBOGUBUN: 'Y', INNERDSNM: 'ds_oExpireGubun', TBLNM: 'CUSTOMER' },
];
...
export const ds_ds_oElectQualify: Ids_oElectQualify[] = [
    ...
    { CD: '3', DATA: '소방안전업무경력(2년이상)', PCD: '20' },
    { CD: '4', DATA: '소방안전업무종사자(\'16.1.7이전)', PCD: '20' },
    { CD: '', DATA: '선택', PCD: '10' },
...
export const ds_ds_oPostPlace: Ids_oPostPlace[] = [
    ...
    { CD: '2', DATA: '관리소장(소방안전관리자)' },
    { CD: '3', DATA: '행정실장(소방안전관리자)' },
    { CD: '4', DATA: '대표(위험물안전관리자)' },
    { CD: '5', DATA: '대표(소방기술자)' },
...
export const ds_ds_oExpireGubun: Ids_oExpireGubun[] = [
    { CD: '0', DATA: '자동' },
    { CD: '1', DATA: '수정' },
];
