...
<Grid container spacing={2}>
                ...
                <Grid item xs={12} md={4}>
                    <Stack direction="row" alignItems="center" spacing={1}>
                        ...
                        <FormControl size="small" fullWidth><Select value={hook.ds_gubun?.DATA || ''} displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmprofes0006MLecHistoryApprovalData.ds_ds_oJibu || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
                    </Stack>
                </Grid>
                <Grid item xs={12} md={4}>
                    <Stack direction="row" alignItems="center" spacing={1}>
...
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Box>교육시간이 틀린 강의실적</Box></Grid><Grid item xs={12} md={2}><Button variant="contained">일괄승인</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Button variant="contained">승인</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">수정요청허가</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
