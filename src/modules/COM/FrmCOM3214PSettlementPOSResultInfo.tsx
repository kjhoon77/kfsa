...
import { useFrmCOM3214PSettlementPOSResultInfo } from './useFrmCOM3214PSettlementPOSResultInfo';
import * as FrmCOM3214PSettlementPOSResultInfoData from './FrmCOM3214PSettlementPOSResultInfoData';

export const FrmCOM3214PSettlementPOSResultInfo = () => {
    const hook = useFrmCOM3214PSettlementPOSResultInfo();
    return (
        <PageContainer>
...
export default FrmCOM3214PSettlementPOSResultInfo;
