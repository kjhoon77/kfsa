...
<Grid item xs={12} md={2}><Button variant="contained" onClick={hook.lfn_SMSPatternList}>    문자유형 선택</Button></Grid><Grid item xs={12} md={2}><Box>* 수신번호가 없으면 보내기 버튼이
 활성화되지 않습니다.</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
