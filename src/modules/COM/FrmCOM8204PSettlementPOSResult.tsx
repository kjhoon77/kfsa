...
import { useFrmCOM8204PSettlementPOSResult } from './useFrmCOM8204PSettlementPOSResult';
import * as FrmCOM8204PSettlementPOSResultData from './FrmCOM8204PSettlementPOSResultData';

export const FrmCOM8204PSettlementPOSResult = () => {
    const hook = useFrmCOM8204PSettlementPOSResult();
    return (
        <PageContainer>
...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>▶ 휴대폰 :</Box></Grid><Grid item xs={12} md={2}><Box></Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
export default FrmCOM8204PSettlementPOSResult;
