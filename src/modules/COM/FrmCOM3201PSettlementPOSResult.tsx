...
import { useFrmCOM3201PSettlementPOSResult } from './useFrmCOM3201PSettlementPOSResult';
import * as FrmCOM3201PSettlementPOSResultData from './FrmCOM3201PSettlementPOSResultData';

export const FrmCOM3201PSettlementPOSResult = () => {
    const hook = useFrmCOM3201PSettlementPOSResult();
    return (
        <PageContainer>
...
export default FrmCOM3201PSettlementPOSResult;
