...
import { useFrmCOM3211PSettlementPOSResultInfo } from './useFrmCOM3211PSettlementPOSResultInfo';
import * as FrmCOM3211PSettlementPOSResultInfoData from './FrmCOM3211PSettlementPOSResultInfoData';

export const FrmCOM3211PSettlementPOSResultInfo = () => {
    const hook = useFrmCOM3211PSettlementPOSResultInfo();
    return (
        <PageContainer>
...
export default FrmCOM3211PSettlementPOSResultInfo;
