...
정보</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
{ hook.isVisible_lbText01 && (
                <Grid item xs={12} md={5}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        <Typography variant="subtitle2" sx={{ mb: 1, fontWeight: "bold" }}>동일인에 대한 이름 또는 주민번호를 변경합니다.
기존 정보가 변경되오니 신중히 변경하시기 바랍니다.</Typography>
                        <Grid container spacing={2}>
                            
                        </Grid>
                    </Paper>
                </Grid>
                ) }{ hook.isVisible_lbText02 && (
                <Grid item xs={12} md={5}>
                    <Paper sx={{ p: 2, height: '100%' }}>
...
접수자가 타인으로 변경되오니 신중히 변경하시기 바랍니다.</Typography>
                ...
                ) }{ hook.isVisible_lbText03 && (
                <Grid item xs={12} md={5}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        <Typography variant="subtitle2" sx={{ mb: 1, fontWeight: "bold" }}>실명인증 처리된 접수자의 이름 또는 주민번호를 변경합니다
기존 정보가 변경되오니 신중히 변경하시기 바랍니다.</Typography>
                        <Grid container spacing={2}>
                ...
                ) }{ hook.isVisible_lbText04 && (
                <Grid item xs={12} md={5}>
                    <Paper sx={{ p: 2, height: '100%' }}>
                        <Typography variant="subtitle2" sx={{ mb: 1, fontWeight: "bold" }}>실명인증 처리가 되지 않은 접수자 또는 접수자를 잘 못 접수
한 경우 접수대장사를 변경합니다.
기존 정보가 변경되오니 신중하게 변경하시기 바랍니다.</Typography>
                        <Grid container spacing={2}>
