...
<Grid item xs={12}><Box sx={{ width: "100%" }}><Box sx={{ borderBottom: 1, borderColor: "divider" }}><Tabs value={tabValue_OMRTab} onChange={(e, v) => setTabValue_OMRTab(v)} aria-label="OMRTab"><Tab label="1과목" /><Tab label="2과목" /><Tab label="3과목" /></Tabs></Box><CustomTabPanel value={tabValue_OMRTab} index={0}><Grid container spacing={2} alignItems="center">
...
<Grid item xs={12} md={12}><Box></Box></Grid></Grid>
</CustomTabPanel><CustomTabPanel value={tabValue_OMRTab} index={2}><Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={12}><Box></Box></Grid></Grid>
