...
import { useFrmCOM8211PSettlementPOSResultInfo } from './useFrmCOM8211PSettlementPOSResultInfo';
import * as FrmCOM8211PSettlementPOSResultInfoData from './FrmCOM8211PSettlementPOSResultInfoData';

export const FrmCOM8211PSettlementPOSResultInfo = () => {
    const hook = useFrmCOM8211PSettlementPOSResultInfo();
    return (
        <PageContainer>
...
export default FrmCOM8211PSettlementPOSResultInfo;
