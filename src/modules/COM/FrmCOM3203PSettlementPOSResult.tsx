...
import { useFrmCOM3203PSettlementPOSResult } from './useFrmCOM3203PSettlementPOSResult';
import * as FrmCOM3203PSettlementPOSResultData from './FrmCOM3203PSettlementPOSResultData';

export const FrmCOM3203PSettlementPOSResult = () => {
    const hook = useFrmCOM3203PSettlementPOSResult();
    return (
        <PageContainer>
...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>▶ 용도 :</Box></Grid><Grid item xs={12} md={2}><Box>지출증빙</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>▶ 현금영수증번호 :</Box></Grid><Grid item xs={12} md={2}><Box>1234-****-****-9876</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
export default FrmCOM3203PSettlementPOSResult;
