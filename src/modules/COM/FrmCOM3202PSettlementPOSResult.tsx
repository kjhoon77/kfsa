...
import { useFrmCOM3202PSettlementPOSResult } from './useFrmCOM3202PSettlementPOSResult';
import * as FrmCOM3202PSettlementPOSResultData from './FrmCOM3202PSettlementPOSResultData';

export const FrmCOM3202PSettlementPOSResult = () => {
    const hook = useFrmCOM3202PSettlementPOSResult();
    return (
        <PageContainer>
...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>▶ 신용카드번호 :</Box></Grid><Grid item xs={12} md={2}><Box>1234-****-****-9876</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>▶ 할부개월수 :</Box></Grid><Grid item xs={12} md={2}><Box>3개월 할부</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={4}><Box>※ 결과 메세지</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnSetlmt_OnClick}>재결제신청</Button></Grid></Grid>
...
export default FrmCOM3202PSettlementPOSResult;
