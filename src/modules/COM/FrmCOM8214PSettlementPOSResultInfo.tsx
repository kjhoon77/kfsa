...
import { useFrmCOM8214PSettlementPOSResultInfo } from './useFrmCOM8214PSettlementPOSResultInfo';
import * as FrmCOM8214PSettlementPOSResultInfoData from './FrmCOM8214PSettlementPOSResultInfoData';

export const FrmCOM8214PSettlementPOSResultInfo = () => {
    const hook = useFrmCOM8214PSettlementPOSResultInfo();
    return (
        <PageContainer>
...
export default FrmCOM8214PSettlementPOSResultInfo;
