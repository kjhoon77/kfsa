...
<Grid item xs={12} md={2}><Button variant="contained">예</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">아니오</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">취소</Button></Grid></Grid>
