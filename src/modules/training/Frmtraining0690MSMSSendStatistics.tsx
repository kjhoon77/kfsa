...
<Button variant="contained"  onClick={hook.btnPrintList_OnClick}>발송 리스트 출력</Button>
...
<Button variant="contained"  onClick={hook.btnPrintOrder_OnClick}>회차별 발송현황 출력</Button>
<Button variant="contained"  onClick={hook.btnPrintDate_OnClick}>발송일자별 발송현황 출력</Button>
<Button variant="contained"  onClick={hook.btnPrintJibu_OnClick}>지부별 발송현황 출력</Button>
...
<Grid item xs={12} md={2}><Box>업무구분</Box></Grid><Grid item xs={12} md={7}><Box></Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
