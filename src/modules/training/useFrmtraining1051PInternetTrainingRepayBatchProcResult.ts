...
import type { Ids_iBatchPorcResult, Ids_oCourse, Ids_oJibu, Ids_oBatchProcResultYn } from './Frmtraining1051PInternetTrainingRepayBatchProcResultData';

export const useFrmtraining1051PInternetTrainingRepayBatchProcResult = () => {
