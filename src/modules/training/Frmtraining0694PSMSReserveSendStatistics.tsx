...
export const Frmtraining0694PSMSReserveSendStatistics = () => {
    const hook = useFrmtraining0694PSMSReserveSendStatistics();
    const columns_gdSmsStat = [
        ...
        { field: 'TDATE', headerName: '교육일자', width: 118 },
        { field: 'MRECVNM', headerName: '수신자', width: 63 },
        { field: 'MRECVTEL', headerName: '휴대폰번호', width: 103 },
    ];
    return (
        <PageContainer>
...
<Grid container spacing={2}>
                ...
                <Grid item xs={12}>
                    <Paper sx={{ height: 400, width: '100%' }}>
                        <DataGridWrapper rows={hook.ds_oReserveSend} columns={columns_gdSmsStat} />
                    </Paper>
                </Grid></Grid>
...
export default Frmtraining0694PSMSReserveSendStatistics;
