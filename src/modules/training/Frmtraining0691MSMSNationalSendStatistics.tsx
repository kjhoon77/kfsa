...
<Grid container spacing={2}>
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained">발송현황 출력</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>발송구분</Box></Grid><Grid item xs={12} md={4}><Box></Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
