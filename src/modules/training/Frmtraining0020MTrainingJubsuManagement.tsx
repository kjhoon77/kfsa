...
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={3}><Button variant="contained">접수가능회차</Button></Grid><Grid item xs={12} md={3}><Button variant="contained">ⓘ접수대기자보기</Button></Grid><Grid item xs={12} md={2}><Box>E-Mail</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={3}><Button variant="contained">접수목록</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">빈번호</Button></Grid><Grid item xs={12} md={2}><Box>선·후불구분</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={3}><Button variant="contained">좌석목록</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">좌석선택</Button></Grid><Grid item xs={12} md={2}><Box>비고(특이사항)</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid item xs={12} md={8}><Box></Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>회차변경</Box></Grid><Grid item xs={12} md={2}><Button variant="contained">회차변경</Button></Grid><Grid item xs={12} md={2}><Box>민원서류 등록</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained">결강자관리</Button></Grid><Grid item xs={12} md={3}><Button variant="contained">결제(POS)</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>사이버교육</Box></Grid><Grid item xs={12} md={3}><Button variant="contained">사이버교육 정보</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>수첩정보</Box></Grid><Grid item xs={12} md={3}><Button variant="contained">수첩보유현황</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>이력정보</Box></Grid><Grid item xs={12} md={2}><Button variant="contained">접수이력</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">변경이력</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={9}><Box></Box></Grid><Grid item xs={12} md={2}><Button variant="contained">최근사진반영</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={2}><Button variant="contained">등록사진조회</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box></Box></Grid>
                ...
                </Grid><Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={2}><Button variant="contained">SVP5300사진스캔</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">D400사진스캔</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={7}><Box></Box></Grid><Grid item xs={12} md={2}><Button variant="contained">사진찾기</Button></Grid><Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={2}><Box></Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained">다운로드</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">과제등록</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Tooltip title="BTN_SEARCH"><IconButton color="primary"><Search /></IconButton></Tooltip></Grid><Grid item xs={12} md={8}><Box></Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={5}><Box></Box></Grid><Grid item xs={12} md={2}><Box>교재수령지 출력</Box></Grid><Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={2}><Box>교재반납</Box></Grid><Grid item xs={12} md={2}><Box></Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={2}><Button variant="contained">결제삭제</Button></Grid><Grid item xs={12} md={3}><Button variant="contained">영수증재발행(PDF용)</Button></Grid><Grid item xs={12} md={3}><Button variant="contained">작성일자별 계산서발행</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
