...
<Grid container spacing={2}>
                ...
                </Grid><Grid item xs={12} md={3}><Box>* 기 합격자와 결강자는 나타나지 않습니다.</Box></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.lfn_SaveEvaluation}>평가자료 생성</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
