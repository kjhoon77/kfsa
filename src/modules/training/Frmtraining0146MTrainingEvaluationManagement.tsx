...
<Button variant="contained"  onClick={hook.btnPassCancel_OnClick}>합격취소(팝업)</Button>
...
<Grid container spacing={2}>
                ...
                </Grid><Grid item xs={12} md={3}><Box>* 기 합격자와 결강자는 나타나지 않습니다.</Box></Grid><Grid item xs={12} md={2}><Button variant="contained">평가자료 생성</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                <Grid item xs={12} md={4}>
                    <Stack direction="row" alignItems="center" spacing={1}>
                        <Typography variant="body2" sx={{ minWidth: 80, display: 'flex', alignItems: 'center', bgcolor: '#f5f5f5', p: 0.5, borderRadius: 1 }}>합격예정자수</Typography>
                        <TextField size="small" fullWidth  />
                    </Stack>
...
<Grid container spacing={2} alignItems="center">
                ...
                <Grid item xs={12}>
                    <Paper sx={{ height: 400, width: '100%' }}>
                        <DataGridWrapper rows={hook.ds_ioTrainingEvaluation} columns={columns_gdTrainingEvaluation} />
                    </Paper>
                </Grid></Grid>
