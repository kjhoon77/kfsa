...
export interface Ids_TrainingList {
    ...
    LSDSCNT_2: string;
    LSDSCNT_3: string;
    LSDSCNT_BANG0N: string;
    LSDSCNT_BANG0N_1: string;
    LSDSCNT_BANG0N_2: string;
    LSDSCNT_BANG0N_3: string;
    LSDSCNT_BANG0C: string;
    LSDSCNT_BANG0C_1: string;
    LSDSCNT_BANG0C_2: string;
    LSDSCNT_BANG0C_3: string;
    LSDSCNT_BANG10: string;
    LSDSCNT_BANG10_1: string;
    LSDSCNT_BANG10_2: string;
    LSDSCNT_BANG10_3: string;
    ...
    LSOUTCNT_2: string;
    LSOUTCNT_3: string;
    LSOUTCNT_BANG0N: string;
    LSOUTCNT_BANG0N_1: string;
    LSOUTCNT_BANG0N_2: string;
    LSOUTCNT_BANG0N_3: string;
    LSOUTCNT_BANG0C: string;
    LSOUTCNT_BANG0C_1: string;
    LSOUTCNT_BANG0C_2: string;
    LSOUTCNT_BANG0C_3: string;
    LSOUTCNT_BANG10: string;
    LSOUTCNT_BANG10_1: string;
    LSOUTCNT_BANG10_2: string;
    LSOUTCNT_BANG10_3: string;
    ...
    LSPASSCNT_2: string;
    LSPASSCNT_3: string;
    LSPASSCNT_BANG0N: string;
    LSPASSCNT_BANG0N_1: string;
    LSPASSCNT_BANG0N_2: string;
    LSPASSCNT_BANG0N_3: string;
    LSPASSCNT_BANG0C: string;
    LSPASSCNT_BANG0C_1: string;
    LSPASSCNT_BANG0C_2: string;
    LSPASSCNT_BANG0C_3: string;
    LSPASSCNT_BANG10: string;
    LSPASSCNT_BANG10_1: string;
    LSPASSCNT_BANG10_2: string;
    LSPASSCNT_BANG10_3: string;
    ...
    LSRCNT_2: string;
    LSRCNT_3: string;
    LSRCNT_BANG0N: string;
    LSRCNT_BANG0N_1: string;
    LSRCNT_BANG0N_2: string;
    LSRCNT_BANG0N_3: string;
    LSRCNT_BANG0C: string;
    LSRCNT_BANG0C_1: string;
    LSRCNT_BANG0C_2: string;
    LSRCNT_BANG0C_3: string;
    LSRCNT_BANG10: string;
    LSRCNT_BANG10_1: string;
    LSRCNT_BANG10_2: string;
    LSRCNT_BANG10_3: string;
    LSRCNT_BANG1: string;
