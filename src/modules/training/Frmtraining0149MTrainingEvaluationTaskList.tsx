...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box>구분</Box></Grid><Grid item xs={12} md={3}><Box></Box></Grid><Grid item xs={12} md={2}><Button variant="contained">일괄 다운로드</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">과제 합격처리</Button></Grid><Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={2}><Box></Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
