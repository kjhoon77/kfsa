...
import { useFrmtraining0148MTrainingEvaluationList } from './useFrmtraining0148MTrainingEvaluationList';
import * as Frmtraining0148MTrainingEvaluationListData from './Frmtraining0148MTrainingEvaluationListData';

export const Frmtraining0148MTrainingEvaluationList = () => {
    const hook = useFrmtraining0148MTrainingEvaluationList();
    const columns_gdTrainingEvaluation = [
        ...
        { field: 'ERPASSYN', headerName: '합격여부', width: 64 },
        { field: 'TJADDR1', headerName: '주소1', width: 194 },
        { field: 'TJADDR2', headerName: '주소2', width: 141 },
    ];
    return (
        <PageContainer>
...
export default Frmtraining0148MTrainingEvaluationList;
