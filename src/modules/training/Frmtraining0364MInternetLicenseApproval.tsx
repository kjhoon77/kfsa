...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={2}><Box></Box></Grid><Grid item xs={12} md={2}><Button variant="contained">신청서출력</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">임시저장</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">접수취소</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">접수시작</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">보완</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">승인</Button></Grid><Grid item xs={12} md={2}><Button variant="contained">반려</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
                ...
                <Grid item xs={12} md={4}>
                    <Stack direction="row" alignItems="center" spacing={1}>
                        ...
                        <FormControl size="small" fullWidth><Select  displayEmpty><MenuItem value=""><em>선택</em></MenuItem>{ (Frmtraining0364MInternetLicenseApprovalData.ds_ds_oAjgubun || []).map(opt => <MenuItem key={opt.CD} value={opt.CD}>{opt.DATA}</MenuItem>) }</Select></FormControl>
                    </Stack>
                </Grid></Grid>
<Grid container spacing={2} alignItems="center">
