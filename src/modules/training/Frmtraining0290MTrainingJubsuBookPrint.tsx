...
<Grid item xs={12} md={3}><Box>교재발송명단 등기정보 엑셀 업로드</Box></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnHistory_OnClick}>이력 확인</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnExcelUpload_OnClick}>①엑셀 자료 불러오기</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
                ...
                </Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnDataCheck_OnClick}>②자료 확인 하기</Button></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnResult_OnClick}>③등기정보 반영</Button></Grid><Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnSmsSend_OnClick}>문자메시지발송</Button></Grid><Grid item xs={12} md={2}><Box>TBPMGNO</Box></Grid></Grid>
<Grid container spacing={2} alignItems="center">
...
<Grid container spacing={2} alignItems="center">
<Grid item xs={12} md={2}><Button variant="contained" onClick={hook.btnSearchMgno_OnClick}>btnSearchMgno</Button></Grid></Grid>
<Grid container spacing={2} alignItems="center">
