...
import { useFrmtraining0426PExamSmsSendList } from './useFrmtraining0426PExamSmsSendList';
import * as Frmtraining0426PExamSmsSendListData from './Frmtraining0426PExamSmsSendListData';

export const Frmtraining0426PExamSmsSendList = () => {
    const hook = useFrmtraining0426PExamSmsSendList();
...
export default Frmtraining0426PExamSmsSendList;
