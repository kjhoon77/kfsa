...
</CustomTabPanel><CustomTabPanel value={tabValue_TAB_Profes} index={1}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "5px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_XChart1 ? undefined : 'none' }}><Box sx={{ width: '952px', height: '593px', border: '1px dashed grey' }}>Unknown: XChart</Box></Box><Box sx={{ display: hook.isVisible_gdList ? undefined : 'none' }}><Paper sx={{ width: '300px', height: '235px', width: '100%', height: 'auto', minHeight: '235px' }}><DataGridWrapper rows={hook.ds_ioListChart2} columns={columns_gdList_1} /></Paper></Box></Stack>
</CustomTabPanel><CustomTabPanel value={tabValue_TAB_Profes} index={2}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "5px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_XChart1 ? undefined : 'none' }}><Box sx={{ width: '952px', height: '593px', border: '1px dashed grey' }}>Unknown: XChart</Box></Box><Box sx={{ display: hook.isVisible_gdList ? undefined : 'none' }}><Paper sx={{ width: '300px', height: '276px', width: '100%', height: 'auto', minHeight: '276px' }}><DataGridWrapper rows={hook.ds_ioListChart3} columns={columns_gdList_2} /></Paper></Box></Stack>
</CustomTabPanel><CustomTabPanel value={tabValue_TAB_Profes} index={3}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "5px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_XChart1 ? undefined : 'none' }}><Box sx={{ width: '952px', height: '593px', border: '1px dashed grey' }}>Unknown: XChart</Box></Box><Box sx={{ display: hook.isVisible_gdList ? undefined : 'none' }}><Paper sx={{ width: '300px', height: '268px', width: '100%', height: 'auto', minHeight: '268px' }}><DataGridWrapper rows={hook.ds_ioListChart4} columns={columns_gdList_3} /></Paper></Box></Stack>
</CustomTabPanel><CustomTabPanel value={tabValue_TAB_Profes} index={4}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "4px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_XChart1 ? undefined : 'none' }}><Box sx={{ width: '952px', height: '593px', border: '1px dashed grey' }}>Unknown: XChart</Box></Box><Box sx={{ display: hook.isVisible_gdList ? undefined : 'none' }}><Paper sx={{ width: '300px', height: '476px', width: '100%', height: 'auto', minHeight: '476px' }}><DataGridWrapper rows={hook.ds_ioListChart5} columns={columns_gdList_4} /></Paper></Box></Stack>
</CustomTabPanel><CustomTabPanel value={tabValue_TAB_Profes} index={5}><Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "5px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_XChart1 ? undefined : 'none' }}><Box sx={{ width: '952px', height: '593px', border: '1px dashed grey' }}>Unknown: XChart</Box></Box><Box sx={{ display: hook.isVisible_gdList ? undefined : 'none' }}><Paper sx={{ width: '300px', height: '460px', width: '100%', height: 'auto', minHeight: '460px' }}><DataGridWrapper rows={hook.ds_ioListChart6} columns={columns_gdList_5} /></Paper></Box></Stack>
