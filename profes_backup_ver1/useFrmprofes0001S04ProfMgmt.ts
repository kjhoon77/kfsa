...
export const useFrmprofes0001S04ProfMgmt = () => {
    ...
    const [rawVisible_gdProfPaper, setRawVisible_gdProfPaper] = useState(true);
    ...
    const isVisible_gdProfPaper = rawVisible_gdProfPaper && rawVisible_shpGubunBox1;
    const setIsVisible_gdProfPaper = setRawVisible_gdProfPaper;
