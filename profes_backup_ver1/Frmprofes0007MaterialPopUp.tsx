...
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "2px", py: 0.5, width: "100%" }}><Stack direction="row" alignItems="center" spacing={0.5} sx={{ width: '194px', height: '22px', display: 'flex', alignItems: 'center', ml: '8px' }}>
                    <Typography variant="body2" sx={{ minWidth: 88, bgcolor: '#f5f5f5', p: 0.3, borderRadius: 1 }}>승인일자</Typography>
                    <DatePicker format="yyyy/MM/dd" slotProps={{ textField: { size: "small", fullWidth: true, sx: { "& .MuiOutlinedInput-notchedOutline": { borderColor: "rgba(0,0,0,0.4)" }, "& .MuiInputBase-input": { padding: "4px 6px" } } } }} />
                 </Stack><Box sx={{ display: hook.isVisible_btnCreate ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btnCreate_OnClick} sx={{ width: '66px', height: '24px' }}>교안이력</Button></Box><Box sx={{ display: hook.isVisible_btn_appr ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btn_appr_OnClick} sx={{ width: '66px', height: '24px' }}>승인</Button></Box><Box sx={{ display: hook.isVisible_btn_Approval ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btn_Approval_OnClick} sx={{ width: '93px', height: '24px' }}>◀결재올림</Button></Box><Box sx={{ display: hook.isVisible_btn_Cancel ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btn_Cancel_OnClick} sx={{ width: '66px', height: '24px' }}>승인취소</Button></Box></Stack>
<Stack direction="row" alignItems="center" spacing={0} sx={{ mt: "10px", py: 0.5, width: "100%" }}><Box sx={{ display: hook.isVisible_btn_Modify ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btn_Modify_OnClick} sx={{ width: '66px', height: '24px' }}>수정</Button></Box><Box sx={{ display: hook.isVisible_btn_delete ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btn_delete_OnClick} sx={{ width: '66px', height: '24px' }}>삭제</Button></Box><Box sx={{ display: hook.isVisible_btn_apprReq ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btn_apprReq_OnClick} sx={{ width: '66px', height: '24px' }}>승인요청</Button></Box><Box sx={{ display: hook.isVisible_btn_apprReqCancel ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btn_apprReqCancel_OnClick} sx={{ width: '93px', height: '24px' }}>승인요청취소</Button></Box><Box sx={{ display: hook.isVisible_btn_modReq ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btn_modReq_OnClick} sx={{ width: '66px', height: '24px' }}>수정요청</Button></Box><Box sx={{ display: hook.isVisible_btn_modReqCancel ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btn_modReqCancel_OnClick} sx={{ width: '93px', height: '24px' }}>수정요청취소</Button></Box><Box sx={{ display: hook.isVisible_btn_modAppr ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btn_modAppr_OnClick} sx={{ width: '66px', height: '24px' }}>수정허가</Button></Box><Box sx={{ display: hook.isVisible_btn_modCancel ? undefined : 'none' }}><Button variant="contained"   onClick={hook.btn_modCancel_OnClick} sx={{ width: '93px', height: '24px' }}>수정(허가)취소</Button></Box></Stack>
