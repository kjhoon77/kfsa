...
function gfn_SearchKCode(objDataset, sKgubun, sOpt) {
    ...
    for (var i = 0; i < gds_oKCode.GetCount(); i++) {
        ...
        objDataset.SetColumn(nRow, "DATA5", gds_oKCode.GetColumn(i, "KNM5"));
    }
 ...
 * 
 */
function gfn_PostRoadListPopup_New(sPostAddr1, sPostAddr2)	
{
	var sArg = "sPostAddr1=" + quote(sPostAddr1)
		+ " sPostAddr2=" + quote(sPostAddr2);
	
	return Dialog("COM::frmCOM9004PAddrSearch.xml",sArg, 704, 656, "", -1, -1);
}
...
function urlEncodeUtf8_New(decoded) 
{
  // Some variables:
	var encoded = "";
